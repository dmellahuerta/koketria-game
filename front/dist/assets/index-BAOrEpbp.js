...
`].filter(Jr).join(`
`)),a=fu(a),a=tf(a,t),a=nf(a,t),o=fu(o),o=tf(o,t),o=nf(o,t),a=sf(a),o=sf(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`;const $i=document.querySelector("#bootLoader"),gf=document.querySelector("#bootLoaderText"),_f=document.querySelector("#bootLoaderFill"),xf=document.querySelector("#bootLoaderPercent"),Zi=document.querySelector("#lobby"),el=document.querySelector("#connectionStatus"),Vp=document.querySelector("#playerName"),tn=document.querySelector("#characterSelect"),Zs=document.querySelector("#characterPreview"),GS=document.querySelector("#refreshRoomsBtn"),tl=document.querySelector("#roomList"),co=document.querySelector("#lobbyError"),vf=document.querySelector("#matchInfo"),Mf=document.querySelector("#respawnScreen"),WS=document.querySelector("#respawnCounter"),Hp=document.querySelector("#winnerScreen"),XS=document.querySelector("#winnerText"),gu=document.querySelector("#winnerCounter"),nl=document.querySelector("#damageOverlay"),lo=document.querySelector("#damageIndicator"),yf=document.querySelector("#scoreboard"),qS=document.querySelector("#scoreboardBody"),jS=document.querySelector("#healthStat"),YS=document.querySelector("#shieldStat"),KS=document.querySelector("#ammoStat"),$S=document.querySelector("#healthSideLabel"),ZS=document.querySelector("#shieldSideLabel"),JS=document.querySelector("#ammoSideLabel"),QS=document.querySelector("#healthBarFill"),eb=document.querySelector("#shieldBarFill"),tb=document.querySelector("#ammoBarFill"),nb=document.querySelector("#stats"),Sf=document.querySelector("#roomHud"),bf=document.querySelector("#stateHud"),Ef=document.querySelector("#weatherHud"),Tf=document.querySelector("#playersHud"),Af=document.querySelector("#perfPanel"),ib=document.querySelector("#fpsValue"),sb=document.querySelector("#latencyValue"),rb=document.querySelector("#drawCallsValue"),ab=document.querySelector("#trianglesValue"),ob=document.querySelector("#geometriesValue"),cb=document.querySelector("#texturesValue"),lb=document.querySelector("#vfxValue"),il=document.querySelector("#hostControls"),Gp=document.querySelector("#startGameBtn"),Wp=document.querySelector("#endGameBtn"),ub=document.querySelector("#leaveRoomHudBtn"),hh=document.querySelector("#chatFeed"),Xp=document.querySelector("#chatPanel"),uo=document.querySelector("#chatLog"),qp=document.querySelector("#chatInputWrap"),Bo=document.querySelector("#chatInput"),jr=document.querySelector("#crosshair"),jp=document.querySelector("#optionsScreen"),_u=document.querySelector("#optMouseSensitivity"),Yp=document.querySelector("#optMouseSensitivityValue"),xu=document.querySelector("#optMasterVolume"),Kp=document.querySelector("#optMasterVolumeValue"),vu=document.querySelector("#optMusicVolume"),$p=document.querySelector("#optMusicVolumeValue"),Mu=document.querySelector("#optSfxVolume"),Zp=document.querySelector("#optSfxVolumeValue"),yu=document.querySelector("#optFov"),Jp=document.querySelector("#optFovValue"),Su=document.querySelector("#optShowPerf"),hb=document.querySelector("#optResumeBtn"),db=document.querySelector("#optLeaveLobbyBtn"),H={ws:null,self:null,rooms:[],joinedRoom:null,remotePlayers:new Map,lastStateSentAt:0,showMatchInfo:!1,showScoreboard:!1,showPerf:!1,fps:0,latencyMs:null},Xn={drawCalls:0,triangles:0,geometries:0,textures:0,vfx:0},Cn=[],wf=40,fb=8e3;let ns=!1,Ir=!1;const Qp="koketria_settings_v1",Pe={mouseSensitivity:1,masterVolume:1,musicVolume:1,sfxVolume:1,fov:75,showPerfByDefault:!1},sl=["battle1","battle2","battle3"],em=()=>{pt.KeyW=!1,pt.KeyA=!1,pt.KeyS=!1,pt.KeyD=!1,pt.Space=!1},dh=()=>{if(!uo)return;const i=Date.now();for(let t=Cn.length-1;t>=0;t-=1)i-Cn[t].ts>fb&&Cn.splice(t,1);hh.classList.toggle("open",Cn.length>0);const e=Cn.slice(-8);uo.innerHTML=e.map(t=>{const n=t.isSelf?" (Tú)":"";return`<p><strong>${t.playerName}${n}:</strong> ${t.text}</p>`}).join(""),uo.scrollTop=uo.scrollHeight},pb=(i,e)=>{if(!e)return;const t=!!(H.self&&String(i||"")===String(H.self.name||""));Cn.push({playerName:String(i||"Player"),text:String(e||""),isSelf:t,ts:Date.now()}),Cn.length>wf&&Cn.splice(0,Cn.length-wf),dh()};setInterval(()=>{Cn.length>0&&!ns&&dh()},500);const mb=()=>{H.joinedRoom&&(ns=!0,em(),si=!1,Xp.classList.add("open"),qp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),Bo.value="",Bo.focus())},bu=()=>{ns=!1,Xp.classList.remove("open"),qp.classList.add("hidden"),Bo.blur()},Js=(i="")=>{if(!i){co.classList.add("hidden"),co.textContent="";return}co.classList.remove("hidden"),co.textContent=i},qn=(i,e,t,n)=>{const s=Number(i);return Number.isFinite(s)?Math.max(e,Math.min(t,s)):n},gb=()=>{try{const i=localStorage.getItem(Qp);if(!i)return;const e=JSON.parse(i);Pe.mouseSensitivity=qn(e.mouseSensitivity,.4,2.5,Pe.mouseSensitivity),Pe.masterVolume=qn(e.masterVolume,0,1,Pe.masterVolume),Pe.musicVolume=qn(e.musicVolume,0,1,Pe.musicVolume),Pe.sfxVolume=qn(e.sfxVolume,0,1,Pe.sfxVolume),Pe.fov=qn(e.fov,60,100,Pe.fov),Pe.showPerfByDefault=!!e.showPerfByDefault}catch{}},Lr=()=>{localStorage.setItem(Qp,JSON.stringify(Pe))},_b=i=>{const e=[...i];for(let t=e.length-1;t>0;t-=1){const n=Math.floor(Math.random()*(t+1)),s=e[t];e[t]=e[n],e[n]=s}return e},zo=i=>{Jo.classList.toggle("in-room",i),Ri(),!i&&document.pointerLockElement&&document.exitPointerLock(),i||(nc(),Cn.length=0,dh(),bu(),hh.classList.remove("open"))},tm=()=>{H.showMatchInfo&&H.joinedRoom?vf.classList.add("visible"):vf.classList.remove("visible")},fh=()=>{if(!H.joinedRoom||!H.showScoreboard){yf.classList.add("hidden");return}const i=[...H.joinedRoom.players].sort((e,t)=>(t.kills||0)!==(e.kills||0)?(t.kills||0)-(e.kills||0):(e.deaths||0)-(t.deaths||0));qS.innerHTML=i.map(e=>{const t=H.self&&e.id===H.self.id?" (Tú)":"";return`<tr><td>${e.name}${t}</td><td>${e.kills||0}</td><td>${e.deaths||0}</td></tr>`}).join(""),yf.classList.remove("hidden")},Dr=()=>{if(!H.joinedRoom||!H.showPerf){Af.classList.add("hidden");return}ib.textContent=String(H.fps),sb.textContent=Number.isFinite(H.latencyMs)?`${Math.round(H.latencyMs)} ms`:"--",rb.textContent=String(Math.round(Xn.drawCalls)),ab.textContent=String(Math.round(Xn.triangles)),ob.textContent=String(Math.round(Xn.geometries)),cb.textContent=String(Math.round(Xn.textures)),lb.textContent=String(Math.round(Xn.vfx)),Af.classList.remove("hidden")},nm=()=>!!(H.joinedRoom&&H.self&&H.joinedRoom.room.hostId===H.self.id),On=()=>!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"&&!yt&&!br),xa=()=>!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"),xb=i=>i==="rainy"?"Lluvioso":i==="sunny"?"Soleado":i==="night"?"Noche":i==="snow"?"Nieve":i||"-",sa=i=>{const e=i||"night";im=e,gh.visible=e==="rainy",xh.visible=e==="snow",lm.visible=e==="night"||e==="snow",hm.visible=!1,vh.visible=!1,Mh.visible=!1,e==="sunny"?(Ee.background=new Ce(12050431),Ee.fog.color.set(12050431),Ee.fog.near=90,Ee.fog.far=400,Qr.intensity=.74,Gn.intensity=1.2,Gn.color.set(16773826),ea.opacity=.35):e==="rainy"?(Ee.background=new Ce(599e4),Ee.fog.color.set(599e4),Ee.fog.near=10,Ee.fog.far=95,Qr.intensity=.26,Gn.intensity=.42,Gn.color.set(9156567),ea.opacity=.25):e==="snow"?(Ee.background=new Ce(14215668),Ee.fog.color.set(14215668),Ee.fog.near=26,Ee.fog.far=200,Qr.intensity=.65,Gn.intensity=.9,Gn.color.set(15202047),ea.opacity=.42):(Ee.background=new Ce(461588),Ee.fog.color.set(461588),Ee.fog.near=16,Ee.fog.far=140,Qr.intensity=.26,Gn.intensity=.38,Gn.color.set(8354248),ea.opacity=.6)},en=i=>{if(!H.ws||H.ws.readyState!==WebSocket.OPEN){Js("WebSocket no conectado");return}H.ws.send(JSON.stringify(i))};let Rf=0,vi=null,Cf=0;const vb=2e3;let rl=0,Pf=performance.now();const ph=(i=!1)=>{const e=performance.now();if(!H.showPerf||!H.joinedRoom||!H.ws||H.ws.readyState!==WebSocket.OPEN||vi&&e-vi.sentAt<5e3||!i&&e-Cf<vb)return;const t=`${Date.now()}-${Rf}`;Rf+=1,vi={id:t,sentAt:e},Cf=e,en({type:"ping",probeId:t,clientTs:Date.now()})},Mb=()=>{const i=performance.now();rl+=1;const e=i-Pf;e>=500&&(H.fps=Math.max(0,Math.round(rl*1e3/e)),rl=0,Pf=i,H.showPerf&&H.joinedRoom&&Dr()),ph()},Eu=()=>{if(tl.innerHTML="",H.rooms.length===0){const i=document.createElement("p");i.className="room-empty",i.textContent="No hay salas activas.",tl.appendChild(i);return}H.rooms.forEach(i=>{const e=document.createElement("article");e.className="room-card",e.innerHTML=`
      <div>
    ...
    `,e.querySelector("button").addEventListener("click",()=>{Js(),en({type:"join_room",roomId:i.id,playerName:Vp.value.trim(),character:tn.value||et})}),tl.appendChild(e)})},yb=()=>`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws`,Sb=()=>`${window.location.protocol}//${window.location.host}`,Ee=new gp;Ee.background=new Ce(66817);Ee.fog=new Zu(66817,18,160);let im="night";const de=new Xt(75,window.innerWidth/window.innerHeight,.1,500);de.position.set(0,1.7,10);const As=new Xt(75,window.innerWidth/window.innerHeight,.1,500);let or=!1;const bb=1.25,Eb=.7,Tb=.18,If=new P,ho=new P,Lf=new P,Df=new P,fo=new P,mn=new Op({antialias:!0});mn.setSize(window.innerWidth,window.innerHeight);mn.setPixelRatio(Math.min(window.devicePixelRatio,2));Jo.appendChild(mn.domElement);const Qr=new Z0(6750088,.3);Ee.add(Qr);const Gn=new oh(4849523,.8);Gn.position.set(15,30,10);Ee.add(Gn);const va=new Cp(10026904,0,8,2);de.add(va);va.position.set(.2,-.18,-.6);Ee.add(de);const sm=new Je(new ts(320,320),new Un({color:135426,roughness:1}));sm.rotation.x=-Math.PI/2;Ee.add(sm);const rm=new m_(320,80,4194150,1002015);rm.position.y=.01;Ee.add(rm);const Ab=new Un({color:5984868,emissive:2762034,emissiveIntensity:.18,metalness:.06,roughness:.9});new Un({color:8089476,emissive:2893110,emissiveIntensity:.14,metalness:.04,roughness:.92});new Un({color:9401999,emissive:3417405,emissiveIntensity:.11,metalness:.04,roughness:.9});const Ji=[],ko=[],Qi=.55,wb=156;let Nf=null;const Qo=5600,Tn=new Float32Array(Qo*3),Tu=new Float32Array(Qo);for(let i=0;i<Qo;i+=1)Tn[i*3]=(Math.random()-.5)*260,Tn[i*3+1]=Math.random()*120+6,Tn[i*3+2]=(Math.random()-.5)*260,Tu[i]=22+Math.random()*26;const mh=new wt;mh.setAttribute("position",new Ut(Tn,3));const Rb=new Tr({color:6750054,size:.26,transparent:!0,opacity:.98,sizeAttenuation:!0}),gh=new Aa(mh,Rb);Ee.add(gh);const ec=1700,An=new Float32Array(ec*3),am=new Float32Array(ec);for(let i=0;i<ec;i+=1)An[i*3]=(Math.random()-.5)*260,An[i*3+1]=Math.random()*120+6,An[i*3+2]=(Math.random()-.5)*260,am[i]=1.6+Math.random()*2.7;const _h=new wt;_h.setAttribute("position",new Ut(An,3));const Cb=new Tr({color:16777215,size:.22,transparent:!0,opacity:.85,sizeAttenuation:!0}),xh=new Aa(_h,Cb);Ee.add(xh);const om=1200,To=new Float32Array(om*3);for(let i=0;i<om;i+=1)To[i*3]=(Math.random()-.5)*420,To[i*3+1]=70+Math.random()*80,To[i*3+2]=(Math.random()-.5)*420;const cm=new wt;cm.setAttribute("position",new Ut(To,3));const Pb=new Tr({color:12572927,size:.36,transparent:!0,opacity:.78,sizeAttenuation:!0}),lm=new Aa(cm,Pb);Ee.add(lm);const tc=900,Ao=new Float32Array(tc*3),um=new Float32Array(tc);for(let i=0;i<tc;i+=1)Ao[i*3]=(Math.random()-.5)*300,Ao[i*3+1]=8+Math.random()*34,Ao[i*3+2]=(Math.random()-.5)*300,um[i]=.4+Math.random()*.9;const Vo=new wt;Vo.setAttribute("position",new Ut(Ao,3));const ea=new Tr({color:16773311,size:.18,transparent:!0,opacity:.62,sizeAttenuation:!0,depthWrite:!1}),hm=new Aa(Vo,ea);Ee.add(hm);const vh=new Je(new li(8.5,24,24),new It({color:15331839,transparent:!0,opacity:.9}));vh.position.set(78,95,-124);Ee.add(vh);const Mh=new Je(new li(4.2,18,18),new It({color:16373920,transparent:!0,opacity:.74}));Mh.position.set(-104,76,-112);Ee.add(Mh);const al=[],Au=[];let ra=0;const Ib=new P,dm=new lS,wu=new Map,on=[];let et="";const Lb=["attack","dead","running","idle","jump","funny"],qe={renderer:null,scene:null,camera:null,mixer:null,model:null,lastWidth:0,lastHeight:0},Ke={group:null,mixer:null,actions:null,currentAnimation:"",shootUntil:0,loadingKey:"",funnyUntil:0},Ra=i=>{const e=String(i||"").trim();return e?e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,"")==="pezunalunar"?"pezunalunar":e:""},Db=(i,e)=>`/characters/${encodeURIComponent(Ra(i))}/${encodeURIComponent(e)}`,Ho=i=>Ra(i)==="pezunalunar"?"pezuñalunar":i,Nb=i=>/\.(glb|gltf)$/i.test(String(i||"").trim()),Ub=i=>{const e=String(i||"").trim();if(!e)return[];const t=Ra(e);return t===e?[e]:[t,e]},Fb=i=>new Promise(e=>{const t=n=>{if(n>=i.length){e(null);return}dm.load(i[n],s=>e(s),void 0,()=>t(n+1))};t(0)}),Uf={mana:{url:"/items/mana.glb",targetHeight:.62},defensa:{url:"/items/defensa.glb",targetHeight:.7},vida:{url:"/items/vida.glb",targetHeight:.68}},Yr=new Map,po=new Map,Ob=(i,e)=>{const t=new Mn().setFromObject(i),n=t.getSize(new P);if(Number.isFinite(n.y)&&n.y>1e-4){const a=e/n.y;i.scale.setScalar(a),t.setFromObject(i)}const s=t.getCenter(new P),r=Number.isFinite(t.min.y)?t.min.y:0;return i.position.set(-s.x,-r,-s.z),i.traverse(a=>{a.isMesh&&(a.frustumCulled=!0)}),i},wo=async i=>{const e=String(i||"").trim();if(!e||!Uf[e])return null;if(Yr.has(e))return Yr.get(e);if(po.has(e))return po.get(e);const{url:t,targetHeight:n}=Uf[e],s=new Promise(r=>{dm.load(t,a=>{const o=a?.scene?a.scene.clone(!0):null;if(!o){Yr.set(e,null),r(null);return}const c=Ob(o,n);Yr.set(e,c),r(c)},void 0,()=>{Yr.set(e,null),r(null)})}).finally(()=>{po.delete(e)});return po.set(e,s),s},ol=(i,e)=>{const t=new un,n=new un;t.add(n);const s=e();return s.name="__pickup_fallback__",n.add(s),wo(i).then(r=>{if(!r||!t.parent)return;for(;n.children.length>0;)n.remove(n.children[0]);const a=r.clone(!0);a.name=`pickup_${i}`,n.add(a),t.userData.modelLoaded=!0}),t},js=(i,e)=>{if(!i?.animations||i.animations.length===0)return null;const t=i.animations[0].clone();return t.name=e,t},Nr=async i=>{if(!i)return null;const e=wu.get(i);if(e?.loaded)return e;if(e?.loadingPromise)return e.loadingPromise;const t=e||{loaded:!1,scene:null,animations:[],animationSet:{},loadingPromise:null};return wu.set(i,t),t.loadingPromise=new Promise(n=>{const s=Ub(i);if(s.length===0){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}Promise.all(Lb.map(async r=>{const a=Nb(r)?[r]:[r,`${r}.glb`,`${r}.gltf`],o=s.flatMap(l=>a.map(u=>Db(l,u))),c=await Fb(o);return{actionName:r,gltf:c}})).then(r=>{const a=r.find(_=>_.actionName==="dead"&&_.gltf?.scene)?.gltf,o=r.find(_=>_.actionName==="idle"&&_.gltf?.scene)?.gltf,c=r.find(_=>_.actionName==="running"&&_.gltf?.scene)?.gltf,l=r.find(_=>_.actionName==="jump"&&_.gltf?.scene)?.gltf,u=r.find(_=>_.actionName==="funny"&&_.gltf?.scene)?.gltf,h=r.find(_=>_.actionName==="attack"&&_.gltf?.scene)?.gltf,d=o||c||l||u||a||h;if(!d?.scene){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}const f={attack:js(h,"attack"),dead:js(a,"dead"),running:js(c,"running"),idle:js(o,"idle"),jump:js(l,"jump"),funny:js(u,"funny")},g=Object.values(f).filter(Boolean);t.loaded=!0,t.scene=d.scene,t.animations=g,t.animationSet=f,t.loadingPromise=null,n(t)})}),t.loadingPromise},fm=i=>{const e=tn.value||et;if(tn.innerHTML="",on.length=0,_b(i).forEach(n=>on.push(n)),on.length===0){const n=document.createElement("option");n.value="",n.textContent="Sin personajes",tn.appendChild(n),tn.disabled=!0,et="";return}tn.disabled=!1,on.forEach(n=>{const s=document.createElement("option");s.value=n,s.textContent=Ho(n),tn.appendChild(s)}),et=on.includes(e)?e:on[0],tn.value=et},cl=(i,e,t="")=>{const n=Math.max(1,e),s=Math.max(0,Math.min(1,i/n)),r=Math.round(s*100);_f&&(_f.style.width=`${r}%`),xf&&(xf.textContent=`${r}%`),gf&&t&&(gf.textContent=t)},pm=async()=>{const i=Sb();try{const t=await(await fetch(`${i}/characters`)).json();if(t?.ok&&Array.isArray(t.data)&&t.data.length>0)return t.data}catch{}return["silentman","pumori","neoorphen","pezunalunar"]},Ff=new Set,Qs=(i,e=6e3)=>new Promise(t=>{if(!i){t(!1);return}if(Ff.has(i)){t(!0);return}const n=new Audio;let s=!1;const r=c=>{s||(s=!0,n.removeEventListener("canplaythrough",a),n.removeEventListener("loadedmetadata",a),n.removeEventListener("error",o),c&&Ff.add(i),t(c))},a=()=>r(!0),o=()=>r(!1);n.preload="auto",n.addEventListener("canplaythrough",a,{once:!0}),n.addEventListener("loadedmetadata",a,{once:!0}),n.addEventListener("error",o,{once:!0}),n.src=i,n.load(),setTimeout(()=>r(!1),e)}),Bb=async i=>{const e=await Sh(i);return await Qs(e,6e3)?!0:Qs(e,1e4)},zb=async()=>{$i&&$i.classList.remove("hidden"),Zi&&Zi.classList.add("hidden");const i=await pm();fm(i),ic(et);const e=[...on],t=2+e.length*2+1+sl.length+1+3+1;let n=0;const s=r=>{n+=1,cl(n,t,r)};cl(0,t,"Cargando tema pre-lobby..."),await Qs(_m,1e4),s("Tema pre-lobby cargado"),Ri(),cl(n,t,"Preparando catalogo..."),mm(),s("Catalogo listo");for(let r=0;r<e.length;r+=1){const a=e[r];await Nr(a),s(`Modelo: ${Ho(a)}`)}for(let r=0;r<e.length;r+=1){const a=e[r];await Bb(a),s(`Audio ataque: ${Ho(a)}`)}await Qs(wi,6e3),s("Audio base cargado");for(let r=0;r<sl.length;r+=1){const a=sl[r];await Qs(yh(a),1e4),s(`Tema batalla: ${a}`)}await Qs(xm,1e4),s("Audio lobby cargado"),await wo("mana"),s("Item mana cargado"),await wo("defensa"),s("Item defensa cargado"),await wo("vida"),s("Item vida cargado"),await Fh(),Ur();for(const r of H.remotePlayers.values())ba(r);s("Lobby listo"),$i&&$i.classList.add("hidden"),Zi&&Zi.classList.remove("hidden"),Ri()},kb=async()=>{const i=await pm();fm(i),ic(et),await Nr(et),await Fh(),Ur();for(const e of H.remotePlayers.values())ba(e)},Ur=()=>{if(!qe.scene)return;const i=tn.value||et;if(!i)return;qe.model&&(qe.scene.remove(qe.model),qe.model=null,qe.mixer=null);const e=wu.get(i);if(!e?.loaded||!e.scene){Nr(i).then(o=>{o?.loaded&&(tn.value||et)===i&&Ur()});return}const t=uh(e.scene),n=new Mn().setFromObject(t),s=n.getCenter(new P),r=n.getSize(new P);t.position.set(-s.x,-n.min.y,-s.z),qe.scene.add(t),qe.model=t,qe.camera.position.set(0,Math.max(1.2,r.y*.55),Math.max(2.3,r.y*.95)),qe.camera.lookAt(0,Math.max(.9,r.y*.45),0);const a=e.animationSet?.running||ms(e.animations||[],"running",["running"]);if(a){const o=new Pp(t),c=o.clipAction(a);c.reset(),c.setLoop(Xo,1/0),c.play(),qe.mixer=o}},mm=()=>{if(!Zs||qe.renderer)return;const i=new gp,e=new Xt(40,1,.1,100),t=new Op({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(window.devicePixelRatio,2));const n=Zs.clientWidth||280,s=Zs.clientHeight||220;t.setSize(n,s,!1),Zs.appendChild(t.domElement);const r=new q0(12514815,1975838,.95);i.add(r);const a=new oh(16777215,1);a.position.set(3.5,5,4),i.add(a),qe.scene=i,qe.camera=e,qe.renderer=t,qe.lastWidth=n,qe.lastHeight=s,Ur()},gm=()=>{if(!qe.renderer||!qe.camera)return;const i=Zs.clientWidth||280,e=Zs.clientHeight||220;i===qe.lastWidth&&e===qe.lastHeight||(qe.lastWidth=i,qe.lastHeight=e,qe.camera.aspect=i/e,qe.camera.updateProjectionMatrix(),qe.renderer.setSize(i,e,!1))},pn=new Audio("/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3");pn.preload="auto";pn.loop=!1;pn.volume=.24;const Kr=[],Vb=8,_m="/themes/pre-lobby.mp3",xm="/themes/lobby.mp3",Ru={battle1:"/themes/battle1.mp3",battle2:"/themes/battle2.mp3",battle3:"/themes/battle3.mp3"},yh=i=>Ru[i]||Ru.battle1,Qn=new Audio(_m);Qn.preload="auto";Qn.loop=!1;Qn.volume=.28;const is=new Audio(xm);is.preload="auto";is.loop=!0;is.volume=.34;const Ai=new Audio(yh("battle1"));Ai.preload="auto";Ai.loop=!0;Ai.volume=.38;let Ma=!1,Ms=!1,aa=!1,cr=!1,qi=!1,ll="battle1";const wi="/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3",Hb=[".ogg",".mp3",".wav",".m4a",""],mo=new Map;let ul="";const Of=140,hl=6,ji=[],Gb=24,Wb=(i,e,t)=>{(i.getAttribute(t)||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute(t,e),i.load())},vm=()=>!H.joinedRoom&&$i&&!$i.classList.contains("hidden"),Mm=()=>!H.joinedRoom&&Zi&&!Zi.classList.contains("hidden")&&(!$i||$i.classList.contains("hidden")),ym=()=>!!(H.joinedRoom&&H.joinedRoom.room?.status==="in_game"),dl=()=>{!Ms&&Qn.paused||(Qn.pause(),Qn.currentTime=0,Ms=!1,qi=!1)},go=()=>{!aa&&is.paused||(is.pause(),is.currentTime=0,aa=!1)},fl=()=>{!cr&&Ai.paused||(Ai.pause(),Ai.currentTime=0,cr=!1)},Xb=()=>{if(!Ma||Ms||!vm())return;Ms=!0;const i=Qn.play();i&&typeof i.catch=="function"&&i.catch(()=>{Ms=!1})},qb=()=>{if(!Ma||aa||!Mm())return;aa=!0;const i=is.play();i&&typeof i.catch=="function"&&i.catch(()=>{aa=!1})},jb=()=>{if(!Ma||cr||!ym())return;cr=!0;const i=Ai.play();i&&typeof i.catch=="function"&&i.catch(()=>{cr=!1})},Ri=()=>{if(ym()){qi=!1,dl(),go(),jb();return}if(vm()){qi=!1,fl(),go(),Xb();return}if(Mm()){if(fl(),Ms&&!Qn.ended){qi=!0,go();return}qi=!1,dl(),qb();return}qi=!1,fl(),dl(),go()},Ro=i=>{const e=String(i||"").trim(),t=Ru[e]?e:"battle1";t!==ll&&(ll=t,Wb(Ai,yh(ll),"data-bgm-src"),cr=!1,Ri())},Ca=()=>{const i=Math.max(0,Math.min(1,Pe.masterVolume));pn.volume=.24*i*Pe.sfxVolume,Qn.volume=.28*i*Pe.musicVolume,is.volume=.34*i*Pe.musicVolume,Ai.volume=.38*i*Pe.musicVolume,de.fov=Pe.fov,de.updateProjectionMatrix(),As.fov=Pe.fov,As.updateProjectionMatrix(),H.showPerf=Pe.showPerfByDefault||H.showPerf,Dr()},Yb=()=>{_u.value=String(Pe.mouseSensitivity),Yp.textContent=Pe.mouseSensitivity.toFixed(2),xu.value=String(Pe.masterVolume),Kp.textContent=`${Math.round(Pe.masterVolume*100)}%`,vu.value=String(Pe.musicVolume),$p.textContent=`${Math.round(Pe.musicVolume*100)}%`,Mu.value=String(Pe.sfxVolume),Zp.textContent=`${Math.round(Pe.sfxVolume*100)}%`,yu.value=String(Math.round(Pe.fov)),Jp.textContent=String(Math.round(Pe.fov)),Su.checked=!!Pe.showPerfByDefault},nc=()=>{Ir=!1,jp.classList.add("hidden")},Sm=()=>{H.joinedRoom&&(Ir=!0,si=!1,em(),jp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock())},Kb=()=>{Ir?nc():Sm()},$b=i=>{const e=Ra(i);return e?Hb.map(t=>`/characters/${encodeURIComponent(e)}/attack_sound${t}`):[]},Zb=i=>new Promise(e=>{const t=new Audio;let n=!1;const s=o=>{n||(n=!0,t.removeEventListener("canplaythrough",r),t.removeEventListener("loadedmetadata",r),t.removeEventListener("error",a),e(o))},r=()=>s(!0),a=()=>s(!1);t.preload="metadata",t.addEventListener("canplaythrough",r,{once:!0}),t.addEventListener("loadedmetadata",r,{once:!0}),t.addEventListener("error",a,{once:!0}),t.src=i,t.load(),setTimeout(()=>s(!1),900)}),Sh=async i=>{const e=Ra(i);if(!e)return wi;if(mo.has(e))return mo.get(e);const t=$b(e);for(let n=0;n<t.length;n+=1){const s=t[n];if(await Zb(s))return mo.set(e,s),s}return mo.set(e,wi),wi},bm=(i,e)=>{(i.getAttribute("data-attack-src")||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute("data-attack-src",e),i.removeAttribute("data-fallback-applied"),i.load())},ic=async i=>{const e=String(i||"").trim();if(e===ul&&pn.getAttribute("data-attack-src"))return;ul=e;const t=await Sh(e);e===ul&&bm(pn,t)},bh=()=>{Ma||(Ma=!0,Ri())};window.addEventListener("pointerdown",bh,{once:!0});window.addEventListener("keydown",bh,{once:!0});window.addEventListener("touchstart",bh,{once:!0,passive:!0});Qn.addEventListener("ended",()=>{Ms=!1,qi&&(qi=!1,Ri())});const Jb=()=>{const i=pn.getAttribute("data-attack-src")||pn.src||wi,e=new Audio(i);if(e.preload="auto",e.loop=!1,e.volume=pn.volume,Kr.length>=Vb){const s=Kr.shift();s&&(s.pause(),s.currentTime=0)}Kr.push(e);const t=()=>{const s=Kr.indexOf(e);s>=0&&Kr.splice(s,1)};e.addEventListener("ended",t,{once:!0}),e.addEventListener("pause",t,{once:!0});const n=e.play();n&&typeof n.catch=="function"&&n.catch(()=>{t();const s=pn.getAttribute("data-fallback-applied")==="1";i!==wi&&!s&&(pn.setAttribute("data-fallback-applied","1"),bm(pn,wi))})},Qb=i=>{const e=i.distanceTo(de.position);if(e>=Of)return 0;const n=1-(Math.max(hl,e)-hl)/(Of-hl);return .02+Math.pow(Math.max(0,n),1.6)*.2},Bf=()=>{for(let i=0;i<ji.length;i+=1){const e=ji[i];e.pause(),e.currentTime=0}ji.length=0},eE=async(i,e="")=>{const t=Qb(i);if(t<=.02)return;let n=wi;e&&(n=await Sh(e));const s=new Audio(n||wi);if(s.preload="auto",s.loop=!1,s.volume=t*Pe.masterVolume*Pe.sfxVolume,ji.length>=Gb){const o=ji.shift();o&&(o.pause(),o.currentTime=0)}ji.push(s);const r=()=>{const o=ji.indexOf(s);o>=0&&ji.splice(o,1)};s.addEventListener("ended",r,{once:!0}),s.addEventListener("pause",r,{once:!0});const a=s.play();a&&typeof a.catch=="function"&&a.catch(()=>{r()})},lr=new f_;new Xe(0,0);const tE=new jo(.028,.028,1,10,1,!0),nE=new It({color:10682286,transparent:!0,opacity:1,blending:Li,depthWrite:!1}),iE=new li(.11,8,8),sE=new It({color:8257426,transparent:!0,opacity:.9}),ys=[],ur=[],oa=[],ca=[],la=[],ua=[],rE=new li(.045,6,6),Ss=[],aE=420,oE=680,cE=980,pt={KeyW:!1,KeyA:!1,KeyS:!1,KeyD:!1,Space:!1};let bs=!1,Pn=0,Ci=0;const Eh=9,lE=24,uE=18,hE=.45,dE=.92,vn=1.7,fE=6.8,pE=18;let si=!1,pl=0;const mE=8,gE=1,Cu=55,_E=19,zf=260,xE=.018,vE=.008,ME=1.2,yE=2.25,SE=1.2,ri=10,Et=100,Pa=100,sc=0,ss=30,Ia=120,hn=100,kf=Math.ceil(hn/3),bE=12,EE=50,TE=6e4,AE=12,wE=20,RE=30,CE=6e4,PE=25,IE=20,LE=6e4,DE=Et/3,NE=18,rc=.5,ac=.92,UE=.18,FE=-.45,ml=2.45,Pu=.9,Vf=.09,OE=320;let Th=0,Vt=Et,ai=sc,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,yt=!1,Ui=0,Ln=ri,br=!1,Ah=0,dr=0,gl=0,er=0,ya=0,fr=0,Em=0,Tm=0,wh=0,Rh=0,Am=0;const Hf=new Nn(0,0,0,"YXZ"),Ys=new P,_l=new P,Vn=new P,vt=new P,Gf=new P,BE=new p_,Ch=Math.PI,zE=170,kE=160,VE=4.8,HE=2.4,GE=9.5,WE=.55,XE=.32,qE=140,wm=220,jE=()=>Date.now(),YE=new qo(.2,.18,4,8),KE=new Un({color:5082623,emissive:1719696,emissiveIntensity:.85,roughness:.35,metalness:.4}),tr=[],$E=new sh(.32,0),ZE=new Un({color:4584703,emissive:1006976,emissiveIntensity:.9,roughness:.25,metalness:.3}),nr=[],ir=[],_o=i=>{let e=Number(i)>>>0;return()=>{e+=1831565813;let t=Math.imul(e^e>>>15,1|e);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},JE=i=>{const e=String(i||"");let t=2166136261;for(let n=0;n<e.length;n+=1)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0||1},QE=(i,e,t=0)=>!0,Wf=(i,e,t=0)=>({x:i,z:e}),eT=()=>{for(let i=al.length-1;i>=0;i-=1){const e=al[i];e&&(Ee.remove(e),e.traverse(t=>{t.isMesh&&(t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(s=>s.dispose()))}))}al.length=0,Au.length=0},es=i=>{ra=Math.min(1,ra+.5),i&&Ib.copy(i)},Rm=i=>{const e=Number(i);if(!Number.isFinite(e)||Nf===e)return;Nf=e;for(let a=Ji.length-1;a>=0;a-=1){const o=Ji[a];Ee.remove(o),o.geometry.dispose(),o.material.dispose()}Ji.length=0,ko.length=0,eT();for(let a=tr.length-1;a>=0;a-=1)Ee.remove(tr[a].mesh);tr.length=0;for(let a=nr.length-1;a>=0;a-=1)Ee.remove(nr[a].mesh);nr.length=0;for(let a=ir.length-1;a>=0;a-=1)Ee.remove(ir[a].mesh);ir.length=0;const t=_o(e^2654435769);for(let a=0;a<220;a+=1){const o=1+t()*3,c=1+t()*3,l=3+t()*24,u=new Je(new Rs(o,l,c),Ab.clone());u.position.set((t()-.5)*220,l/2,(t()-.5)*220),u.userData.hp=1+Math.floor(t()*3),Ee.add(u),Ji.push(u),ko.push({minX:u.position.x-o/2,maxX:u.position.x+o/2,minZ:u.position.z-c/2,maxZ:u.position.z+c/2})}const n=_o(e^2246822507);for(let a=0;a<EE;a+=1){const o=ol("mana",()=>new Je(YE,KE.clone())),c=(n()-.5)*180,l=(n()-.5)*180,u=.35;o.position.set(c,u,l),Ee.add(o),tr.push({mesh:o,baseY:u,phase:n()*Math.PI*2,active:!0,respawnAt:0})}const s=_o(e^3266489909);for(let a=0;a<RE;a+=1){const o=ol("defensa",()=>new Je($E,ZE.clone())),c=(s()-.5)*180,l=(s()-.5)*180,u=.6;o.position.set(c,u,l),Ee.add(o),nr.push({mesh:o,baseY:u,phase:s()*Math.PI*2,active:!0,respawnAt:0})}const r=_o(e^668265263);for(let a=0;a<IE;a+=1){const o=ol("vida",()=>new Je(new rh(.34,0),new Un({color:9502623,emissive:2985794,emissiveIntensity:.8,roughness:.32,metalness:.25}))),c=(r()-.5)*180,l=(r()-.5)*180,u=.55;o.position.set(c,u,l),Ee.add(o),ir.push({mesh:o,baseY:u,phase:r()*Math.PI*2,active:!0,respawnAt:0})}},oc=i=>String(i||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,""),Ph=i=>{const e=oc(i);return e==="silentman"||e==="silenmant"},Ih=i=>oc(i)==="pumori",Lh=i=>oc(i)==="neoorphen",Dh=i=>{const e=oc(i);return e==="pezunalunar"||e==="pezuanalunar"},Fr=i=>Ph(i)||Ih(i)||Lh(i)||Dh(i),tT=()=>Fr(et)?gE:1/mE;Rm(1);const Pt=()=>{const i=Fr(et),e=i?Math.round(Lt):Pi,t=i?hn:ei,n=i?"Mana":"Balas",s=Math.round(Vt),r=Math.round(ai);if(jS.textContent=`Vida: ${s}`,YS.textContent=`Escudo: ${r}`,KS.textContent=`${n}: ${e} / ${t}${!i&&jn?" (recargando...)":""}`,nb.textContent=`Kills: ${Th}`,$S.textContent=`${s}`,ZS.textContent=`${r}`,JS.textContent=`${e} / ${t}`,QS.style.width=`${Math.max(0,Math.min(100,Vt/Et*100))}%`,eb.style.width=`${Math.max(0,Math.min(100,ai/Pa*100))}%`,tb.style.height=`${Math.max(0,Math.min(100,e/t*100))}%`,!H.joinedRoom){Sf.textContent="Sala: -",bf.textContent="Estado: waiting",Ef.textContent="Clima: -",Tf.textContent="Jugadores: -",il.classList.add("hidden");return}const a=H.joinedRoom.room,o=H.joinedRoom.players.map(c=>c.name).join(", ");Sf.textContent=`Sala: ${a.name} (${a.id})`,bf.textContent=`Estado: ${a.status}`,Ef.textContent=`Clima: ${xb(a.weather)}`,Tf.textContent=`Jugadores: ${o||"-"}`,nm()?(il.classList.remove("hidden"),Gp.disabled=a.status==="in_game",Wp.disabled=a.status!=="in_game"):il.classList.add("hidden"),tm(),fh(),Dr(),Cm()},oi=()=>{if(!yt||!H.joinedRoom||!xa()){Mf.classList.add("hidden");return}WS.textContent=String(Ln),Mf.classList.remove("hidden")},vs=()=>{br=!1,Ah=0,dr=0,Hp.classList.add("hidden")},nT=(i,e)=>{const t=String(i?.name||"Desconocido"),n=String(i?.character||"Sin personaje"),s=Math.max(1,Number(e)||10);br=!0,Ah=performance.now()+s*1e3,dr=s,XS.textContent=`Ganador: ${t} (${n})`,gu.textContent=String(dr),Hp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),si=!1,yt&&(yt=!1,Ui=0,Ln=ri,oi())},Cm=(i=0)=>{if(!nl)return;const e=!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"),n=1-Math.max(0,Math.min(1,Vt/Et));let s=e&&!yt?n*.62:0;e||(er=0);const r=i>0?Math.min(1,i*4.8):1;gl+=(s-gl)*r,er=Math.max(0,er-(i>0?i*1.7:0));const a=e&&!yt?(Math.sin(performance.now()*.01)+1)*.5*n*.22:0,o=Math.max(0,Math.min(.92,gl+a+er));nl.style.opacity=o.toFixed(3),nl.style.setProperty("--bleed-inner",`${20+n*24}%`)},iT=(i=!1)=>{const e=performance.now();Em=e+140,i&&(Tm=e+220)},sT=()=>{wh=performance.now()+320},rT=i=>{if(!i||!H.remotePlayers.has(i))return;const e=H.remotePlayers.get(i);if(!e?.group)return;const t=e.group.position.x-de.position.x,n=e.group.position.z-de.position.z;Am=(Math.atan2(t,-n)-Pn)*180/Math.PI,Rh=performance.now()+520},aT=()=>{if(!jr)return;const i=performance.now(),e=Math.sqrt(vt.x*vt.x+vt.z*vt.z),t=Math.min(1,e/Math.max(.001,Eh)),n=Ht?.85:0,s=5+t*7.5+n*6+ya*10+fr*6.5;jr.style.setProperty("--crosshair-gap",`${s.toFixed(2)}px`),jr.classList.toggle("hit",i<=Em),jr.classList.toggle("headshot",i<=Tm),jr.classList.toggle("kill",i<=wh)},oT=()=>{if(!lo)return;if(!(performance.now()<=Rh)){lo.classList.remove("visible");return}lo.classList.add("visible"),lo.style.setProperty("--damage-angle",`${Am.toFixed(1)}deg`)},Co=()=>{Vt=Et,ai=sc,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,Th=0,yt=!1,Ln=ri,Ui=0,vs(),si=!1,wh=0,Rh=0,oi(),Pt()},Nh=()=>{Fr(et)||jn||Pi>=ss||ei<=0||!On()||(jn=!0,hr=SE,Pt())},cT=()=>{Vt=Et,ai=sc,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,yt=!1,Ln=ri,Ui=0,oi(),en({type:"player_respawn"}),Pt()},Pm=()=>{xa()&&(yt=!0,si=!1,Ht=!1,Si=0,Ui=performance.now()+ri*1e3,Ln=ri,document.pointerLockElement&&document.exitPointerLock(),oi())},Xf=(i,e,t)=>{const n=(e-i+Math.PI)%(Math.PI*2)-Math.PI;return i+n*t},ms=(i,e,t)=>{const n=i.find(s=>s.name===e);return n||i.find(s=>{const r=String(s.name||"").toLowerCase();return t.some(a=>r.includes(a))})},Uh=i=>{const e=String(i||"").trim();if(!e)return on[0]||et||"silentman";if(on.includes(e))return e;const t=e.toLowerCase(),n=on.find(s=>Ho(s).toLowerCase()===t);return n||e},bi=(i,e)=>{if(!i.actions)return;const t=i.actions[e]||i.actions.move||null;t&&i.currentAnimation!==e&&(Object.values(i.actions).forEach(n=>{!n||n===t||n.fadeOut(.12)}),e==="death"?(t.reset(),t.setLoop(Wu,1),t.clampWhenFinished=!0,t.fadeIn(.08).play()):(t.reset(),t.setLoop(Xo,1/0),t.clampWhenFinished=!1,t.fadeIn(.1).play()),i.currentAnimation=e)},Sa=i=>{i.actions&&bi(i,"idle")},Yi=i=>{if(!Ke.actions)return;const e=Ke.actions[i]||Ke.actions.move||null;e&&Ke.currentAnimation!==i&&(Object.values(Ke.actions).forEach(t=>{!t||t===e||t.fadeOut(.1)}),i==="death"||i==="funny"?(e.reset(),e.setLoop(Wu,1),e.clampWhenFinished=!0,e.fadeIn(.08).play()):(e.reset(),e.setLoop(Xo,1/0),e.clampWhenFinished=!1,e.fadeIn(.08).play()),Ke.currentAnimation=i)},Po=()=>{Ke.funnyUntil<=0||(Ke.funnyUntil=0,Ke.currentAnimation==="funny"&&Yi("idle"))},Im=i=>{const e=new un,t=uh(i.scene),n=new Mn().setFromObject(t),s=Number.isFinite(n.min.y)?n.min.y:0;t.position.y-=s,e.add(t);const r=new Pp(t),a=i.animations||[],o=i.animationSet?.idle||ms(a,"idle",["idle"]),c=i.animationSet?.running||ms(a,"running",["running"]),l=i.animationSet?.jump||ms(a,"jump",["jump"]),u=i.animationSet?.funny||ms(a,"funny",["funny"]),h=i.animationSet?.attack||ms(a,"attack",["attack"]),d=i.animationSet?.dead||ms(a,"dead",["dead"]),f={idle:o?r.clipAction(o):null,move:c?r.clipAction(c):null,jump:l?r.clipAction(l):null,funny:u?r.clipAction(u):null,shoot:h?r.clipAction(h):null,death:d?r.clipAction(d):null};return Ee.add(e),{group:e,avatarRoot:t,mixer:r,actions:f,body:null,head:null}},lT=()=>{Ke.group&&Ee.remove(Ke.group),Ke.group=null,Ke.mixer=null,Ke.actions=null,Ke.currentAnimation="",Ke.funnyUntil=0},Fh=async()=>{const i=tn.value||et;if(!i)return;const e=`${i}`;Ke.loadingKey=e;const t=await Nr(i);if(!t?.loaded||Ke.loadingKey!==e)return;lT();const n=Im(t);Ke.group=n.group,Ke.mixer=n.mixer,Ke.actions=n.actions,Ke.currentAnimation="",Ke.shootUntil=0,Ke.funnyUntil=0,Yi("idle")},uT=i=>{if(!Ke.group)return;const e=!!(H.joinedRoom&&or&&!yt);if(Ke.group.visible=e,!e)return;Ke.group.position.set(de.position.x,de.position.y-vn,de.position.z),Ke.group.rotation.y=Pn+Ch;const t=performance.now(),n=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD;Ke.funnyUntil>t?Yi("funny"):Ht?Yi("jump"):Ke.shootUntil>t?Yi("shoot"):Yi(n?"move":"idle"),Ke.mixer&&Ke.mixer.update(i)},hT=i=>{const e=new un,t=new Un({color:i?4835839:6815591,emissive:i?731702:1003290,emissiveIntensity:.6,roughness:.6}),n=t.clone(),s=new Je(new qo(.35,.9,4,8),t),r=new Je(new li(.22,12,12),n);return s.position.y=1.15,r.position.y=1.95,e.add(s),e.add(r),Ee.add(e),{group:e,avatarRoot:e,body:s,head:r,mixer:null,actions:null}},ba=async i=>{const e=Uh(i.character);if(!e)return;const t=await Nr(e);if(!t?.loaded||!H.remotePlayers.has(i.id))return;const n=H.remotePlayers.get(i.id);if(!n)return;n.character=e;const s=n.group.position.clone(),r=n.group.rotation.y;cc(n);const a=Im(t);a.group.position.copy(s),a.group.rotation.y=r,n.group=a.group,n.avatarRoot=a.avatarRoot,n.body=a.body,n.head=a.head,n.mixer=a.mixer,n.actions=a.actions,n.currentAnimation=null,n.animationUntil=0,n.isDead=!1,n.isJumping=!1,n.deadAt=0;const o=Bm();n.group.add(o.holder),n.healthBar=o,Es(n),Sa(n)},cc=i=>{i.healthBar&&(i.healthBar.holder?.parent&&i.healthBar.holder.parent.remove(i.healthBar.holder),i.healthBar.bg&&(i.healthBar.bg.geometry.dispose(),i.healthBar.bg.material.dispose()),i.healthBar.fill&&(i.healthBar.fill.geometry.dispose(),i.healthBar.fill.material.dispose()),i.healthBar.text&&(i.healthBar.text.geometry.dispose(),i.healthBar.text.material.dispose()),i.healthBar.textTexture&&i.healthBar.textTexture.dispose(),i.healthBar=null),Ee.remove(i.group),i.body&&(i.body.geometry.dispose(),i.body.material.dispose()),i.head&&(i.head.geometry.dispose(),i.head.material.dispose())},dT=(i,e,t)=>{const n=hT(e),s=Uh(t);H.remotePlayers.set(i,{id:i,name:"Player",character:s,group:n.group,avatarRoot:n.avatarRoot,body:n.body,head:n.head,mixer:n.mixer,actions:n.actions,currentAnimation:null,animationUntil:0,isDead:!1,health:Et,isJumping:!1,deadAt:0,targetPosition:new P(0,0,0),targetYaw:0,targetPitch:0,netSnapshots:[],netInitialized:!1,smoothedMoveSpeed:0,movingUntil:0,lastAnimationAt:0,healthBar:null});const r=H.remotePlayers.get(i),a=Bm();r.group.add(a.holder),r.healthBar=a,Es(r),r.character||(r.character=on[0]||et||"silentman"),ba(r)},Iu=i=>{if(H.self&&i.id===H.self.id)return;H.remotePlayers.has(i.id)||dT(i.id,H.joinedRoom?.room?.hostId===i.id,i.character);const e=H.remotePlayers.get(i.id);i.name&&(e.name=String(i.name));const n=typeof i.character=="string"&&i.character.length>0?Uh(i.character):e.character;n!==e.character&&(e.character=n||e.character,ba(e)),e.mixer||(e.character||(e.character=on[0]||et||"silentman"),e.character&&ba(e));const s=i.state?.position||{x:0,y:vn,z:0},r=i.state?.rotation||{yaw:0,pitch:0},a=!!i.state?.moving,o=Number.isFinite(Number(i.ts))?Number(i.ts):Date.now();e.isJumping=!!i.state?.jumping,a&&(e.movingUntil=Math.max(Number(e.movingUntil||0),performance.now()+wm)),Number.isFinite(Number(i.health))&&(e.health=Math.max(0,Math.min(Et,Math.round(Number(i.health)))),Es(e)),typeof i.alive=="boolean"&&(!i.alive&&!e.isDead?(e.isDead=!0,e.deadAt=performance.now(),e.animationUntil=0,bi(e,"death"),Es(e)):i.alive&&e.isDead&&(e.isDead=!1,e.deadAt=0,e.animationUntil=0,Sa(e),Number.isFinite(Number(i.health))||(e.health=Et),Es(e)));const l={ts:o,x:s.x,y:s.y-vn,z:s.z,yaw:r.yaw,pitch:r.pitch,jumping:!!i.state?.jumping,moving:a};e.netSnapshots.push(l),e.netSnapshots.length>32&&e.netSnapshots.splice(0,e.netSnapshots.length-32),e.netInitialized||(e.group.position.set(l.x,l.y,l.z),e.targetPosition.set(l.x,l.y,l.z),e.group.rotation.y=l.yaw+Ch,e.targetYaw=l.yaw,e.targetPitch=l.pitch,e.smoothedMoveSpeed=0,e.netInitialized=!0)},fT=i=>{const e=new Set;i.players.forEach(t=>{H.self&&t.id===H.self.id||(e.add(t.id),Iu(t))});for(const[t,n]of H.remotePlayers.entries())e.has(t)||(cc(n),H.remotePlayers.delete(t))},qf=()=>{for(const i of H.remotePlayers.values())cc(i);H.remotePlayers.clear()},Dn=(i,e,t=10682286,n={})=>{const s=e.clone().sub(i),r=s.length();if(r<=1e-4)return;const a=Number.isFinite(n.radiusScale)?n.radiusScale:1,o=Number.isFinite(n.life)?n.life:.14,c=Number.isFinite(n.opacity)?n.opacity:1,l=nE.clone();l.color=new Ce(t),l.opacity=c;const u=new Je(tE,l);if(u.position.copy(i).add(e).multiplyScalar(.5),u.quaternion.setFromUnitVectors(new P(0,1,0),s.normalize()),u.scale.set(a,r,a),u.userData.life=o,Ee.add(u),ys.push(u),ys.length>aE){const h=ys.shift();h&&(Ee.remove(h),h.material.dispose())}},Lm=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.22,14,14),new It({color:10154239,transparent:!0,opacity:.96,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),oa.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:85,phase:Math.random()*Math.PI*2,spin:Math.PI*15+Math.random()*Math.PI*6,radius:.72,radiusFalloff:.22,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Dm=(i,e,t={})=>{const n=e.clone().sub(i);if(n.length()<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new un,l=new Je(new Rs(.46,.26,.22),new It({color:16773830,transparent:!0,opacity:.98,blending:Li,depthWrite:!1})),u=new Je(new jo(.05,.05,.7,10),new It({color:10154239,transparent:!0,opacity:.95,blending:Li,depthWrite:!1}));u.rotation.z=Math.PI/2,c.add(l),c.add(u),c.position.copy(i),Ee.add(c),ca.push({mesh:c,prevPos:i.clone(),pos:i.clone(),velocity:r.clone().multiplyScalar(34).add(o.clone().multiplyScalar(7.2)),origin:i.clone(),right:a,up:o,traveledDistance:0,spin:(Math.random()>.5?1:-1)*(Math.PI*6.5+Math.random()),phase:Math.random()*Math.PI*2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Nm=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.3,16,16),new It({color:6029158,transparent:!0,opacity:.9,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),la.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:60,phase:Math.random()*Math.PI*2,spin:Math.PI*9+Math.random()*Math.PI*3,waveAmpA:1.05,waveAmpB:.42,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Um=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.22,16,16),new It({color:15267839,transparent:!0,opacity:.96,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),ua.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:80,phase:Math.random()*Math.PI*2,spin:Math.PI*10+Math.random()*Math.PI*4,waveAmpA:.4,waveAmpB:.2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Jt=(i,e=8257426)=>{if(ur.length>=oE)return null;const t=new Je(iE,sE.clone());return t.material.color=new Ce(e),t.position.copy(i),t.userData.life=.26,Ee.add(t),ur.push(t),t},Go=(i,e,t,n)=>{const s=e.clone().sub(i),r=s.length();if(r<=1e-4)return null;s.multiplyScalar(1/r);const o=t.clone().sub(i).dot(s);if(o<0||o>r)return null;const c=s.multiplyScalar(o).add(i);return c.distanceToSquared(t)<=n*n?c:null},lc=(i,e,t=.2)=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return null;const r=n.multiplyScalar(1/s);lr.set(i,r),lr.far=s+t;const a=lr.intersectObjects(Ji,!1);return a.length>0?a[0].point.clone():null},uc=(i,e)=>{const t=de.position.clone().add(new P(0,UE,0)),n=de.position.clone().add(new P(0,FE,0)),s=Go(i,e,t,rc);if(s)return{point:s,headshot:!0};const r=Go(i,e,n,ac);return r?{point:r,headshot:!1}:null},hc=(i,e)=>{},pT=i=>{if(!H.self)return;const e=i.players.find(s=>s.id===H.self.id);if(!e)return;const t=e.state?.position,n=e.state?.rotation;t&&(de.position.set(t.x,t.y,t.z),km(),Ht=!!e.state?.jumping,!Ht&&de.position.y<=vn+.001&&(Si=0)),n&&(Pn=n.yaw,Ci=n.pitch,dc()),Th=Number.isFinite(e.kills)?e.kills:0,Number.isFinite(e.health)&&(Vt=Math.max(0,Math.min(Et,Number(e.health)))),Number.isFinite(e.shield)&&(ai=Math.max(0,Math.min(Pa,Math.round(e.shield)))),Number.isFinite(e.mana)&&(Lt=Math.max(0,Math.min(hn,Math.round(e.mana))),ti=Math.round(Lt)),Number.isFinite(Number(e.pendingHealthRegen))&&(Kt=Math.max(0,Number(e.pendingHealthRegen))),Uu(),e.alive===!1&&!yt&&xa()&&Pm(),e.alive===!0&&yt&&(yt=!1,Ui=0,Ln=ri,oi())},jf=(i,e={})=>{const t=!H.joinedRoom;H.joinedRoom=i;const n=Number.isFinite(i.room?.mapSeed)?i.room.mapSeed:JE(i.room?.id);Rm(n),fT(i),sa(i.room?.weather),Ro(i.room?.battleTheme),(e.applyOwnState||t)&&pT(i),t&&Co(),zo(!0),nm()&&i.room.status!=="in_game"&&en({type:"start_game"}),i.room.status!=="cooldown"&&vs(),Pt()},Fm=()=>{const i=yb(),e=new WebSocket(i);H.ws=e,el.textContent=`Conectando a ${i}`,e.addEventListener("open",()=>{el.textContent="Conectado",Js(),en({type:"list_rooms"})}),e.addEventListener("message",t=>{let n;try{n=JSON.parse(t.data)}catch{Js("Respuesta invalida del servidor");return}if(n.ok===!1&&n.error){Js(n.error.message||"Error del servidor");return}if(n.type==="connected"){H.self=n.data.player,Vp.value=H.self.name,H.self.character&&on.includes(H.self.character)&&(et=H.self.character,tn.value=H.self.character),ic(H.self.character||et),H.rooms=n.data.rooms||[],Ur(),Eu();return}if(n.type==="rooms_list"){H.rooms=n.data||[],Eu();return}if(n.type==="room_joined"){jf(n.data,{applyOwnState:!0});return}if(n.type==="room_state"){jf(n.data);return}if(n.type==="left_room"){H.joinedRoom=null,H.showScoreboard=!1,vi=null,H.latencyMs=null,qf(),zo(!1),Bf(),sa("night"),Ro("battle1"),Co(),vs(),Pt(),Ri();return}if(n.type==="pong"){const s=String(n.data?.probeId||"");vi&&s===vi.id&&(H.latencyMs=performance.now()-vi.sentAt,vi=null,Dr());return}if(n.type==="player_joined"){n.data?.player&&Iu(n.data.player);return}if(n.type==="player_left"){const s=n.data?.playerId;s&&H.remotePlayers.has(s)&&(cc(H.remotePlayers.get(s)),H.remotePlayers.delete(s));return}if(n.type==="player_move"){const{playerId:s,position:r,rotation:a,character:o,jumping:c,moving:l,ts:u}=n.data||{};if(!s||H.self&&s===H.self.id)return;Iu({id:s,ts:u,character:o,state:{position:r,rotation:a,jumping:c,moving:l}});return}if(n.type==="player_shoot"){const s=n.data;if(!s)return;const r=s.playerId?H.remotePlayers.get(s.playerId):null,a=s.character||r?.character||"",o=Ph(a),c=Ih(a),l=Lh(a),u=Dh(a);if(s.playerId&&H.remotePlayers.has(s.playerId)){const m=H.remotePlayers.get(s.playerId);m.isDead||(bi(m,"shoot"),m.animationUntil=performance.now()+420)}const h=new P(s.origin.x,s.origin.y,s.origin.z),d=new P(s.direction.x,s.direction.y,s.direction.z).normalize(),f=s.distance||100,_=h.clone().add(d.clone().multiplyScalar(f)).clone();o?(Lm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):c?(Dm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):l?(Nm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):u?(Um(h,_,{source:"remote",ownerId:s.playerId}),es(h)):(Dn(h,_,5885183),Jt(_,5885183)),eE(h,a);return}if(n.type==="player_damage"){if(!H.self||!On())return;const s=Number(n.data?.health),r=Number(n.data?.shield),a=!!n.data?.headshot;Number.isFinite(s)&&(Vt=Math.max(0,Math.min(Et,s))),Number.isFinite(r)&&(ai=Math.max(0,Math.min(Pa,Math.round(r)))),Uu(),er=Math.min(.45,er+(a?.35:.2)),rT(n.data?.fromPlayerId),Pt();return}if(n.type==="hit_confirm"){iT(!!n.data?.headshot);return}if(n.type==="player_resources"){const s=Number(n.data?.mana),r=Number(n.data?.health),a=Number(n.data?.pendingHealthRegen);let o=!1;Number.isFinite(s)&&(Lt=Math.max(0,Math.min(hn,Math.round(s))),ti=Math.round(Lt),o=!0),Number.isFinite(r)&&(Vt=Math.max(0,Math.min(Et,r)),o=!0),Number.isFinite(a)&&(Kt=Math.max(0,a)),Uu(),o&&Pt();return}if(n.type==="player_death"){const s=n.data?.playerId;if(!s)return;if(H.self&&n.data?.killerId===H.self.id&&s!==H.self.id&&sT(),H.self&&s===H.self.id){Vt=0,Kt=0,Pt(),Pm();return}if(!H.remotePlayers.has(s))return;const r=H.remotePlayers.get(s);r.isDead=!0,r.health=0,r.isJumping=!1,r.deadAt=performance.now(),bi(r,"death"),r.animationUntil=0,Es(r);return}if(n.type==="player_respawned"){const s=n.data?.playerId;if(!s)return;if(H.self&&s===H.self.id){const o=n.data?.position;o&&Number.isFinite(Number(o.x))&&Number.isFinite(Number(o.y))&&Number.isFinite(Number(o.z))&&(de.position.set(Number(o.x),Number(o.y),Number(o.z)),km()),Vt=Number.isFinite(n.data?.health)?Number(n.data.health):Et,ai=Number.isFinite(n.data?.shield)?Math.round(n.data.shield):sc,Number.isFinite(n.data?.mana)&&(Lt=Math.round(n.data.mana),ti=Math.round(Lt)),Kt=0,yt=!1,Ui=0,Ln=ri,oi(),Pt();return}const r=H.remotePlayers.get(s);if(!r)return;r.isDead=!1,r.deadAt=0,r.health=Number.isFinite(Number(n.data?.health))?Math.max(0,Math.min(Et,Math.round(Number(n.data.health)))):Et,r.animationUntil=0,Sa(r);const a=n.data?.position;if(a&&Number.isFinite(Number(a.x))&&Number.isFinite(Number(a.y))&&Number.isFinite(Number(a.z))){const o=Number(a.x),c=Number(a.y)-vn,l=Number(a.z);r.group.position.set(o,c,l),r.targetPosition.set(o,c,l)}Es(r);return}if(n.type==="chat_message"){const s=n.data||{},r=String(s.playerName||"Player"),a=String(s.text||"").trim();if(!a)return;pb(r,a),hh.classList.add("open");return}if(n.type==="player_funny"){const s=n.data?.playerId;if(!s||!H.remotePlayers.has(s))return;const r=H.remotePlayers.get(s);if(r.isDead)return;r.currentAnimation==="funny"&&(r.currentAnimation=""),bi(r,"funny");const a=r.actions?.funny,o=Math.max(500,Math.round((a?.getClip()?.duration||1)*1e3));r.animationUntil=performance.now()+o;return}if(n.type==="game_state"){H.joinedRoom&&H.joinedRoom.room.id===n.data.roomId&&(H.joinedRoom.room.status=n.data.status,H.joinedRoom.room.hostId=n.data.hostId,n.data.weather&&(H.joinedRoom.room.weather=n.data.weather,sa(n.data.weather)),n.data.battleTheme&&(H.joinedRoom.room.battleTheme=n.data.battleTheme,Ro(n.data.battleTheme)),n.data.status!=="in_game"&&yt&&(yt=!1,Ui=0,Ln=ri,oi()),n.data.status!=="cooldown"&&vs(),Pt(),Ri());return}if(n.type==="match_winner"){if(!H.joinedRoom)return;nT(n.data?.winner,n.data?.countdownSeconds);return}if(n.type==="match_reset"){vs(),Co(),Pt();return}}),e.addEventListener("close",()=>{el.textContent="Desconectado. Reintentando...",H.joinedRoom=null,H.showScoreboard=!1,vi=null,H.latencyMs=null,qf(),zo(!1),Bf(),sa("night"),Ro("battle1"),Co(),vs(),Pt(),Ri(),setTimeout(Fm,1200)}),e.addEventListener("error",()=>{Js("No se pudo conectar al WebSocket")})};tn.addEventListener("change",()=>{et=tn.value||et,H.self&&(H.self.character=et),ic(et),Nr(et),Fh(),Ur(),Pt()});GS.addEventListener("click",()=>{en({type:"list_rooms"}),kb()});ub.addEventListener("click",()=>{en({type:"leave_room"})});Gp.addEventListener("click",()=>{en({type:"start_game"})});Wp.addEventListener("click",()=>{en({type:"end_game"})});hb.addEventListener("click",()=>{nc()});db.addEventListener("click",()=>{nc(),en({type:"leave_room"})});_u.addEventListener("input",()=>{Pe.mouseSensitivity=qn(_u.value,.4,2.5,Pe.mouseSensitivity),Yp.textContent=Pe.mouseSensitivity.toFixed(2),Lr()});xu.addEventListener("input",()=>{Pe.masterVolume=qn(xu.value,0,1,Pe.masterVolume),Kp.textContent=`${Math.round(Pe.masterVolume*100)}%`,Ca(),Lr()});vu.addEventListener("input",()=>{Pe.musicVolume=qn(vu.value,0,1,Pe.musicVolume),$p.textContent=`${Math.round(Pe.musicVolume*100)}%`,Ca(),Lr()});Mu.addEventListener("input",()=>{Pe.sfxVolume=qn(Mu.value,0,1,Pe.sfxVolume),Zp.textContent=`${Math.round(Pe.sfxVolume*100)}%`,Ca(),Lr()});yu.addEventListener("input",()=>{Pe.fov=qn(yu.value,60,100,Pe.fov),Jp.textContent=String(Math.round(Pe.fov)),Ca(),Lr()});Su.addEventListener("change",()=>{Pe.showPerfByDefault=!!Su.checked,!H.showPerf&&Pe.showPerfByDefault&&(H.showPerf=!0,ph(!0)),Dr(),Lr()});const dc=()=>{Hf.set(Ci,Pn,0),de.quaternion.setFromEuler(Hf)},Om=()=>{if(!or)return;If.copy(de.position),de.getWorldDirection(fo),fo.normalize();const i=If.clone().add(fo.clone().multiplyScalar(18));Lf.set(-Math.sin(Pn),0,-Math.cos(Pn)).normalize(),Df.set(Math.cos(Pn),0,-Math.sin(Pn)).normalize(),ho.copy(de.position).addScaledVector(fo,-.8).add(new P(0,bb,0)).addScaledVector(Lf,-4.6).addScaledVector(Df,Eb),ho.y=Math.max(vn+.6,ho.y),As.position.lerp(ho,Tb),As.lookAt(i)},Lu=()=>or?As:de,mT=(i,e,t,n={})=>{let s=t,r=null;const a=new P,o=new P,c=new P,l=Number.isFinite(n.headRadius)?n.headRadius:rc,u=Number.isFinite(n.bodyRadius)?n.bodyRadius:ac,h=(d,f)=>{o.copy(d).sub(i);const g=o.dot(e);g<0||g>s||(c.copy(e).multiplyScalar(g).add(i),c.distanceToSquared(d)<=f*f&&(s=g,r=c.clone()))};for(const d of H.remotePlayers.values())!d?.group||d.isDead||(a.set(d.group.position.x,d.group.position.y+1.85,d.group.position.z),h(a,l),a.set(d.group.position.x,d.group.position.y+1.1,d.group.position.z),h(a,u));return r?{point:r,distance:s}:null},Bm=()=>{const i=new un,e=new Je(new ts(Pu,Vf),new It({color:1776411,transparent:!0,opacity:.78,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));e.renderOrder=999,e.position.set(0,ml,0),i.add(e);const t=new Je(new ts(Pu-.02,Vf-.02),new It({color:5701485,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));t.renderOrder=1e3,t.position.set(0,ml,.001),i.add(t);const n=document.createElement("canvas");n.width=256,n.height=64;const s=n.getContext("2d"),r=new T0(n);r.minFilter=Tt,r.magFilter=Tt,r.generateMipmaps=!1;const a=new Je(new ts(1.05,.18),new It({map:r,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));return a.renderOrder=1001,a.position.set(0,ml+.16,.001),i.add(a),{holder:i,bg:e,fill:t,text:a,textCanvas:n,textCtx:s,textTexture:r,lastText:""}},Es=i=>{if(!i?.healthBar?.fill)return;const e=Number.isFinite(Number(i.health))?Number(i.health):Et,t=Math.max(0,Math.min(1,e/Et));i.healthBar.fill.scale.x=Math.max(.001,t),i.healthBar.fill.position.x=(t-1)*(Pu-.02)*.5,t>.66?i.healthBar.fill.material.color.set(5701485):t>.33?i.healthBar.fill.material.color.set(16769898):i.healthBar.fill.material.color.set(16738151);const n=`${String(i.name||"Player")} ${Math.round(e)}`;if(i.healthBar.lastText!==n&&i.healthBar.textCtx){const s=i.healthBar.textCtx;s.clearRect(0,0,i.healthBar.textCanvas.width,i.healthBar.textCanvas.height),s.font="bold 24px Courier New, monospace",s.textAlign="center",s.textBaseline="middle",s.strokeStyle="rgba(0, 0, 0, 0.75)",s.lineWidth=6,s.strokeText(n,i.healthBar.textCanvas.width/2,32),s.fillStyle="#d8ffd8",s.fillText(n,i.healthBar.textCanvas.width/2,32),i.healthBar.textTexture.needsUpdate=!0,i.healthBar.lastText=n}i.healthBar.holder.visible=!i.isDead},Ea=(i=!1)=>{if(!H.joinedRoom)return;const e=performance.now();if(!i&&e-H.lastStateSentAt<55)return;H.lastStateSentAt=e;const t=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD||vt.lengthSq()>.5;en({type:"player_move",position:{x:de.position.x,y:de.position.y,z:de.position.z},rotation:{yaw:Pn,pitch:Ci},jumping:Ht,moving:t})},Du=(i,e)=>{for(let t=0;t<ko.length;t+=1){const n=ko[t];if(i+Qi>n.minX&&i-Qi<n.maxX&&e+Qi>n.minZ&&e-Qi<n.maxZ)return!0}return!1},Nu=(i,e)=>QE(i,e,Qi+.05)?!Du(i,e):!1,gT=(i,e)=>{const t=Wf(i,e,Qi+.05);if(Nu(t.x,t.z))return t;const n=14;for(let s=.6;s<=n;s+=.6)for(let a=0;a<24;a+=1){const o=a/24*Math.PI*2,c=Wf(t.x+Math.cos(o)*s,t.z+Math.sin(o)*s,Qi+.05);if(Nu(c.x,c.z))return c}return t},zm=(i,e)=>{const t=de.position.x,n=de.position.z,s=wb-Qi,r=Math.max(-s,Math.min(s,i)),a=Math.max(-s,Math.min(s,e));let o=t,c=n;return Du(r,n)||(o=r),Du(o,a)||(c=a),{x:o,z:c}},km=()=>{if(!Nu(de.position.x,de.position.z)){const e=gT(de.position.x,de.position.z);de.position.x=e.x,de.position.z=e.z}const i=zm(de.position.x,de.position.z);de.position.x=i.x,de.position.z=i.z,de.position.y=Math.max(vn,de.position.y)};mn.domElement.addEventListener("click",()=>{!bs&&H.joinedRoom&&mn.domElement.requestPointerLock()});document.addEventListener("pointerlockchange",()=>{bs=document.pointerLockElement===mn.domElement,Jo.classList.toggle("locked",bs),bs||(si=!1,H.joinedRoom&&!Ir&&!yt&&!br&&!ns&&Sm())});document.addEventListener("mousemove",i=>{if(!bs||!On())return;const e=.0021*Pe.mouseSensitivity;Pn-=i.movementX*e,Ci-=i.movementY*e,Ci=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,Ci)),dc(),Ea()});window.addEventListener("mousedown",i=>{i.button===0&&bs&&On()&&(Po(),si=!0)});window.addEventListener("mouseup",i=>{i.button===0&&(si=!1)});window.addEventListener("keydown",i=>{if(i.code==="Escape"&&!ns){i.preventDefault(),Kb();return}if(i.code==="Enter"){if(i.preventDefault(),!H.joinedRoom)return;if(!ns){mb();return}const e=Bo.value.trim();e&&en({type:"chat_message",text:e}),bu();return}if(ns){i.code==="Escape"&&(i.preventDefault(),bu());return}if(i.code==="Tab"&&(i.preventDefault(),H.joinedRoom&&(H.showScoreboard=!0,fh())),i.code==="KeyI"&&(H.showMatchInfo=!H.showMatchInfo,tm()),i.code==="KeyP"&&(H.showPerf=!H.showPerf,H.showPerf&&ph(!0),Dr()),i.code==="KeyF"){if(i.preventDefault(),H.joinedRoom&&Ke.actions?.funny){const e=Ke.actions.funny.getClip(),t=Math.max(500,Math.round((e?.duration||1)*1e3));Ke.funnyUntil=performance.now()+t,Yi("funny"),en({type:"player_funny"})}return}i.code==="KeyC"&&(or=!or,or&&Om()),i.code==="Space"&&(i.preventDefault(),Po(),On()&&!Ht&&de.position.y<=vn+.001&&(Ht=!0,Si=fE,Ea(!0))),i.code==="KeyR"&&(Po(),Nh()),i.code in pt&&((i.code==="KeyW"||i.code==="KeyA"||i.code==="KeyS"||i.code==="KeyD")&&Po(),pt[i.code]=!0)});window.addEventListener("keyup",i=>{ns||(i.code==="Space"&&i.preventDefault(),i.code==="Tab"&&(H.showScoreboard=!1,fh()),i.code in pt&&(pt[i.code]=!1))});const _T=()=>{const i=Ph(et),e=Ih(et),t=Lh(et),n=Dh(et),s=i||e||t||n;if(s&&Lt<kf)return;if(!s&&Pi<=0){Nh();return}s?(Lt=Math.max(0,Lt-kf),ti=Math.round(Lt)):Pi-=1,Jb(),Ke.shootUntil=performance.now()+420,Pt(),de.getWorldDirection(Gf);const r=Gf.clone().normalize(),a=de.position.clone().add(r.clone().multiplyScalar(.55)),o=Math.sqrt(vt.x*vt.x+vt.z*vt.z),c=Math.min(1,o/Math.max(.001,Eh)),l=!s,u=l?(.0018+c*.0032+(Ht?.0055:0)+fr*.0048)*(1/Pe.mouseSensitivity):0,h=r.clone();if(u>0){const _=new P().crossVectors(h,de.up).normalize(),m=new P().crossVectors(_,h).normalize(),p=(Math.random()*2-1)*u,M=(Math.random()*2-1)*u;h.add(_.multiplyScalar(p)).add(m.multiplyScalar(M)).normalize()}lr.set(a,h),lr.far=220;const d=lr.intersectObjects(Ji,!1);let f=d.length>0?d[0].point:a.clone().add(h.clone().multiplyScalar(120));if(s||e||t){const _=mT(a,h,a.distanceTo(f),{headRadius:rc,bodyRadius:ac});_?.point&&f.copy(_.point)}e&&a.distanceTo(f)>Cu&&(f=a.clone().add(h.clone().multiplyScalar(Cu)));const g=a.distanceTo(f);if(i?(Lm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):e?(Dm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):t?(Nm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):n?(Um(a,f,{source:"local",ownerId:H.self?.id}),es(a)):(Dn(a,f),Jt(f)),en({type:"player_shoot",origin:{x:a.x,y:a.y,z:a.z},direction:{x:h.x,y:h.y,z:h.z},distance:g}),va.intensity=2.3,ya=Math.min(1.3,ya+.52+c*.14+(Ht?.18:0)),fr=Math.min(ME,fr+(l?.22+c*.18+(Ht?.24:0):.08)),Ci+=(Math.random()*.5+.5)*xE,Pn+=(Math.random()-.5)*vE,Ci=Math.min(Ci,Math.PI/2-.01),dc(),d.length>0){const _=d[0].object;_.material.emissiveIntensity=1.3}},xT=(i,e)=>{i.active=!1,i.respawnAt=e+TE,i.mesh.visible=!1,Fr(et)?(Lt=Math.min(hn,Lt+wE),ti=Math.round(Lt)):ei=Math.min(Ia,ei+AE),Pt()},vT=(i,e)=>{i.active=!1,i.respawnAt=e+CE,i.mesh.visible=!1,ai=Math.min(Pa,ai+PE),Pt()},MT=(i,e)=>{i.active=!1,i.respawnAt=e+LE,i.mesh.visible=!1;const t=Math.max(0,Et-(Vt+Kt)),n=Math.min(t,DE);n<=0||(Kt+=n,en({type:"player_pickup_health"}))},yT=i=>{if(!On()||yt||Vt<=0||Kt<=0)return;const e=Math.max(0,Et-Vt);if(e<=1e-4){Kt=0;return}const t=Math.min(e,Kt,NE*i);if(t<=1e-4)return;const n=Math.round(Vt);Vt+=t,Kt=Math.max(0,Kt-t),Math.round(Vt)!==n&&Pt()},Uu=()=>{const i=Math.max(0,Et-Vt);Kt=Math.max(0,Math.min(Kt,i))},Oh=2.2,Bh=.1,Er=(i,e)=>{if(!i?.mesh||!i.active||!i.mesh.visible)return;if(Ss.length>=cE){const o=Ss.shift();o&&(Ee.remove(o.mesh),o.mesh.geometry.dispose(),o.mesh.material.dispose())}const t=new It({color:e,transparent:!0,opacity:.55+Math.random()*.25,blending:Li,depthWrite:!1}),n=new Je(rE,t),s=Math.random()*Math.PI*2,r=.11+Math.random()*.28;n.position.set(i.mesh.position.x+Math.cos(s)*r,i.mesh.position.y+.08+Math.random()*.32,i.mesh.position.z+Math.sin(s)*r),Ee.add(n);const a=.95+Math.random()*.85;Ss.push({mesh:n,life:a,initialLife:a,velocity:new P((Math.random()-.5)*.16,1.6+Math.random()*1.25,(Math.random()-.5)*.16)})},ST=i=>{for(let e=Ss.length-1;e>=0;e-=1){const t=Ss[e];t.life-=i,t.mesh.position.addScaledVector(t.velocity,i),t.velocity.y+=i*.55,t.mesh.scale.multiplyScalar(1+i*1.45);const n=Math.max(0,t.life/t.initialLife);t.mesh.material.opacity=n*.75,t.life<=0&&(Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Ss.splice(e,1))}},bT=i=>{if(!On()||Ir){vt.multiplyScalar(Math.max(0,1-i*10));return}Vn.set(0,0,0),de.getWorldDirection(Ys),Ys.y=0,Ys.normalize(),_l.crossVectors(Ys,de.up).normalize(),pt.KeyW&&Vn.add(Ys),pt.KeyS&&Vn.sub(Ys),pt.KeyA&&Vn.sub(_l),pt.KeyD&&Vn.add(_l);const e=Vn.lengthSq()>0;e&&(Vn.normalize().multiplyScalar(Eh),(pt.KeyA||pt.KeyD)&&!(pt.KeyW||pt.KeyS)&&Vn.multiplyScalar(dE));const n=1-Math.exp(-((e?lE:uE)*(Ht?hE:1))*i);if(vt.x+=((e?Vn.x:0)-vt.x)*n,vt.z+=((e?Vn.z:0)-vt.z)*n,Math.abs(vt.x)<1e-4&&(vt.x=0),Math.abs(vt.z)<1e-4&&(vt.z=0),vt.lengthSq()>0){const s=de.position.x+vt.x*i,r=de.position.z+vt.z*i,a=zm(s,r),o=Math.abs(a.x-de.position.x)>1e-4||Math.abs(a.z-de.position.z)>1e-4;Math.abs(a.x-s)>2e-4&&(vt.x=0),Math.abs(a.z-r)>2e-4&&(vt.z=0),de.position.x=a.x,de.position.z=a.z,de.position.y=Math.max(vn,de.position.y),o&&Ea()}},ET=i=>{!Ht&&de.position.y<=vn+.001&&Si<=0||(Si-=pE*i,de.position.y+=Si*i,de.position.y<=vn?(de.position.y=vn,Si=0,Ht&&(Ht=!1,Ea(!0))):Ht=!0,Ea())},TT=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<tr.length;n+=1){const s=tr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*2.2,s.mesh.position.y=s.baseY+Math.sin(t*Oh+s.phase)*Bh,Math.random()<i*2.9&&(Er(s,9421823),Math.random()<.72&&Er(s,9421823)),!On()||(Fr(et)?Lt>=hn:ei>=Ia))continue;const r=de.position.x-s.mesh.position.x,a=de.position.z-s.mesh.position.z;r*r+a*a<=1.1*1.1&&xT(s,e)}},AT=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<nr.length;n+=1){const s=nr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.position.y=s.baseY+Math.sin(t*Oh+s.phase)*Bh,Math.random()<i*3.1&&(Er(s,9435135),Math.random()<.75&&Er(s,9435135)),!On()||ai>=Pa)continue;const r=de.position.x-s.mesh.position.x,a=de.position.z-s.mesh.position.z;r*r+a*a<=1.1*1.1&&vT(s,e)}},wT=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<ir.length;n+=1){const s=ir[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*1.9,s.mesh.position.y=s.baseY+Math.sin(t*Oh+s.phase)*Bh,Math.random()<i*3.5&&(Er(s,10878896),Math.random()<.82&&Er(s,10878896)),!On()||yt||Math.max(0,Et-(Vt+Kt))<=1e-4)continue;const a=de.position.x-s.mesh.position.x,o=de.position.z-s.mesh.position.z;a*a+o*o<=1.1*1.1&&MT(s,e)}},RT=i=>{if(!gh.visible)return;const e=.15+Math.sin(performance.now()*.0024)*.2;for(let t=0;t<Qo;t+=1){const n=t*3,s=t*3+1,r=t*3+2;Tn[s]-=Tu[t]*i,Tn[n]+=e*i*Tu[t]*.35,Tn[r]+=Math.sin(performance.now()*.0015+t)*.015,Tn[s]<.2&&(Tn[s]=Math.random()*120+25,Tn[n]=de.position.x+(Math.random()-.5)*220,Tn[r]=de.position.z+(Math.random()-.5)*220)}mh.attributes.position.needsUpdate=!0},CT=i=>{if(xh.visible){for(let e=0;e<ec;e+=1){const t=e*3,n=t+1,s=t+2;An[n]-=am[e]*i,An[t]+=Math.sin(performance.now()*9e-4+e)*.02,An[s]+=Math.cos(performance.now()*7e-4+e)*.02,An[n]<.2&&(An[n]=Math.random()*120+25,An[t]=de.position.x+(Math.random()-.5)*180,An[s]=de.position.z+(Math.random()-.5)*180)}_h.attributes.position.needsUpdate=!0}},PT=i=>{ra=Math.max(0,ra-i*(im==="night"?.35:.55));const t=performance.now()*.001,n=Vo.attributes.position.array;for(let r=0;r<tc;r+=1){const a=r*3;n[a+1]+=Math.sin(t*um[r]+r)*.003,n[a]+=Math.cos(t*.7+r)*.0025,n[a+2]+=Math.sin(t*.5+r)*.0025}Vo.attributes.position.needsUpdate=!0;const s=ra*.95;for(let r=0;r<Au.length;r+=1){const a=Au[r],o=(Math.sin(t*1.6+a.phase)+1)*.035;a.material.emissiveIntensity=a.base+o+s,a.material.color&&s>.08&&a.material.color.offsetHSL(Math.sin(t+a.phase)*3e-4,4e-4,3e-4)}},IT=i=>{const e=Math.min(1,i*8),t=performance.now(),n=jE()-zE;for(const s of H.remotePlayers.values()){const r=s.netSnapshots||[];if(r.length>0){const p=n-1e3;for(;r.length>2&&r[0].ts<p;)r.shift();let M=r[r.length-1];for(let S=1;S<r.length;S+=1){const y=r[S-1],T=r[S];if(n<y.ts||n>T.ts)continue;const w=Math.max(1,T.ts-y.ts),R=Math.max(0,Math.min(1,(n-y.ts)/w));M={x:y.x+(T.x-y.x)*R,y:y.y+(T.y-y.y)*R,z:y.z+(T.z-y.z)*R,yaw:y.yaw+((T.yaw-y.yaw+Math.PI*3)%(Math.PI*2)-Math.PI)*R,pitch:y.pitch+(T.pitch-y.pitch)*R,jumping:y.jumping||T.jumping,moving:y.moving||T.moving,ts:n};break}if(r.length>=2&&n>r[r.length-1].ts){const S=r[r.length-1],y=r[r.length-2],T=n-S.ts;if(T<=kE){const w=Math.max(1,S.ts-y.ts),R=T/w;M={x:S.x+(S.x-y.x)*R,y:S.y+(S.y-y.y)*R,z:S.z+(S.z-y.z)*R,yaw:S.yaw,pitch:S.pitch,jumping:S.jumping,moving:S.moving,ts:n}}else M=S}s.targetPosition.set(M.x,M.y,M.z),s.targetYaw=M.yaw,s.targetPitch=M.pitch,s.isJumping=!!M.jumping,M.moving&&(s.movingUntil=Math.max(Number(s.movingUntil||0),t+wm))}const a=s.group.position.distanceTo(s.targetPosition);let o=e;a>VE?o=Math.max(o,Math.min(1,i*12)):a>HE&&(o=Math.max(o,Math.min(1,i*10)));const c=s.group.position.clone();a>GE?s.group.position.copy(s.targetPosition):s.group.position.lerp(s.targetPosition,o),s.group.rotation.y=Xf(s.group.rotation.y,s.targetYaw+Ch,o);const l=c.distanceTo(s.group.position),u=i>0?l/i:0,h=Math.min(1,i*10);s.smoothedMoveSpeed=fp.lerp(Number(s.smoothedMoveSpeed||0),u,h);const d=s.currentAnimation==="move"?s.smoothedMoveSpeed>XE:s.smoothedMoveSpeed>WE,g=t<Number(s.movingUntil||0)||d,_=s.isJumping||s.targetPosition.y>.08||s.group.position.y>.08,m=t-Number(s.lastAnimationAt||0)>=qE;if(s.head&&(s.head.rotation.x=Xf(s.head.rotation.x,s.targetPitch,o)),s.healthBar?.holder){s.healthBar.holder.quaternion.copy(Lu().quaternion);const p=s.group.position.distanceTo(Lu().position),M=p<=OE,S=Math.max(.74,Math.min(1.06,1.12-p/170));s.healthBar.holder.scale.setScalar(S),s.healthBar.holder.visible=!s.isDead&&M}s.mixer&&s.mixer.update(i),s.animationUntil>0&&t>=s.animationUntil&&(s.isDead&&(s.isDead=!1),_?(bi(s,"jump"),s.lastAnimationAt=t):g?(bi(s,"move"),s.lastAnimationAt=t):(Sa(s),s.lastAnimationAt=t),s.animationUntil=0),!s.isDead&&s.animationUntil<=0&&(_?s.currentAnimation!=="jump"&&(bi(s,"jump"),s.lastAnimationAt=t):g?s.currentAnimation!=="move"&&m&&(bi(s,"move"),s.lastAnimationAt=t):s.currentAnimation!=="idle"&&m&&(Sa(s),s.lastAnimationAt=t))}},LT=i=>{va.intensity=Math.max(0,va.intensity-20*i),ya=Math.max(0,ya-i*4.8),fr=Math.max(0,fr-i*yE),ST(i);for(let e=ys.length-1;e>=0;e-=1){const t=ys[e];t.userData.life-=i,t.material.opacity=Math.max(0,t.userData.life*7.5),t.userData.life<=0&&(Ee.remove(t),t.material.dispose(),ys.splice(e,1))}for(let e=ur.length-1;e>=0;e-=1){const t=ur[e];t.userData.life-=i,t.scale.multiplyScalar(1+7*i),t.material.opacity=Math.max(0,t.userData.life*5),t.userData.life<=0&&(Ee.remove(t),t.material.dispose(),ur.splice(e,1))}for(let e=0;e<Ji.length;e+=1){const t=Ji[e];t.material.emissiveIntensity>.5&&(t.material.emissiveIntensity=Math.max(.5,t.material.emissiveIntensity-3*i))}},DT=i=>{for(let e=oa.length-1;e>=0;e-=1){const t=oa[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.max(0,t.radius*(1-n*t.radiusFalloff)),a=Math.cos(s)*r,o=Math.sin(s)*r,l=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(a)).add(t.up.clone().multiplyScalar(o));t.pos.copy(l),t.mesh.position.copy(l),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.02)*.24),t.trailTimer+=i;const u=t.source==="remote"?.028:.012;if(t.trailTimer>=u){t.trailTimer=0;const d=Jt(l,Math.random()>.5?16773830:10154239);d&&(d.scale.setScalar(1.35+Math.random()*.95),d.userData.life=.3+Math.random()*.18)}let h=null;if(t.source==="remote"){const d=uc(t.prevPos,t.pos);d&&(h=d.point,d.headshot)}if(h||(h=lc(t.prevPos,t.pos,.22)),h||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),oa.splice(e,1);const d=h?h.clone():t.end.clone();h&&t.source==="remote"&&hc({},t.ownerId);const f=Jt(d,16775121);f&&(f.scale.setScalar(2.3),f.userData.life=.42);const g=Jt(d,12579839);g&&(g.scale.setScalar(1.7),g.userData.life=.36),Dn(d.clone().add(t.up.clone().multiplyScalar(1.05)),d.clone().add(t.up.clone().multiplyScalar(-1.05)),16773830,{radiusScale:2.2,life:.34,opacity:1}),Dn(d.clone().add(t.right.clone().multiplyScalar(.7)),d.clone().add(t.right.clone().multiplyScalar(-.7)),10154239,{radiusScale:1.9,life:.34,opacity:1})}}},NT=i=>{for(let e=ca.length-1;e>=0;e-=1){const t=ca[e];t.prevPos.copy(t.pos),t.velocity.y-=_E*i,t.pos.add(t.velocity.clone().multiplyScalar(i)),t.mesh.position.copy(t.pos);const n=t.pos.distanceTo(t.prevPos);t.traveledDistance+=n;const s=Math.max(0,Math.min(1,t.traveledDistance/Cu)),r=t.phase+s*t.spin;t.mesh.rotation.set(r*.9,r*1.1,r*.75),t.trailTimer+=i;const a=t.source==="remote"?.032:.018;if(t.trailTimer>=a){t.trailTimer=0;const c=Jt(t.pos,Math.random()>.5?16773830:10154239);c&&(c.scale.setScalar(1+Math.random()*.9),c.userData.life=.22+Math.random()*.16)}let o=null;if(t.pos.y<=.2&&(o=t.pos.clone(),o.y=.2),!o&&n>1e-4&&(o=lc(t.prevPos,t.pos,.4)),!o){if(t.source==="local")for(const c of H.remotePlayers.values()){if(!c?.group||c.isDead)continue;const l=new P(c.group.position.x,c.group.position.y+1.85,c.group.position.z),u=new P(c.group.position.x,c.group.position.y+1.1,c.group.position.z);if(o=Go(t.prevPos,t.pos,l,rc)||Go(t.prevPos,t.pos,u,ac),o)break}else if(t.source==="remote"){const c=uc(t.prevPos,t.pos);c&&(o=c.point,c.headshot)}}if(!o&&t.traveledDistance>=zf&&(o=null),(o||t.traveledDistance>=zf)&&(Ee.remove(t.mesh),t.mesh.traverse(c=>{c.isMesh&&(c.geometry.dispose(),c.material.dispose())}),ca.splice(e,1),o)){const c=o.clone();t.source==="remote"&&hc({},t.ownerId);const l=Jt(c,16773830),u=Jt(c,10154239);l&&(l.scale.setScalar(2.5),l.userData.life=.42),u&&(u.scale.setScalar(1.9),u.userData.life=.35),Dn(c.clone().add(t.up.clone().multiplyScalar(1.15)),c.clone().add(t.up.clone().multiplyScalar(-1.15)),16773830,{radiusScale:2.3,life:.34,opacity:1}),Dn(c.clone().add(t.right.clone().multiplyScalar(.8)),c.clone().add(t.right.clone().multiplyScalar(-.8)),10154239,{radiusScale:2,life:.34,opacity:1})}}},UT=i=>{for(let e=la.length-1;e>=0;e-=1){const t=la[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA*(1-n*.22),a=Math.sin(s*.5+Math.PI*.35)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(a));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.12+Math.sin(performance.now()*.02)*.28),t.trailTimer+=i;const l=t.source==="remote"?.016:.007;if(t.trailTimer>=l){t.trailTimer=0;const h=Math.random()>.5?6750067:10354554,d=Math.random()>.5?6160236:9437049,f=Jt(c,h),g=Jt(c.clone().add(t.right.clone().multiplyScalar((Math.random()-.5)*.12)),d);f&&(f.scale.setScalar(.72+Math.random()*.35),f.userData.life=.22+Math.random()*.08),g&&(g.scale.setScalar(.62+Math.random()*.28),g.userData.life=.18+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=uc(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=lc(t.prevPos,t.pos,.22)),u||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),la.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&hc({},t.ownerId);const d=Jt(h,5832550);d&&(d.scale.setScalar(2.45),d.userData.life=.45);const f=Jt(h,11075468);f&&(f.scale.setScalar(1.9),f.userData.life=.38),Dn(h.clone().add(t.up.clone().multiplyScalar(.95)),h.clone().add(t.up.clone().multiplyScalar(-.95)),7733092,{radiusScale:2,life:.28,opacity:1}),Dn(h.clone().add(t.right.clone().multiplyScalar(.75)),h.clone().add(t.right.clone().multiplyScalar(-.75)),12124053,{radiusScale:1.75,life:.28,opacity:.95})}}},FT=i=>{for(let e=ua.length-1;e>=0;e-=1){const t=ua[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA,a=Math.cos(s*.7+Math.PI*.3)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(a));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.03)*.18),t.trailTimer+=i;const l=t.source==="remote"?.012:.005;if(t.trailTimer>=l){t.trailTimer=0;const h=2.9+Math.random()*1.4,d=c.clone().add(t.dir.clone().multiplyScalar(-h)),f=Math.random()>.5?10148095:8309247;Dn(c,d,f,{radiusScale:1.8,life:.36,opacity:.92});const g=Jt(d,Math.random()>.5?12380671:8703999);g&&(g.scale.setScalar(.7+Math.random()*.3),g.userData.life=.22+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=uc(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=lc(t.prevPos,t.pos,.24)),u||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),ua.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&hc({},t.ownerId);const d=Jt(h,15661567),f=Jt(h,9359871);d&&(d.scale.setScalar(2.2),d.userData.life=.4),f&&(f.scale.setScalar(2.8),f.userData.life=.46),Dn(h.clone().add(t.up.clone().multiplyScalar(1.35)),h.clone().add(t.up.clone().multiplyScalar(-1.35)),14677759,{radiusScale:2.35,life:.36,opacity:1}),Dn(h.clone().add(t.right.clone().multiplyScalar(1.05)),h.clone().add(t.right.clone().multiplyScalar(-1.05)),9097215,{radiusScale:2.15,life:.36,opacity:.98})}}},OT=i=>{const e=Fr(et);if(On()){if(e){const t=ti;Lt=Math.min(hn,Lt+bE*i),ti=Math.round(Lt),jn&&(jn=!1,hr=0),ti!==t&&Pt()}if(!e&&jn&&(hr-=i,hr<=0)){const t=ss-Pi,n=Math.min(t,ei);Pi+=n,ei-=n,jn=!1,Pt()}if(pl-=i,Ir){si=!1;return}bs&&si&&pl<=0&&!jn&&(_T(),pl=tT(),!e&&Pi<=0&&ei>0&&Nh())}},BT=()=>{if(!yt||!H.joinedRoom||!xa()){yt&&!xa()&&(yt=!1,Ui=0,Ln=ri,oi());return}const i=Math.max(0,Ui-performance.now()),e=Math.ceil(i/1e3);e!==Ln&&(Ln=e,oi()),i<=0&&cT()},zT=()=>{if(!br||!H.joinedRoom||H.joinedRoom.room.status!=="cooldown"){br&&vs();return}const i=Math.max(0,Ah-performance.now()),e=Math.ceil(i/1e3);e!==dr&&(dr=e,gu.textContent=String(dr)),i<=0&&(gu.textContent="0")},xl=()=>!H.joinedRoom&&Zi&&!Zi.classList.contains("hidden"),Vm=()=>{requestAnimationFrame(Vm);const i=Math.min(BE.getDelta(),.05);Mb(),bT(i),ET(i),yT(i),uT(i),Om(),TT(i),AT(i),wT(i),RT(i),CT(i),PT(i),IT(i),DT(i),NT(i),UT(i),FT(i),OT(i),BT(),zT(),LT(i),aT(),oT(),Cm(i),xl()&&qe.mixer&&qe.mixer.update(i),xl()&&qe.model&&(qe.model.rotation.y+=i*.45),xl()&&qe.renderer&&qe.scene&&qe.camera&&(gm(),qe.renderer.render(qe.scene,qe.camera)),mn.render(Ee,Lu()),Xn.drawCalls=mn.info.render.calls||0,Xn.triangles=mn.info.render.triangles||0,Xn.geometries=mn.info.memory.geometries||0,Xn.textures=mn.info.memory.textures||0,Xn.vfx=ys.length+ur.length+Ss.length+oa.length+ca.length+la.length+ua.length};window.addEventListener("resize",()=>{de.aspect=window.innerWidth/window.innerHeight,de.updateProjectionMatrix(),As.aspect=window.innerWidth/window.innerHeight,As.updateProjectionMatrix(),mn.setSize(window.innerWidth,window.innerHeight),qe.renderer&&qe.camera&&gm()});gb();Yb();Ca();zo(!1);sa("night");mm();oi();Pt();Eu();dc();Vm();Fm();zb();
