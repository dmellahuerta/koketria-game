...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ei,depthTest:!1,depthWrite:!1})}function Hd(){return new ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$o(),fragmentShader:`
		...
		`,blending:Ei,depthTest:!1,depthWrite:!1})}function Gd(){return new ii({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$o(),fragmentShader:`
	...
	`}class Pp extends Zn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new vp(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Je(o,c),u=new Ko(-1,1,1,-1,0,1);let h=null,d=null,f=!1,g,_=null,m=[],p=!1;this.setSize=function(M,S){r.setSize(M,S),a.setSize(M,S);for(let y=0;y<m.length;y++){const T=m[y];T.setSize&&T.setSize(M,S)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;const S=r.width,y=r.height;for(let T=0;T<m.length;T++){const w=m[T];w.setSize&&w.setSize(S,y)}},this.begin=function(M,S){if(f||M.toneMapping===$n&&m.length===0)return!1;if(_=S,S!==null){const y=S.width,T=S.height;(r.width!==y||r.height!==T)&&this.setSize(y,T)}return p===!1&&M.setRenderTarget(r),g=M.toneMapping,M.toneMapping=$n,!0},this.hasRenderPass=function(){return p},this.end=function(M,S){M.toneMapping=g,f=!0;let y=r,T=a;for(let w=0;w<m.length;w++){const R=m[w];if(R.enabled!==!1&&(R.render(M,T,y,S),R.needsSwap!==!1)){const x=y;y=T,T=x}}if(h!==M.outputColorSpace||d!==M.toneMapping){h=M.outputColorSpace,d=M.toneMapping,c.defines={},$e.getTransfer(h)===rt&&(c.defines.SRGB_TRANSFER="");const w=fM[d];w&&(c.defines[w]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=y.texture,M.setRenderTarget(_),M.render(l,u),_=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),c.dispose()}}const Ip=new Nt,hu=new _a(1,1),Lp=new dp,Dp=new e0,Np=new vp,Wd=[],Xd=[],qd=new Float32Array(16),jd=new Float32Array(9),Yd=new Float32Array(4);function Pr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Wd[s];if(r===void 0&&(r=new Float32Array(s),Wd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Ft(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Zo(i,e){let t=Xd[e];t===void 0&&(t=new Int32Array(e),Xd[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function mM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function gM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ft(t,e))return;i.uniform2fv(this.addr,e),Ot(t,e)}}function _M(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Ft(t,e))return;i.uniform3fv(this.addr,e),Ot(t,e)}}function xM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ft(t,e))return;i.uniform4fv(this.addr,e),Ot(t,e)}}function vM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ft(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Ot(t,e)}else{if(Ft(t,n))return;Yd.set(n),i.uniformMatrix2fv(this.addr,!1,Yd),Ot(t,n)}}function MM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ft(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Ot(t,e)}else{if(Ft(t,n))return;jd.set(n),i.uniformMatrix3fv(this.addr,!1,jd),Ot(t,n)}}function yM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ft(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Ot(t,e)}else{if(Ft(t,n))return;qd.set(n),i.uniformMatrix4fv(this.addr,!1,qd),Ot(t,n)}}function SM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function bM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ft(t,e))return;i.uniform2iv(this.addr,e),Ot(t,e)}}function EM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ft(t,e))return;i.uniform3iv(this.addr,e),Ot(t,e)}}function TM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ft(t,e))return;i.uniform4iv(this.addr,e),Ot(t,e)}}function AM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function wM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ft(t,e))return;i.uniform2uiv(this.addr,e),Ot(t,e)}}function RM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ft(t,e))return;i.uniform3uiv(this.addr,e),Ot(t,e)}}function CM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ft(t,e))return;i.uniform4uiv(this.addr,e),Ot(t,e)}}function PM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(hu.compareFunction=t.isReversedDepthBuffer()?qu:Xu,r=hu):r=Ip,t.setTexture2D(e||r,s)}function IM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Dp,s)}function LM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Np,s)}function DM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Lp,s)}function NM(i){switch(i){case 5126:return mM;case 35664:return gM;case 35665:return _M;case 35666:return xM;case 35674:return vM;case 35675:return MM;case 35676:return yM;case 5124:case 35670:return SM;case 35667:case 35671:return bM;case 35668:case 35672:return EM;case 35669:case 35673:return TM;case 5125:return AM;case 36294:return wM;case 36295:return RM;case 36296:return CM;case 35678:case 36198:case 36298:case 36306:case 35682:return PM;case 35679:case 36299:case 36307:return IM;case 35680:case 36300:case 36308:case 36293:return LM;case 36289:case 36303:case 36311:case 36292:return DM}}function UM(i,e){i.uniform1fv(this.addr,e)}function FM(i,e){const t=Pr(e,this.size,2);i.uniform2fv(this.addr,t)}function OM(i,e){const t=Pr(e,this.size,3);i.uniform3fv(this.addr,t)}function BM(i,e){const t=Pr(e,this.size,4);i.uniform4fv(this.addr,t)}function zM(i,e){const t=Pr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function kM(i,e){const t=Pr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function VM(i,e){const t=Pr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function HM(i,e){i.uniform1iv(this.addr,e)}function GM(i,e){i.uniform2iv(this.addr,e)}function WM(i,e){i.uniform3iv(this.addr,e)}function XM(i,e){i.uniform4iv(this.addr,e)}function qM(i,e){i.uniform1uiv(this.addr,e)}function jM(i,e){i.uniform2uiv(this.addr,e)}function YM(i,e){i.uniform3uiv(this.addr,e)}function KM(i,e){i.uniform4uiv(this.addr,e)}function $M(i,e,t){const n=this.cache,s=e.length,r=Zo(t,s);Ft(n,r)||(i.uniform1iv(this.addr,r),Ot(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=hu:a=Ip;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function ZM(i,e,t){const n=this.cache,s=e.length,r=Zo(t,s);Ft(n,r)||(i.uniform1iv(this.addr,r),Ot(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Dp,r[a])}function JM(i,e,t){const n=this.cache,s=e.length,r=Zo(t,s);Ft(n,r)||(i.uniform1iv(this.addr,r),Ot(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Np,r[a])}function QM(i,e,t){const n=this.cache,s=e.length,r=Zo(t,s);Ft(n,r)||(i.uniform1iv(this.addr,r),Ot(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Lp,r[a])}function ey(i){switch(i){case 5126:return UM;case 35664:return FM;case 35665:return OM;case 35666:return BM;case 35674:return zM;case 35675:return kM;case 35676:return VM;case 5124:case 35670:return HM;case 35667:case 35671:return GM;case 35668:case 35672:return WM;case 35669:case 35673:return XM;case 5125:return qM;case 36294:return jM;case 36295:return YM;case 36296:return KM;case 35678:case 36198:case 36298:case 36306:case 35682:return $M;case 35679:case 36299:case 36307:return ZM;case 35680:case 36300:case 36308:case 36293:return JM;case 36289:case 36303:case 36311:case 36292:return QM}}class ty{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=NM(t.type)}}class ny{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=ey(t.type)}}class iy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Yc=/(\w+)(\])?(\[|\.)?/g;function Kd(i,e){i.seq.push(e),i.map[e.id]=e}function sy(i,e,t){const n=i.name,s=n.length;for(Yc.lastIndex=0;;){const r=Yc.exec(n),a=Yc.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Kd(t,l===void 0?new ty(o,i,e):new ny(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new iy(o),Kd(t,h)),t=h}}}class Eo{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);sy(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function $d(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const ry=37297;let ay=0;function oy(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Zd=new Be;function cy(i){$e._getMatrix(Zd,$e.workingColorSpace,i);const e=`mat3( ${Zd.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(i)){case Do:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return Ae("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Jd(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+oy(i.getShaderSource(e),o)}else return r}function ly(i,e){const t=cy(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const uy={[jf]:"Linear",[Yf]:"Reinhard",[Kf]:"Cineon",[$f]:"ACESFilmic",[Jf]:"AgX",[Qf]:"Neutral",[Zf]:"Custom"};function hy(i,e){const t=uy[e];return t===void 0?(Ae("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const oo=new P;function dy(){$e.getLuminanceCoefficients(oo);const i=oo.x.toFixed(4),e=oo.y.toFixed(4),t=oo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function fy(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Jr).join(`
`)}function py(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function my(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Jr(i){return i!==""}function Qd(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ef(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const gy=/^[ \t]*#include +<([\w\d./]+)>/gm;function du(i){return i.replace(gy,xy)}const _y=new Map;function xy(i,e){let t=Ve[e];if(t===void 0){const n=_y.get(e);if(n!==void 0)t=Ve[n],Ae('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return du(t)}const vy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function tf(i){return i.replace(vy,My)}function My(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function nf(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const yy={[xo]:"SHADOWMAP_TYPE_PCF",[$r]:"SHADOWMAP_TYPE_VSM"};function Sy(i){return yy[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const by={[Ts]:"ENVMAP_TYPE_CUBE",[mr]:"ENVMAP_TYPE_CUBE",[Wo]:"ENVMAP_TYPE_CUBE_UV"};function Ey(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":by[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Ty={[mr]:"ENVMAP_MODE_REFRACTION"};function Ay(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ty[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const wy={[qf]:"ENVMAP_BLENDING_MULTIPLY",[pg]:"ENVMAP_BLENDING_MIX",[mg]:"ENVMAP_BLENDING_ADD"};function Ry(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":wy[i.combine]||"ENVMAP_BLENDING_NONE"}function Cy(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Py(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Sy(t),l=Ey(t),u=Ay(t),h=Ry(t),d=Cy(t),f=fy(t),g=py(r),_=s.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const S=M+m+a,y=M+p+o,T=$d(s,s.VERTEX_SHADER,S),w=$d(s,s.FRAGMENT_SHADER,y);s.attachShader(_,T),s.attachShader(_,w),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(C){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(_)||"",B=s.getShaderInfoLog(T)||"",X=s.getShaderInfoLog(w)||"",k=N.trim(),G=B.trim(),O=X.trim();let ee=!0,Z=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,T,w);else{const ue=Jd(s,T,"vertex"),ge=Jd(s,w,"fragment");Le("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
`;const $i=document.querySelector("#bootLoader"),pf=document.querySelector("#bootLoaderText"),mf=document.querySelector("#bootLoaderFill"),gf=document.querySelector("#bootLoaderPercent"),Zi=document.querySelector("#lobby"),Qc=document.querySelector("#connectionStatus"),zp=document.querySelector("#playerName"),en=document.querySelector("#characterSelect"),Zs=document.querySelector("#characterPreview"),VS=document.querySelector("#refreshRoomsBtn"),el=document.querySelector("#roomList"),co=document.querySelector("#lobbyError"),_f=document.querySelector("#matchInfo"),xf=document.querySelector("#respawnScreen"),HS=document.querySelector("#respawnCounter"),kp=document.querySelector("#winnerScreen"),GS=document.querySelector("#winnerText"),mu=document.querySelector("#winnerCounter"),tl=document.querySelector("#damageOverlay"),lo=document.querySelector("#damageIndicator"),vf=document.querySelector("#scoreboard"),WS=document.querySelector("#scoreboardBody"),XS=document.querySelector("#healthStat"),qS=document.querySelector("#shieldStat"),jS=document.querySelector("#ammoStat"),YS=document.querySelector("#healthSideLabel"),KS=document.querySelector("#shieldSideLabel"),$S=document.querySelector("#ammoSideLabel"),ZS=document.querySelector("#healthBarFill"),JS=document.querySelector("#shieldBarFill"),QS=document.querySelector("#ammoBarFill"),eb=document.querySelector("#stats"),Mf=document.querySelector("#roomHud"),yf=document.querySelector("#stateHud"),Sf=document.querySelector("#weatherHud"),bf=document.querySelector("#playersHud"),Ef=document.querySelector("#perfPanel"),tb=document.querySelector("#fpsValue"),nb=document.querySelector("#latencyValue"),ib=document.querySelector("#drawCallsValue"),sb=document.querySelector("#trianglesValue"),rb=document.querySelector("#geometriesValue"),ab=document.querySelector("#texturesValue"),ob=document.querySelector("#vfxValue"),nl=document.querySelector("#hostControls"),Vp=document.querySelector("#startGameBtn"),Hp=document.querySelector("#endGameBtn"),cb=document.querySelector("#leaveRoomHudBtn"),uh=document.querySelector("#chatFeed"),Gp=document.querySelector("#chatPanel"),uo=document.querySelector("#chatLog"),Wp=document.querySelector("#chatInputWrap"),Bo=document.querySelector("#chatInput"),jr=document.querySelector("#crosshair"),Xp=document.querySelector("#optionsScreen"),gu=document.querySelector("#optMouseSensitivity"),qp=document.querySelector("#optMouseSensitivityValue"),_u=document.querySelector("#optMasterVolume"),jp=document.querySelector("#optMasterVolumeValue"),xu=document.querySelector("#optMusicVolume"),Yp=document.querySelector("#optMusicVolumeValue"),vu=document.querySelector("#optSfxVolume"),Kp=document.querySelector("#optSfxVolumeValue"),Mu=document.querySelector("#optFov"),$p=document.querySelector("#optFovValue"),yu=document.querySelector("#optShowPerf"),lb=document.querySelector("#optResumeBtn"),H={ws:null,self:null,rooms:[],joinedRoom:null,remotePlayers:new Map,lastStateSentAt:0,showMatchInfo:!1,showScoreboard:!1,showPerf:!1,fps:0,latencyMs:null},Xn={drawCalls:0,triangles:0,geometries:0,textures:0,vfx:0},Cn=[],Tf=40,ub=8e3;let ns=!1,Ir=!1;const Zp="koketria_settings_v1",Pe={mouseSensitivity:1,masterVolume:1,musicVolume:1,sfxVolume:1,fov:75,showPerfByDefault:!1},il=["battle1","battle2","battle3"],Jp=()=>{pt.KeyW=!1,pt.KeyA=!1,pt.KeyS=!1,pt.KeyD=!1,pt.Space=!1},hh=()=>{if(!uo)return;const i=Date.now();for(let t=Cn.length-1;t>=0;t-=1)i-Cn[t].ts>ub&&Cn.splice(t,1);uh.classList.toggle("open",Cn.length>0);const e=Cn.slice(-8);uo.innerHTML=e.map(t=>{const n=t.isSelf?" (Tú)":"";return`<p><strong>${t.playerName}${n}:</strong> ${t.text}</p>`}).join(""),uo.scrollTop=uo.scrollHeight},hb=(i,e)=>{if(!e)return;const t=!!(H.self&&String(i||"")===String(H.self.name||""));Cn.push({playerName:String(i||"Player"),text:String(e||""),isSelf:t,ts:Date.now()}),Cn.length>Tf&&Cn.splice(0,Cn.length-Tf),hh()};setInterval(()=>{Cn.length>0&&!ns&&hh()},500);const db=()=>{H.joinedRoom&&(ns=!0,Jp(),si=!1,Gp.classList.add("open"),Wp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),Bo.value="",Bo.focus())},Su=()=>{ns=!1,Gp.classList.remove("open"),Wp.classList.add("hidden"),Bo.blur()},Js=(i="")=>{if(!i){co.classList.add("hidden"),co.textContent="";return}co.classList.remove("hidden"),co.textContent=i},qn=(i,e,t,n)=>{const s=Number(i);return Number.isFinite(s)?Math.max(e,Math.min(t,s)):n},fb=()=>{try{const i=localStorage.getItem(Zp);if(!i)return;const e=JSON.parse(i);Pe.mouseSensitivity=qn(e.mouseSensitivity,.4,2.5,Pe.mouseSensitivity),Pe.masterVolume=qn(e.masterVolume,0,1,Pe.masterVolume),Pe.musicVolume=qn(e.musicVolume,0,1,Pe.musicVolume),Pe.sfxVolume=qn(e.sfxVolume,0,1,Pe.sfxVolume),Pe.fov=qn(e.fov,60,100,Pe.fov),Pe.showPerfByDefault=!!e.showPerfByDefault}catch{}},Lr=()=>{localStorage.setItem(Zp,JSON.stringify(Pe))},pb=i=>{const e=[...i];for(let t=e.length-1;t>0;t-=1){const n=Math.floor(Math.random()*(t+1)),s=e[t];e[t]=e[n],e[n]=s}return e},zo=i=>{Jo.classList.toggle("in-room",i),Ri(),!i&&document.pointerLockElement&&document.exitPointerLock(),i||(yh(),Cn.length=0,hh(),Su(),uh.classList.remove("open"))},Qp=()=>{H.showMatchInfo&&H.joinedRoom?_f.classList.add("visible"):_f.classList.remove("visible")},dh=()=>{if(!H.joinedRoom||!H.showScoreboard){vf.classList.add("hidden");return}const i=[...H.joinedRoom.players].sort((e,t)=>(t.kills||0)!==(e.kills||0)?(t.kills||0)-(e.kills||0):(e.deaths||0)-(t.deaths||0));WS.innerHTML=i.map(e=>{const t=H.self&&e.id===H.self.id?" (Tú)":"";return`<tr><td>${e.name}${t}</td><td>${e.kills||0}</td><td>${e.deaths||0}</td></tr>`}).join(""),vf.classList.remove("hidden")},Dr=()=>{if(!H.joinedRoom||!H.showPerf){Ef.classList.add("hidden");return}tb.textContent=String(H.fps),nb.textContent=Number.isFinite(H.latencyMs)?`${Math.round(H.latencyMs)} ms`:"--",ib.textContent=String(Math.round(Xn.drawCalls)),sb.textContent=String(Math.round(Xn.triangles)),rb.textContent=String(Math.round(Xn.geometries)),ab.textContent=String(Math.round(Xn.textures)),ob.textContent=String(Math.round(Xn.vfx)),Ef.classList.remove("hidden")},em=()=>!!(H.joinedRoom&&H.self&&H.joinedRoom.room.hostId===H.self.id),On=()=>!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"&&!yt&&!br),xa=()=>!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"),mb=i=>i==="rainy"?"Lluvioso":i==="sunny"?"Soleado":i==="night"?"Noche":i==="snow"?"Nieve":i||"-",sa=i=>{const e=i||"night";tm=e,mh.visible=e==="rainy",_h.visible=e==="snow",om.visible=e==="night"||e==="snow",lm.visible=!1,xh.visible=!1,vh.visible=!1,e==="sunny"?(Ee.background=new Ce(12050431),Ee.fog.color.set(12050431),Ee.fog.near=90,Ee.fog.far=400,Qr.intensity=.74,Gn.intensity=1.2,Gn.color.set(16773826),ea.opacity=.35):e==="rainy"?(Ee.background=new Ce(599e4),Ee.fog.color.set(599e4),Ee.fog.near=10,Ee.fog.far=95,Qr.intensity=.26,Gn.intensity=.42,Gn.color.set(9156567),ea.opacity=.25):e==="snow"?(Ee.background=new Ce(14215668),Ee.fog.color.set(14215668),Ee.fog.near=26,Ee.fog.far=200,Qr.intensity=.65,Gn.intensity=.9,Gn.color.set(15202047),ea.opacity=.42):(Ee.background=new Ce(461588),Ee.fog.color.set(461588),Ee.fog.near=16,Ee.fog.far=140,Qr.intensity=.26,Gn.intensity=.38,Gn.color.set(8354248),ea.opacity=.6)},nn=i=>{if(!H.ws||H.ws.readyState!==WebSocket.OPEN){Js("WebSocket no conectado");return}H.ws.send(JSON.stringify(i))};let Af=0,vi=null,wf=0;const gb=2e3;let sl=0,Rf=performance.now();const fh=(i=!1)=>{const e=performance.now();if(!H.showPerf||!H.joinedRoom||!H.ws||H.ws.readyState!==WebSocket.OPEN||vi&&e-vi.sentAt<5e3||!i&&e-wf<gb)return;const t=`${Date.now()}-${Af}`;Af+=1,vi={id:t,sentAt:e},wf=e,nn({type:"ping",probeId:t,clientTs:Date.now()})},_b=()=>{const i=performance.now();sl+=1;const e=i-Rf;e>=500&&(H.fps=Math.max(0,Math.round(sl*1e3/e)),sl=0,Rf=i,H.showPerf&&H.joinedRoom&&Dr()),fh()},bu=()=>{if(el.innerHTML="",H.rooms.length===0){const i=document.createElement("p");i.className="room-empty",i.textContent="No hay salas activas.",el.appendChild(i);return}H.rooms.forEach(i=>{const e=document.createElement("article");e.className="room-card",e.innerHTML=`
      <div>
    ...
    `,e.querySelector("button").addEventListener("click",()=>{Js(),nn({type:"join_room",roomId:i.id,playerName:zp.value.trim(),character:en.value||et})}),el.appendChild(e)})},xb=()=>`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws`,vb=()=>`${window.location.protocol}//${window.location.host}`,Ee=new pp;Ee.background=new Ce(66817);Ee.fog=new $u(66817,18,160);let tm="night";const de=new Xt(75,window.innerWidth/window.innerHeight,.1,500);de.position.set(0,1.7,10);const As=new Xt(75,window.innerWidth/window.innerHeight,.1,500);let or=!1;const Mb=1.25,yb=.7,Sb=.18,Cf=new P,ho=new P,Pf=new P,If=new P,fo=new P,mn=new Up({antialias:!0});mn.setSize(window.innerWidth,window.innerHeight);mn.setPixelRatio(Math.min(window.devicePixelRatio,2));Jo.appendChild(mn.domElement);const Qr=new K0(6750088,.3);Ee.add(Qr);const Gn=new ah(4849523,.8);Gn.position.set(15,30,10);Ee.add(Gn);const va=new wp(10026904,0,8,2);de.add(va);va.position.set(.2,-.18,-.6);Ee.add(de);const nm=new Je(new ts(320,320),new Un({color:135426,roughness:1}));nm.rotation.x=-Math.PI/2;Ee.add(nm);const im=new f_(320,80,4194150,1002015);im.position.y=.01;Ee.add(im);const bb=new Un({color:5984868,emissive:2762034,emissiveIntensity:.18,metalness:.06,roughness:.9});new Un({color:8089476,emissive:2893110,emissiveIntensity:.14,metalness:.04,roughness:.92});new Un({color:9401999,emissive:3417405,emissiveIntensity:.11,metalness:.04,roughness:.9});const Ji=[],ko=[],Qi=.55,Eb=156;let Lf=null;const Qo=5600,Tn=new Float32Array(Qo*3),Eu=new Float32Array(Qo);for(let i=0;i<Qo;i+=1)Tn[i*3]=(Math.random()-.5)*260,Tn[i*3+1]=Math.random()*120+6,Tn[i*3+2]=(Math.random()-.5)*260,Eu[i]=22+Math.random()*26;const ph=new wt;ph.setAttribute("position",new Ut(Tn,3));const Tb=new Tr({color:6750054,size:.26,transparent:!0,opacity:.98,sizeAttenuation:!0}),mh=new Aa(ph,Tb);Ee.add(mh);const ec=1700,An=new Float32Array(ec*3),sm=new Float32Array(ec);for(let i=0;i<ec;i+=1)An[i*3]=(Math.random()-.5)*260,An[i*3+1]=Math.random()*120+6,An[i*3+2]=(Math.random()-.5)*260,sm[i]=1.6+Math.random()*2.7;const gh=new wt;gh.setAttribute("position",new Ut(An,3));const Ab=new Tr({color:16777215,size:.22,transparent:!0,opacity:.85,sizeAttenuation:!0}),_h=new Aa(gh,Ab);Ee.add(_h);const rm=1200,To=new Float32Array(rm*3);for(let i=0;i<rm;i+=1)To[i*3]=(Math.random()-.5)*420,To[i*3+1]=70+Math.random()*80,To[i*3+2]=(Math.random()-.5)*420;const am=new wt;am.setAttribute("position",new Ut(To,3));const wb=new Tr({color:12572927,size:.36,transparent:!0,opacity:.78,sizeAttenuation:!0}),om=new Aa(am,wb);Ee.add(om);const tc=900,Ao=new Float32Array(tc*3),cm=new Float32Array(tc);for(let i=0;i<tc;i+=1)Ao[i*3]=(Math.random()-.5)*300,Ao[i*3+1]=8+Math.random()*34,Ao[i*3+2]=(Math.random()-.5)*300,cm[i]=.4+Math.random()*.9;const Vo=new wt;Vo.setAttribute("position",new Ut(Ao,3));const ea=new Tr({color:16773311,size:.18,transparent:!0,opacity:.62,sizeAttenuation:!0,depthWrite:!1}),lm=new Aa(Vo,ea);Ee.add(lm);const xh=new Je(new li(8.5,24,24),new It({color:15331839,transparent:!0,opacity:.9}));xh.position.set(78,95,-124);Ee.add(xh);const vh=new Je(new li(4.2,18,18),new It({color:16373920,transparent:!0,opacity:.74}));vh.position.set(-104,76,-112);Ee.add(vh);const rl=[],Tu=[];let ra=0;const Rb=new P,um=new oS,Au=new Map,on=[];let et="";const Cb=["attack","dead","running","idle","jump","funny"],qe={renderer:null,scene:null,camera:null,mixer:null,model:null,lastWidth:0,lastHeight:0},Ke={group:null,mixer:null,actions:null,currentAnimation:"",shootUntil:0,loadingKey:"",funnyUntil:0},Ra=i=>{const e=String(i||"").trim();return e?e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,"")==="pezunalunar"?"pezunalunar":e:""},Pb=(i,e)=>`/characters/${encodeURIComponent(Ra(i))}/${encodeURIComponent(e)}`,Ho=i=>Ra(i)==="pezunalunar"?"pezuñalunar":i,Ib=i=>/\.(glb|gltf)$/i.test(String(i||"").trim()),Lb=i=>{const e=String(i||"").trim();if(!e)return[];const t=Ra(e);return t===e?[e]:[t,e]},Db=i=>new Promise(e=>{const t=n=>{if(n>=i.length){e(null);return}um.load(i[n],s=>e(s),void 0,()=>t(n+1))};t(0)}),Df={mana:{url:"/items/mana.glb",targetHeight:.62},defensa:{url:"/items/defensa.glb",targetHeight:.7},vida:{url:"/items/vida.glb",targetHeight:.68}},Yr=new Map,po=new Map,Nb=(i,e)=>{const t=new Mn().setFromObject(i),n=t.getSize(new P);if(Number.isFinite(n.y)&&n.y>1e-4){const a=e/n.y;i.scale.setScalar(a),t.setFromObject(i)}const s=t.getCenter(new P),r=Number.isFinite(t.min.y)?t.min.y:0;return i.position.set(-s.x,-r,-s.z),i.traverse(a=>{a.isMesh&&(a.frustumCulled=!0)}),i},wo=async i=>{const e=String(i||"").trim();if(!e||!Df[e])return null;if(Yr.has(e))return Yr.get(e);if(po.has(e))return po.get(e);const{url:t,targetHeight:n}=Df[e],s=new Promise(r=>{um.load(t,a=>{const o=a?.scene?a.scene.clone(!0):null;if(!o){Yr.set(e,null),r(null);return}const c=Nb(o,n);Yr.set(e,c),r(c)},void 0,()=>{Yr.set(e,null),r(null)})}).finally(()=>{po.delete(e)});return po.set(e,s),s},al=(i,e)=>{const t=new un,n=new un;t.add(n);const s=e();return s.name="__pickup_fallback__",n.add(s),wo(i).then(r=>{if(!r||!t.parent)return;for(;n.children.length>0;)n.remove(n.children[0]);const a=r.clone(!0);a.name=`pickup_${i}`,n.add(a),t.userData.modelLoaded=!0}),t},js=(i,e)=>{if(!i?.animations||i.animations.length===0)return null;const t=i.animations[0].clone();return t.name=e,t},Nr=async i=>{if(!i)return null;const e=Au.get(i);if(e?.loaded)return e;if(e?.loadingPromise)return e.loadingPromise;const t=e||{loaded:!1,scene:null,animations:[],animationSet:{},loadingPromise:null};return Au.set(i,t),t.loadingPromise=new Promise(n=>{const s=Lb(i);if(s.length===0){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}Promise.all(Cb.map(async r=>{const a=Ib(r)?[r]:[r,`${r}.glb`,`${r}.gltf`],o=s.flatMap(l=>a.map(u=>Pb(l,u))),c=await Db(o);return{actionName:r,gltf:c}})).then(r=>{const a=r.find(_=>_.actionName==="dead"&&_.gltf?.scene)?.gltf,o=r.find(_=>_.actionName==="idle"&&_.gltf?.scene)?.gltf,c=r.find(_=>_.actionName==="running"&&_.gltf?.scene)?.gltf,l=r.find(_=>_.actionName==="jump"&&_.gltf?.scene)?.gltf,u=r.find(_=>_.actionName==="funny"&&_.gltf?.scene)?.gltf,h=r.find(_=>_.actionName==="attack"&&_.gltf?.scene)?.gltf,d=o||c||l||u||a||h;if(!d?.scene){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}const f={attack:js(h,"attack"),dead:js(a,"dead"),running:js(c,"running"),idle:js(o,"idle"),jump:js(l,"jump"),funny:js(u,"funny")},g=Object.values(f).filter(Boolean);t.loaded=!0,t.scene=d.scene,t.animations=g,t.animationSet=f,t.loadingPromise=null,n(t)})}),t.loadingPromise},hm=i=>{const e=en.value||et;if(en.innerHTML="",on.length=0,pb(i).forEach(n=>on.push(n)),on.length===0){const n=document.createElement("option");n.value="",n.textContent="Sin personajes",en.appendChild(n),en.disabled=!0,et="";return}en.disabled=!1,on.forEach(n=>{const s=document.createElement("option");s.value=n,s.textContent=Ho(n),en.appendChild(s)}),et=on.includes(e)?e:on[0],en.value=et},ol=(i,e,t="")=>{const n=Math.max(1,e),s=Math.max(0,Math.min(1,i/n)),r=Math.round(s*100);mf&&(mf.style.width=`${r}%`),gf&&(gf.textContent=`${r}%`),pf&&t&&(pf.textContent=t)},dm=async()=>{const i=vb();try{const t=await(await fetch(`${i}/characters`)).json();if(t?.ok&&Array.isArray(t.data)&&t.data.length>0)return t.data}catch{}return["silentman","pumori","neoorphen","pezunalunar"]},Nf=new Set,Qs=(i,e=6e3)=>new Promise(t=>{if(!i){t(!1);return}if(Nf.has(i)){t(!0);return}const n=new Audio;let s=!1;const r=c=>{s||(s=!0,n.removeEventListener("canplaythrough",a),n.removeEventListener("loadedmetadata",a),n.removeEventListener("error",o),c&&Nf.add(i),t(c))},a=()=>r(!0),o=()=>r(!1);n.preload="auto",n.addEventListener("canplaythrough",a,{once:!0}),n.addEventListener("loadedmetadata",a,{once:!0}),n.addEventListener("error",o,{once:!0}),n.src=i,n.load(),setTimeout(()=>r(!1),e)}),Ub=async i=>{const e=await Sh(i);return await Qs(e,6e3)?!0:Qs(e,1e4)},Fb=async()=>{$i&&$i.classList.remove("hidden"),Zi&&Zi.classList.add("hidden");const i=await dm();hm(i),nc(et);const e=[...on],t=2+e.length*2+1+il.length+1+3+1;let n=0;const s=r=>{n+=1,ol(n,t,r)};ol(0,t,"Cargando tema pre-lobby..."),await Qs(mm,1e4),s("Tema pre-lobby cargado"),Ri(),ol(n,t,"Preparando catalogo..."),fm(),s("Catalogo listo");for(let r=0;r<e.length;r+=1){const a=e[r];await Nr(a),s(`Modelo: ${Ho(a)}`)}for(let r=0;r<e.length;r+=1){const a=e[r];await Ub(a),s(`Audio ataque: ${Ho(a)}`)}await Qs(wi,6e3),s("Audio base cargado");for(let r=0;r<il.length;r+=1){const a=il[r];await Qs(Mh(a),1e4),s(`Tema batalla: ${a}`)}await Qs(gm,1e4),s("Audio lobby cargado"),await wo("mana"),s("Item mana cargado"),await wo("defensa"),s("Item defensa cargado"),await wo("vida"),s("Item vida cargado"),await Fh(),Ur();for(const r of H.remotePlayers.values())ba(r);s("Lobby listo"),$i&&$i.classList.add("hidden"),Zi&&Zi.classList.remove("hidden"),Ri()},Ob=async()=>{const i=await dm();hm(i),nc(et),await Nr(et),await Fh(),Ur();for(const e of H.remotePlayers.values())ba(e)},Ur=()=>{if(!qe.scene)return;const i=en.value||et;if(!i)return;qe.model&&(qe.scene.remove(qe.model),qe.model=null,qe.mixer=null);const e=Au.get(i);if(!e?.loaded||!e.scene){Nr(i).then(o=>{o?.loaded&&(en.value||et)===i&&Ur()});return}const t=lh(e.scene),n=new Mn().setFromObject(t),s=n.getCenter(new P),r=n.getSize(new P);t.position.set(-s.x,-n.min.y,-s.z),qe.scene.add(t),qe.model=t,qe.camera.position.set(0,Math.max(1.2,r.y*.55),Math.max(2.3,r.y*.95)),qe.camera.lookAt(0,Math.max(.9,r.y*.45),0);const a=e.animationSet?.running||ms(e.animations||[],"running",["running"]);if(a){const o=new Rp(t),c=o.clipAction(a);c.reset(),c.setLoop(Xo,1/0),c.play(),qe.mixer=o}},fm=()=>{if(!Zs||qe.renderer)return;const i=new pp,e=new Xt(40,1,.1,100),t=new Up({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(window.devicePixelRatio,2));const n=Zs.clientWidth||280,s=Zs.clientHeight||220;t.setSize(n,s,!1),Zs.appendChild(t.domElement);const r=new W0(12514815,1975838,.95);i.add(r);const a=new ah(16777215,1);a.position.set(3.5,5,4),i.add(a),qe.scene=i,qe.camera=e,qe.renderer=t,qe.lastWidth=n,qe.lastHeight=s,Ur()},pm=()=>{if(!qe.renderer||!qe.camera)return;const i=Zs.clientWidth||280,e=Zs.clientHeight||220;i===qe.lastWidth&&e===qe.lastHeight||(qe.lastWidth=i,qe.lastHeight=e,qe.camera.aspect=i/e,qe.camera.updateProjectionMatrix(),qe.renderer.setSize(i,e,!1))},pn=new Audio("/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3");pn.preload="auto";pn.loop=!1;pn.volume=.24;const Kr=[],Bb=8,mm="/themes/pre-lobby.mp3",gm="/themes/lobby.mp3",wu={battle1:"/themes/battle1.mp3",battle2:"/themes/battle2.mp3",battle3:"/themes/battle3.mp3"},Mh=i=>wu[i]||wu.battle1,Qn=new Audio(mm);Qn.preload="auto";Qn.loop=!1;Qn.volume=.28;const is=new Audio(gm);is.preload="auto";is.loop=!0;is.volume=.34;const Ai=new Audio(Mh("battle1"));Ai.preload="auto";Ai.loop=!0;Ai.volume=.38;let Ma=!1,Ms=!1,aa=!1,cr=!1,qi=!1,cl="battle1";const wi="/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3",zb=[".ogg",".mp3",".wav",".m4a",""],mo=new Map;let ll="";const Uf=140,ul=6,ji=[],kb=24,Vb=(i,e,t)=>{(i.getAttribute(t)||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute(t,e),i.load())},_m=()=>!H.joinedRoom&&$i&&!$i.classList.contains("hidden"),xm=()=>!H.joinedRoom&&Zi&&!Zi.classList.contains("hidden")&&(!$i||$i.classList.contains("hidden")),vm=()=>!!(H.joinedRoom&&H.joinedRoom.room?.status==="in_game"),hl=()=>{!Ms&&Qn.paused||(Qn.pause(),Qn.currentTime=0,Ms=!1,qi=!1)},go=()=>{!aa&&is.paused||(is.pause(),is.currentTime=0,aa=!1)},dl=()=>{!cr&&Ai.paused||(Ai.pause(),Ai.currentTime=0,cr=!1)},Hb=()=>{if(!Ma||Ms||!_m())return;Ms=!0;const i=Qn.play();i&&typeof i.catch=="function"&&i.catch(()=>{Ms=!1})},Gb=()=>{if(!Ma||aa||!xm())return;aa=!0;const i=is.play();i&&typeof i.catch=="function"&&i.catch(()=>{aa=!1})},Wb=()=>{if(!Ma||cr||!vm())return;cr=!0;const i=Ai.play();i&&typeof i.catch=="function"&&i.catch(()=>{cr=!1})},Ri=()=>{if(vm()){qi=!1,hl(),go(),Wb();return}if(_m()){qi=!1,dl(),go(),Hb();return}if(xm()){if(dl(),Ms&&!Qn.ended){qi=!0,go();return}qi=!1,hl(),Gb();return}qi=!1,dl(),hl(),go()},Ro=i=>{const e=String(i||"").trim(),t=wu[e]?e:"battle1";t!==cl&&(cl=t,Vb(Ai,Mh(cl),"data-bgm-src"),cr=!1,Ri())},Ca=()=>{const i=Math.max(0,Math.min(1,Pe.masterVolume));pn.volume=.24*i*Pe.sfxVolume,Qn.volume=.28*i*Pe.musicVolume,is.volume=.34*i*Pe.musicVolume,Ai.volume=.38*i*Pe.musicVolume,de.fov=Pe.fov,de.updateProjectionMatrix(),As.fov=Pe.fov,As.updateProjectionMatrix(),H.showPerf=Pe.showPerfByDefault||H.showPerf,Dr()},Xb=()=>{gu.value=String(Pe.mouseSensitivity),qp.textContent=Pe.mouseSensitivity.toFixed(2),_u.value=String(Pe.masterVolume),jp.textContent=`${Math.round(Pe.masterVolume*100)}%`,xu.value=String(Pe.musicVolume),Yp.textContent=`${Math.round(Pe.musicVolume*100)}%`,vu.value=String(Pe.sfxVolume),Kp.textContent=`${Math.round(Pe.sfxVolume*100)}%`,Mu.value=String(Math.round(Pe.fov)),$p.textContent=String(Math.round(Pe.fov)),yu.checked=!!Pe.showPerfByDefault},yh=()=>{Ir=!1,Xp.classList.add("hidden")},Mm=()=>{H.joinedRoom&&(Ir=!0,si=!1,Jp(),Xp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock())},qb=()=>{Ir?yh():Mm()},jb=i=>{const e=Ra(i);return e?zb.map(t=>`/characters/${encodeURIComponent(e)}/attack_sound${t}`):[]},Yb=i=>new Promise(e=>{const t=new Audio;let n=!1;const s=o=>{n||(n=!0,t.removeEventListener("canplaythrough",r),t.removeEventListener("loadedmetadata",r),t.removeEventListener("error",a),e(o))},r=()=>s(!0),a=()=>s(!1);t.preload="metadata",t.addEventListener("canplaythrough",r,{once:!0}),t.addEventListener("loadedmetadata",r,{once:!0}),t.addEventListener("error",a,{once:!0}),t.src=i,t.load(),setTimeout(()=>s(!1),900)}),Sh=async i=>{const e=Ra(i);if(!e)return wi;if(mo.has(e))return mo.get(e);const t=jb(e);for(let n=0;n<t.length;n+=1){const s=t[n];if(await Yb(s))return mo.set(e,s),s}return mo.set(e,wi),wi},ym=(i,e)=>{(i.getAttribute("data-attack-src")||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute("data-attack-src",e),i.removeAttribute("data-fallback-applied"),i.load())},nc=async i=>{const e=String(i||"").trim();if(e===ll&&pn.getAttribute("data-attack-src"))return;ll=e;const t=await Sh(e);e===ll&&ym(pn,t)},bh=()=>{Ma||(Ma=!0,Ri())};window.addEventListener("pointerdown",bh,{once:!0});window.addEventListener("keydown",bh,{once:!0});window.addEventListener("touchstart",bh,{once:!0,passive:!0});Qn.addEventListener("ended",()=>{Ms=!1,qi&&(qi=!1,Ri())});const Kb=()=>{const i=pn.getAttribute("data-attack-src")||pn.src||wi,e=new Audio(i);if(e.preload="auto",e.loop=!1,e.volume=pn.volume,Kr.length>=Bb){const s=Kr.shift();s&&(s.pause(),s.currentTime=0)}Kr.push(e);const t=()=>{const s=Kr.indexOf(e);s>=0&&Kr.splice(s,1)};e.addEventListener("ended",t,{once:!0}),e.addEventListener("pause",t,{once:!0});const n=e.play();n&&typeof n.catch=="function"&&n.catch(()=>{t();const s=pn.getAttribute("data-fallback-applied")==="1";i!==wi&&!s&&(pn.setAttribute("data-fallback-applied","1"),ym(pn,wi))})},$b=i=>{const e=i.distanceTo(de.position);if(e>=Uf)return 0;const n=1-(Math.max(ul,e)-ul)/(Uf-ul);return .02+Math.pow(Math.max(0,n),1.6)*.2},Ff=()=>{for(let i=0;i<ji.length;i+=1){const e=ji[i];e.pause(),e.currentTime=0}ji.length=0},Zb=async(i,e="")=>{const t=$b(i);if(t<=.02)return;let n=wi;e&&(n=await Sh(e));const s=new Audio(n||wi);if(s.preload="auto",s.loop=!1,s.volume=t*Pe.masterVolume*Pe.sfxVolume,ji.length>=kb){const o=ji.shift();o&&(o.pause(),o.currentTime=0)}ji.push(s);const r=()=>{const o=ji.indexOf(s);o>=0&&ji.splice(o,1)};s.addEventListener("ended",r,{once:!0}),s.addEventListener("pause",r,{once:!0});const a=s.play();a&&typeof a.catch=="function"&&a.catch(()=>{r()})},lr=new h_;new Xe(0,0);const Jb=new jo(.028,.028,1,10,1,!0),Qb=new It({color:10682286,transparent:!0,opacity:1,blending:Li,depthWrite:!1}),eE=new li(.11,8,8),tE=new It({color:8257426,transparent:!0,opacity:.9}),ys=[],ur=[],oa=[],ca=[],la=[],ua=[],nE=new li(.045,6,6),Ss=[],iE=420,sE=680,rE=720,pt={KeyW:!1,KeyA:!1,KeyS:!1,KeyD:!1,Space:!1};let bs=!1,Pn=0,Ci=0;const Eh=9,aE=24,oE=18,cE=.45,lE=.92,vn=1.7,uE=6.8,hE=18;let si=!1,fl=0;const dE=8,fE=1,Ru=55,pE=19,Of=260,mE=.018,gE=.008,_E=1.2,xE=2.25,vE=1.2,ri=10,Et=100,Pa=100,ic=0,ss=30,Ia=120,hn=100,Bf=Math.ceil(hn/3),ME=12,yE=50,SE=6e4,bE=12,EE=20,TE=30,AE=6e4,wE=25,RE=20,CE=6e4,PE=Et/3,IE=18,sc=.5,rc=.92,LE=.18,DE=-.45,pl=2.45,Cu=.9,zf=.09,NE=320;let Th=0,Vt=Et,ai=ic,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,yt=!1,Ui=0,Ln=ri,br=!1,Ah=0,dr=0,ml=0,er=0,ya=0,fr=0,Sm=0,bm=0,wh=0,Rh=0,Em=0;const kf=new Nn(0,0,0,"YXZ"),Ys=new P,gl=new P,Vn=new P,vt=new P,Vf=new P,UE=new d_,Ch=Math.PI,FE=170,OE=160,BE=4.8,zE=2.4,kE=9.5,VE=.55,HE=.32,GE=140,Tm=220,WE=()=>Date.now(),XE=new qo(.2,.18,4,8),qE=new Un({color:5082623,emissive:1719696,emissiveIntensity:.85,roughness:.35,metalness:.4}),tr=[],jE=new ih(.32,0),YE=new Un({color:4584703,emissive:1006976,emissiveIntensity:.9,roughness:.25,metalness:.3}),nr=[],ir=[],_o=i=>{let e=Number(i)>>>0;return()=>{e+=1831565813;let t=Math.imul(e^e>>>15,1|e);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},KE=i=>{const e=String(i||"");let t=2166136261;for(let n=0;n<e.length;n+=1)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0||1},$E=(i,e,t=0)=>!0,Hf=(i,e,t=0)=>({x:i,z:e}),ZE=()=>{for(let i=rl.length-1;i>=0;i-=1){const e=rl[i];e&&(Ee.remove(e),e.traverse(t=>{t.isMesh&&(t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(s=>s.dispose()))}))}rl.length=0,Tu.length=0},es=i=>{ra=Math.min(1,ra+.5),i&&Rb.copy(i)},Am=i=>{const e=Number(i);if(!Number.isFinite(e)||Lf===e)return;Lf=e;for(let a=Ji.length-1;a>=0;a-=1){const o=Ji[a];Ee.remove(o),o.geometry.dispose(),o.material.dispose()}Ji.length=0,ko.length=0,ZE();for(let a=tr.length-1;a>=0;a-=1)Ee.remove(tr[a].mesh);tr.length=0;for(let a=nr.length-1;a>=0;a-=1)Ee.remove(nr[a].mesh);nr.length=0;for(let a=ir.length-1;a>=0;a-=1)Ee.remove(ir[a].mesh);ir.length=0;const t=_o(e^2654435769);for(let a=0;a<220;a+=1){const o=1+t()*3,c=1+t()*3,l=3+t()*24,u=new Je(new Rs(o,l,c),bb.clone());u.position.set((t()-.5)*220,l/2,(t()-.5)*220),u.userData.hp=1+Math.floor(t()*3),Ee.add(u),Ji.push(u),ko.push({minX:u.position.x-o/2,maxX:u.position.x+o/2,minZ:u.position.z-c/2,maxZ:u.position.z+c/2})}const n=_o(e^2246822507);for(let a=0;a<yE;a+=1){const o=al("mana",()=>new Je(XE,qE.clone())),c=(n()-.5)*180,l=(n()-.5)*180,u=.35;o.position.set(c,u,l),Ee.add(o),tr.push({mesh:o,baseY:u,phase:n()*Math.PI*2,active:!0,respawnAt:0})}const s=_o(e^3266489909);for(let a=0;a<TE;a+=1){const o=al("defensa",()=>new Je(jE,YE.clone())),c=(s()-.5)*180,l=(s()-.5)*180,u=.6;o.position.set(c,u,l),Ee.add(o),nr.push({mesh:o,baseY:u,phase:s()*Math.PI*2,active:!0,respawnAt:0})}const r=_o(e^668265263);for(let a=0;a<RE;a+=1){const o=al("vida",()=>new Je(new sh(.34,0),new Un({color:9502623,emissive:2985794,emissiveIntensity:.8,roughness:.32,metalness:.25}))),c=(r()-.5)*180,l=(r()-.5)*180,u=.55;o.position.set(c,u,l),Ee.add(o),ir.push({mesh:o,baseY:u,phase:r()*Math.PI*2,active:!0,respawnAt:0})}},ac=i=>String(i||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,""),Ph=i=>{const e=ac(i);return e==="silentman"||e==="silenmant"},Ih=i=>ac(i)==="pumori",Lh=i=>ac(i)==="neoorphen",Dh=i=>{const e=ac(i);return e==="pezunalunar"||e==="pezuanalunar"},Fr=i=>Ph(i)||Ih(i)||Lh(i)||Dh(i),JE=()=>Fr(et)?fE:1/dE;Am(1);const Pt=()=>{const i=Fr(et),e=i?Math.round(Lt):Pi,t=i?hn:ei,n=i?"Mana":"Balas",s=Math.round(Vt),r=Math.round(ai);if(XS.textContent=`Vida: ${s}`,qS.textContent=`Escudo: ${r}`,jS.textContent=`${n}: ${e} / ${t}${!i&&jn?" (recargando...)":""}`,eb.textContent=`Kills: ${Th}`,YS.textContent=`${s}`,KS.textContent=`${r}`,$S.textContent=`${e} / ${t}`,ZS.style.width=`${Math.max(0,Math.min(100,Vt/Et*100))}%`,JS.style.width=`${Math.max(0,Math.min(100,ai/Pa*100))}%`,QS.style.height=`${Math.max(0,Math.min(100,e/t*100))}%`,!H.joinedRoom){Mf.textContent="Sala: -",yf.textContent="Estado: waiting",Sf.textContent="Clima: -",bf.textContent="Jugadores: -",nl.classList.add("hidden");return}const a=H.joinedRoom.room,o=H.joinedRoom.players.map(c=>c.name).join(", ");Mf.textContent=`Sala: ${a.name} (${a.id})`,yf.textContent=`Estado: ${a.status}`,Sf.textContent=`Clima: ${mb(a.weather)}`,bf.textContent=`Jugadores: ${o||"-"}`,em()?(nl.classList.remove("hidden"),Vp.disabled=a.status==="in_game",Hp.disabled=a.status!=="in_game"):nl.classList.add("hidden"),Qp(),dh(),Dr(),wm()},oi=()=>{if(!yt||!H.joinedRoom||!xa()){xf.classList.add("hidden");return}HS.textContent=String(Ln),xf.classList.remove("hidden")},vs=()=>{br=!1,Ah=0,dr=0,kp.classList.add("hidden")},QE=(i,e)=>{const t=String(i?.name||"Desconocido"),n=String(i?.character||"Sin personaje"),s=Math.max(1,Number(e)||10);br=!0,Ah=performance.now()+s*1e3,dr=s,GS.textContent=`Ganador: ${t} (${n})`,mu.textContent=String(dr),kp.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),si=!1,yt&&(yt=!1,Ui=0,Ln=ri,oi())},wm=(i=0)=>{if(!tl)return;const e=!!(H.joinedRoom&&H.joinedRoom.room.status==="in_game"),n=1-Math.max(0,Math.min(1,Vt/Et));let s=e&&!yt?n*.62:0;e||(er=0);const r=i>0?Math.min(1,i*4.8):1;ml+=(s-ml)*r,er=Math.max(0,er-(i>0?i*1.7:0));const a=e&&!yt?(Math.sin(performance.now()*.01)+1)*.5*n*.22:0,o=Math.max(0,Math.min(.92,ml+a+er));tl.style.opacity=o.toFixed(3),tl.style.setProperty("--bleed-inner",`${20+n*24}%`)},eT=(i=!1)=>{const e=performance.now();Sm=e+140,i&&(bm=e+220)},tT=()=>{wh=performance.now()+320},nT=i=>{if(!i||!H.remotePlayers.has(i))return;const e=H.remotePlayers.get(i);if(!e?.group)return;const t=e.group.position.x-de.position.x,n=e.group.position.z-de.position.z;Em=(Math.atan2(t,-n)-Pn)*180/Math.PI,Rh=performance.now()+520},iT=()=>{if(!jr)return;const i=performance.now(),e=Math.sqrt(vt.x*vt.x+vt.z*vt.z),t=Math.min(1,e/Math.max(.001,Eh)),n=Ht?.85:0,s=5+t*7.5+n*6+ya*10+fr*6.5;jr.style.setProperty("--crosshair-gap",`${s.toFixed(2)}px`),jr.classList.toggle("hit",i<=Sm),jr.classList.toggle("headshot",i<=bm),jr.classList.toggle("kill",i<=wh)},sT=()=>{if(!lo)return;if(!(performance.now()<=Rh)){lo.classList.remove("visible");return}lo.classList.add("visible"),lo.style.setProperty("--damage-angle",`${Em.toFixed(1)}deg`)},Co=()=>{Vt=Et,ai=ic,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,Th=0,yt=!1,Ln=ri,Ui=0,vs(),si=!1,wh=0,Rh=0,oi(),Pt()},Nh=()=>{Fr(et)||jn||Pi>=ss||ei<=0||!On()||(jn=!0,hr=vE,Pt())},rT=()=>{Vt=Et,ai=ic,Pi=ss,ei=Ia-ss,Lt=hn,ti=Math.round(hn),Kt=0,jn=!1,hr=0,Ht=!1,Si=0,yt=!1,Ln=ri,Ui=0,oi(),nn({type:"player_respawn"}),Pt()},Rm=()=>{xa()&&(yt=!0,si=!1,Ht=!1,Si=0,Ui=performance.now()+ri*1e3,Ln=ri,document.pointerLockElement&&document.exitPointerLock(),oi())},Gf=(i,e,t)=>{const n=(e-i+Math.PI)%(Math.PI*2)-Math.PI;return i+n*t},ms=(i,e,t)=>{const n=i.find(s=>s.name===e);return n||i.find(s=>{const r=String(s.name||"").toLowerCase();return t.some(a=>r.includes(a))})},Uh=i=>{const e=String(i||"").trim();if(!e)return on[0]||et||"silentman";if(on.includes(e))return e;const t=e.toLowerCase(),n=on.find(s=>Ho(s).toLowerCase()===t);return n||e},bi=(i,e)=>{if(!i.actions)return;const t=i.actions[e]||i.actions.move||null;t&&i.currentAnimation!==e&&(Object.values(i.actions).forEach(n=>{!n||n===t||n.fadeOut(.12)}),e==="death"?(t.reset(),t.setLoop(Gu,1),t.clampWhenFinished=!0,t.fadeIn(.08).play()):(t.reset(),t.setLoop(Xo,1/0),t.clampWhenFinished=!1,t.fadeIn(.1).play()),i.currentAnimation=e)},Sa=i=>{i.actions&&bi(i,"idle")},Yi=i=>{if(!Ke.actions)return;const e=Ke.actions[i]||Ke.actions.move||null;e&&Ke.currentAnimation!==i&&(Object.values(Ke.actions).forEach(t=>{!t||t===e||t.fadeOut(.1)}),i==="death"||i==="funny"?(e.reset(),e.setLoop(Gu,1),e.clampWhenFinished=!0,e.fadeIn(.08).play()):(e.reset(),e.setLoop(Xo,1/0),e.clampWhenFinished=!1,e.fadeIn(.08).play()),Ke.currentAnimation=i)},Po=()=>{Ke.funnyUntil<=0||(Ke.funnyUntil=0,Ke.currentAnimation==="funny"&&Yi("idle"))},Cm=i=>{const e=new un,t=lh(i.scene),n=new Mn().setFromObject(t),s=Number.isFinite(n.min.y)?n.min.y:0;t.position.y-=s,e.add(t);const r=new Rp(t),a=i.animations||[],o=i.animationSet?.idle||ms(a,"idle",["idle"]),c=i.animationSet?.running||ms(a,"running",["running"]),l=i.animationSet?.jump||ms(a,"jump",["jump"]),u=i.animationSet?.funny||ms(a,"funny",["funny"]),h=i.animationSet?.attack||ms(a,"attack",["attack"]),d=i.animationSet?.dead||ms(a,"dead",["dead"]),f={idle:o?r.clipAction(o):null,move:c?r.clipAction(c):null,jump:l?r.clipAction(l):null,funny:u?r.clipAction(u):null,shoot:h?r.clipAction(h):null,death:d?r.clipAction(d):null};return Ee.add(e),{group:e,avatarRoot:t,mixer:r,actions:f,body:null,head:null}},aT=()=>{Ke.group&&Ee.remove(Ke.group),Ke.group=null,Ke.mixer=null,Ke.actions=null,Ke.currentAnimation="",Ke.funnyUntil=0},Fh=async()=>{const i=en.value||et;if(!i)return;const e=`${i}`;Ke.loadingKey=e;const t=await Nr(i);if(!t?.loaded||Ke.loadingKey!==e)return;aT();const n=Cm(t);Ke.group=n.group,Ke.mixer=n.mixer,Ke.actions=n.actions,Ke.currentAnimation="",Ke.shootUntil=0,Ke.funnyUntil=0,Yi("idle")},oT=i=>{if(!Ke.group)return;const e=!!(H.joinedRoom&&or&&!yt);if(Ke.group.visible=e,!e)return;Ke.group.position.set(de.position.x,de.position.y-vn,de.position.z),Ke.group.rotation.y=Pn+Ch;const t=performance.now(),n=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD;Ke.funnyUntil>t?Yi("funny"):Ht?Yi("jump"):Ke.shootUntil>t?Yi("shoot"):Yi(n?"move":"idle"),Ke.mixer&&Ke.mixer.update(i)},cT=i=>{const e=new un,t=new Un({color:i?4835839:6815591,emissive:i?731702:1003290,emissiveIntensity:.6,roughness:.6}),n=t.clone(),s=new Je(new qo(.35,.9,4,8),t),r=new Je(new li(.22,12,12),n);return s.position.y=1.15,r.position.y=1.95,e.add(s),e.add(r),Ee.add(e),{group:e,avatarRoot:e,body:s,head:r,mixer:null,actions:null}},ba=async i=>{const e=Uh(i.character);if(!e)return;const t=await Nr(e);if(!t?.loaded||!H.remotePlayers.has(i.id))return;const n=H.remotePlayers.get(i.id);if(!n)return;n.character=e;const s=n.group.position.clone(),r=n.group.rotation.y;oc(n);const a=Cm(t);a.group.position.copy(s),a.group.rotation.y=r,n.group=a.group,n.avatarRoot=a.avatarRoot,n.body=a.body,n.head=a.head,n.mixer=a.mixer,n.actions=a.actions,n.currentAnimation=null,n.animationUntil=0,n.isDead=!1,n.isJumping=!1,n.deadAt=0;const o=Fm();n.group.add(o.holder),n.healthBar=o,Es(n),Sa(n)},oc=i=>{i.healthBar&&(i.healthBar.holder?.parent&&i.healthBar.holder.parent.remove(i.healthBar.holder),i.healthBar.bg&&(i.healthBar.bg.geometry.dispose(),i.healthBar.bg.material.dispose()),i.healthBar.fill&&(i.healthBar.fill.geometry.dispose(),i.healthBar.fill.material.dispose()),i.healthBar.text&&(i.healthBar.text.geometry.dispose(),i.healthBar.text.material.dispose()),i.healthBar.textTexture&&i.healthBar.textTexture.dispose(),i.healthBar=null),Ee.remove(i.group),i.body&&(i.body.geometry.dispose(),i.body.material.dispose()),i.head&&(i.head.geometry.dispose(),i.head.material.dispose())},lT=(i,e,t)=>{const n=cT(e),s=Uh(t);H.remotePlayers.set(i,{id:i,name:"Player",character:s,group:n.group,avatarRoot:n.avatarRoot,body:n.body,head:n.head,mixer:n.mixer,actions:n.actions,currentAnimation:null,animationUntil:0,isDead:!1,health:Et,isJumping:!1,deadAt:0,targetPosition:new P(0,0,0),targetYaw:0,targetPitch:0,netSnapshots:[],netInitialized:!1,smoothedMoveSpeed:0,movingUntil:0,lastAnimationAt:0,healthBar:null});const r=H.remotePlayers.get(i),a=Fm();r.group.add(a.holder),r.healthBar=a,Es(r),r.character||(r.character=on[0]||et||"silentman"),ba(r)},Pu=i=>{if(H.self&&i.id===H.self.id)return;H.remotePlayers.has(i.id)||lT(i.id,H.joinedRoom?.room?.hostId===i.id,i.character);const e=H.remotePlayers.get(i.id);i.name&&(e.name=String(i.name));const n=typeof i.character=="string"&&i.character.length>0?Uh(i.character):e.character;n!==e.character&&(e.character=n||e.character,ba(e)),e.mixer||(e.character||(e.character=on[0]||et||"silentman"),e.character&&ba(e));const s=i.state?.position||{x:0,y:vn,z:0},r=i.state?.rotation||{yaw:0,pitch:0},a=!!i.state?.moving,o=Number.isFinite(Number(i.ts))?Number(i.ts):Date.now();e.isJumping=!!i.state?.jumping,a&&(e.movingUntil=Math.max(Number(e.movingUntil||0),performance.now()+Tm)),Number.isFinite(Number(i.health))&&(e.health=Math.max(0,Math.min(Et,Math.round(Number(i.health)))),Es(e)),typeof i.alive=="boolean"&&(!i.alive&&!e.isDead?(e.isDead=!0,e.deadAt=performance.now(),e.animationUntil=0,bi(e,"death"),Es(e)):i.alive&&e.isDead&&(e.isDead=!1,e.deadAt=0,e.animationUntil=0,Sa(e),Number.isFinite(Number(i.health))||(e.health=Et),Es(e)));const l={ts:o,x:s.x,y:s.y-vn,z:s.z,yaw:r.yaw,pitch:r.pitch,jumping:!!i.state?.jumping,moving:a};e.netSnapshots.push(l),e.netSnapshots.length>32&&e.netSnapshots.splice(0,e.netSnapshots.length-32),e.netInitialized||(e.group.position.set(l.x,l.y,l.z),e.targetPosition.set(l.x,l.y,l.z),e.group.rotation.y=l.yaw+Ch,e.targetYaw=l.yaw,e.targetPitch=l.pitch,e.smoothedMoveSpeed=0,e.netInitialized=!0)},uT=i=>{const e=new Set;i.players.forEach(t=>{H.self&&t.id===H.self.id||(e.add(t.id),Pu(t))});for(const[t,n]of H.remotePlayers.entries())e.has(t)||(oc(n),H.remotePlayers.delete(t))},Wf=()=>{for(const i of H.remotePlayers.values())oc(i);H.remotePlayers.clear()},Dn=(i,e,t=10682286,n={})=>{const s=e.clone().sub(i),r=s.length();if(r<=1e-4)return;const a=Number.isFinite(n.radiusScale)?n.radiusScale:1,o=Number.isFinite(n.life)?n.life:.14,c=Number.isFinite(n.opacity)?n.opacity:1,l=Qb.clone();l.color=new Ce(t),l.opacity=c;const u=new Je(Jb,l);if(u.position.copy(i).add(e).multiplyScalar(.5),u.quaternion.setFromUnitVectors(new P(0,1,0),s.normalize()),u.scale.set(a,r,a),u.userData.life=o,Ee.add(u),ys.push(u),ys.length>iE){const h=ys.shift();h&&(Ee.remove(h),h.material.dispose())}},Pm=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.22,14,14),new It({color:10154239,transparent:!0,opacity:.96,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),oa.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:85,phase:Math.random()*Math.PI*2,spin:Math.PI*15+Math.random()*Math.PI*6,radius:.72,radiusFalloff:.22,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Im=(i,e,t={})=>{const n=e.clone().sub(i);if(n.length()<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new un,l=new Je(new Rs(.46,.26,.22),new It({color:16773830,transparent:!0,opacity:.98,blending:Li,depthWrite:!1})),u=new Je(new jo(.05,.05,.7,10),new It({color:10154239,transparent:!0,opacity:.95,blending:Li,depthWrite:!1}));u.rotation.z=Math.PI/2,c.add(l),c.add(u),c.position.copy(i),Ee.add(c),ca.push({mesh:c,prevPos:i.clone(),pos:i.clone(),velocity:r.clone().multiplyScalar(34).add(o.clone().multiplyScalar(7.2)),origin:i.clone(),right:a,up:o,traveledDistance:0,spin:(Math.random()>.5?1:-1)*(Math.PI*6.5+Math.random()),phase:Math.random()*Math.PI*2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Lm=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.3,16,16),new It({color:6029158,transparent:!0,opacity:.9,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),la.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:60,phase:Math.random()*Math.PI*2,spin:Math.PI*9+Math.random()*Math.PI*3,waveAmpA:1.05,waveAmpB:.42,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Dm=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let a=new P().crossVectors(r,new P(0,1,0));a.lengthSq()<1e-4?a=new P(1,0,0):a.normalize();const o=new P().crossVectors(a,r).normalize(),c=new Je(new li(.22,16,16),new It({color:15267839,transparent:!0,opacity:.96,blending:Li,depthWrite:!1}));c.position.copy(i),Ee.add(c),ua.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:a,up:o,distance:s,traveled:0,speed:80,phase:Math.random()*Math.PI*2,spin:Math.PI*10+Math.random()*Math.PI*4,waveAmpA:.4,waveAmpB:.2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},Jt=(i,e=8257426)=>{if(ur.length>=sE)return null;const t=new Je(eE,tE.clone());return t.material.color=new Ce(e),t.position.copy(i),t.userData.life=.26,Ee.add(t),ur.push(t),t},Go=(i,e,t,n)=>{const s=e.clone().sub(i),r=s.length();if(r<=1e-4)return null;s.multiplyScalar(1/r);const o=t.clone().sub(i).dot(s);if(o<0||o>r)return null;const c=s.multiplyScalar(o).add(i);return c.distanceToSquared(t)<=n*n?c:null},cc=(i,e,t=.2)=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return null;const r=n.multiplyScalar(1/s);lr.set(i,r),lr.far=s+t;const a=lr.intersectObjects(Ji,!1);return a.length>0?a[0].point.clone():null},lc=(i,e)=>{const t=de.position.clone().add(new P(0,LE,0)),n=de.position.clone().add(new P(0,DE,0)),s=Go(i,e,t,sc);if(s)return{point:s,headshot:!0};const r=Go(i,e,n,rc);return r?{point:r,headshot:!1}:null},uc=(i,e)=>{},hT=i=>{if(!H.self)return;const e=i.players.find(s=>s.id===H.self.id);if(!e)return;const t=e.state?.position,n=e.state?.rotation;t&&(de.position.set(t.x,t.y,t.z),Bm(),Ht=!!e.state?.jumping,!Ht&&de.position.y<=vn+.001&&(Si=0)),n&&(Pn=n.yaw,Ci=n.pitch,hc()),Th=Number.isFinite(e.kills)?e.kills:0,Number.isFinite(e.health)&&(Vt=Math.max(0,Math.min(Et,Number(e.health)))),Number.isFinite(e.shield)&&(ai=Math.max(0,Math.min(Pa,Math.round(e.shield)))),Number.isFinite(e.mana)&&(Lt=Math.max(0,Math.min(hn,Math.round(e.mana))),ti=Math.round(Lt)),Number.isFinite(Number(e.pendingHealthRegen))&&(Kt=Math.max(0,Number(e.pendingHealthRegen))),Nu(),e.alive===!1&&!yt&&xa()&&Rm(),e.alive===!0&&yt&&(yt=!1,Ui=0,Ln=ri,oi())},Xf=(i,e={})=>{const t=!H.joinedRoom;H.joinedRoom=i;const n=Number.isFinite(i.room?.mapSeed)?i.room.mapSeed:KE(i.room?.id);Am(n),uT(i),sa(i.room?.weather),Ro(i.room?.battleTheme),(e.applyOwnState||t)&&hT(i),t&&Co(),zo(!0),em()&&i.room.status!=="in_game"&&nn({type:"start_game"}),i.room.status!=="cooldown"&&vs(),Pt()},Nm=()=>{const i=xb(),e=new WebSocket(i);H.ws=e,Qc.textContent=`Conectando a ${i}`,e.addEventListener("open",()=>{Qc.textContent="Conectado",Js(),nn({type:"list_rooms"})}),e.addEventListener("message",t=>{let n;try{n=JSON.parse(t.data)}catch{Js("Respuesta invalida del servidor");return}if(n.ok===!1&&n.error){Js(n.error.message||"Error del servidor");return}if(n.type==="connected"){H.self=n.data.player,zp.value=H.self.name,H.self.character&&on.includes(H.self.character)&&(et=H.self.character,en.value=H.self.character),nc(H.self.character||et),H.rooms=n.data.rooms||[],Ur(),bu();return}if(n.type==="rooms_list"){H.rooms=n.data||[],bu();return}if(n.type==="room_joined"){Xf(n.data,{applyOwnState:!0});return}if(n.type==="room_state"){Xf(n.data);return}if(n.type==="left_room"){H.joinedRoom=null,H.showScoreboard=!1,vi=null,H.latencyMs=null,Wf(),zo(!1),Ff(),sa("night"),Ro("battle1"),Co(),vs(),Pt(),Ri();return}if(n.type==="pong"){const s=String(n.data?.probeId||"");vi&&s===vi.id&&(H.latencyMs=performance.now()-vi.sentAt,vi=null,Dr());return}if(n.type==="player_joined"){n.data?.player&&Pu(n.data.player);return}if(n.type==="player_left"){const s=n.data?.playerId;s&&H.remotePlayers.has(s)&&(oc(H.remotePlayers.get(s)),H.remotePlayers.delete(s));return}if(n.type==="player_move"){const{playerId:s,position:r,rotation:a,character:o,jumping:c,moving:l,ts:u}=n.data||{};if(!s||H.self&&s===H.self.id)return;Pu({id:s,ts:u,character:o,state:{position:r,rotation:a,jumping:c,moving:l}});return}if(n.type==="player_shoot"){const s=n.data;if(!s)return;const r=s.playerId?H.remotePlayers.get(s.playerId):null,a=s.character||r?.character||"",o=Ph(a),c=Ih(a),l=Lh(a),u=Dh(a);if(s.playerId&&H.remotePlayers.has(s.playerId)){const m=H.remotePlayers.get(s.playerId);m.isDead||(bi(m,"shoot"),m.animationUntil=performance.now()+420)}const h=new P(s.origin.x,s.origin.y,s.origin.z),d=new P(s.direction.x,s.direction.y,s.direction.z).normalize(),f=s.distance||100,_=h.clone().add(d.clone().multiplyScalar(f)).clone();o?(Pm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):c?(Im(h,_,{source:"remote",ownerId:s.playerId}),es(h)):l?(Lm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):u?(Dm(h,_,{source:"remote",ownerId:s.playerId}),es(h)):(Dn(h,_,5885183),Jt(_,5885183)),Zb(h,a);return}if(n.type==="player_damage"){if(!H.self||!On())return;const s=Number(n.data?.health),r=Number(n.data?.shield),a=!!n.data?.headshot;Number.isFinite(s)&&(Vt=Math.max(0,Math.min(Et,s))),Number.isFinite(r)&&(ai=Math.max(0,Math.min(Pa,Math.round(r)))),Nu(),er=Math.min(.45,er+(a?.35:.2)),nT(n.data?.fromPlayerId),Pt();return}if(n.type==="hit_confirm"){eT(!!n.data?.headshot);return}if(n.type==="player_resources"){const s=Number(n.data?.mana),r=Number(n.data?.health),a=Number(n.data?.pendingHealthRegen);let o=!1;Number.isFinite(s)&&(Lt=Math.max(0,Math.min(hn,Math.round(s))),ti=Math.round(Lt),o=!0),Number.isFinite(r)&&(Vt=Math.max(0,Math.min(Et,r)),o=!0),Number.isFinite(a)&&(Kt=Math.max(0,a)),Nu(),o&&Pt();return}if(n.type==="player_death"){const s=n.data?.playerId;if(!s)return;if(H.self&&n.data?.killerId===H.self.id&&s!==H.self.id&&tT(),H.self&&s===H.self.id){Vt=0,Kt=0,Pt(),Rm();return}if(!H.remotePlayers.has(s))return;const r=H.remotePlayers.get(s);r.isDead=!0,r.health=0,r.isJumping=!1,r.deadAt=performance.now(),bi(r,"death"),r.animationUntil=0,Es(r);return}if(n.type==="player_respawned"){const s=n.data?.playerId;if(!s)return;if(H.self&&s===H.self.id){const o=n.data?.position;o&&Number.isFinite(Number(o.x))&&Number.isFinite(Number(o.y))&&Number.isFinite(Number(o.z))&&(de.position.set(Number(o.x),Number(o.y),Number(o.z)),Bm()),Vt=Number.isFinite(n.data?.health)?Number(n.data.health):Et,ai=Number.isFinite(n.data?.shield)?Math.round(n.data.shield):ic,Number.isFinite(n.data?.mana)&&(Lt=Math.round(n.data.mana),ti=Math.round(Lt)),Kt=0,yt=!1,Ui=0,Ln=ri,oi(),Pt();return}const r=H.remotePlayers.get(s);if(!r)return;r.isDead=!1,r.deadAt=0,r.health=Number.isFinite(Number(n.data?.health))?Math.max(0,Math.min(Et,Math.round(Number(n.data.health)))):Et,r.animationUntil=0,Sa(r);const a=n.data?.position;if(a&&Number.isFinite(Number(a.x))&&Number.isFinite(Number(a.y))&&Number.isFinite(Number(a.z))){const o=Number(a.x),c=Number(a.y)-vn,l=Number(a.z);r.group.position.set(o,c,l),r.targetPosition.set(o,c,l)}Es(r);return}if(n.type==="chat_message"){const s=n.data||{},r=String(s.playerName||"Player"),a=String(s.text||"").trim();if(!a)return;hb(r,a),uh.classList.add("open");return}if(n.type==="player_funny"){const s=n.data?.playerId;if(!s||!H.remotePlayers.has(s))return;const r=H.remotePlayers.get(s);if(r.isDead)return;r.currentAnimation==="funny"&&(r.currentAnimation=""),bi(r,"funny");const a=r.actions?.funny,o=Math.max(500,Math.round((a?.getClip()?.duration||1)*1e3));r.animationUntil=performance.now()+o;return}if(n.type==="game_state"){H.joinedRoom&&H.joinedRoom.room.id===n.data.roomId&&(H.joinedRoom.room.status=n.data.status,H.joinedRoom.room.hostId=n.data.hostId,n.data.weather&&(H.joinedRoom.room.weather=n.data.weather,sa(n.data.weather)),n.data.battleTheme&&(H.joinedRoom.room.battleTheme=n.data.battleTheme,Ro(n.data.battleTheme)),n.data.status!=="in_game"&&yt&&(yt=!1,Ui=0,Ln=ri,oi()),n.data.status!=="cooldown"&&vs(),Pt(),Ri());return}if(n.type==="match_winner"){if(!H.joinedRoom)return;QE(n.data?.winner,n.data?.countdownSeconds);return}if(n.type==="match_reset"){vs(),Co(),Pt();return}}),e.addEventListener("close",()=>{Qc.textContent="Desconectado. Reintentando...",H.joinedRoom=null,H.showScoreboard=!1,vi=null,H.latencyMs=null,Wf(),zo(!1),Ff(),sa("night"),Ro("battle1"),Co(),vs(),Pt(),Ri(),setTimeout(Nm,1200)}),e.addEventListener("error",()=>{Js("No se pudo conectar al WebSocket")})};en.addEventListener("change",()=>{et=en.value||et,H.self&&(H.self.character=et),nc(et),Nr(et),Fh(),Ur(),Pt()});VS.addEventListener("click",()=>{nn({type:"list_rooms"}),Ob()});cb.addEventListener("click",()=>{nn({type:"leave_room"})});Vp.addEventListener("click",()=>{nn({type:"start_game"})});Hp.addEventListener("click",()=>{nn({type:"end_game"})});lb.addEventListener("click",()=>{yh()});gu.addEventListener("input",()=>{Pe.mouseSensitivity=qn(gu.value,.4,2.5,Pe.mouseSensitivity),qp.textContent=Pe.mouseSensitivity.toFixed(2),Lr()});_u.addEventListener("input",()=>{Pe.masterVolume=qn(_u.value,0,1,Pe.masterVolume),jp.textContent=`${Math.round(Pe.masterVolume*100)}%`,Ca(),Lr()});xu.addEventListener("input",()=>{Pe.musicVolume=qn(xu.value,0,1,Pe.musicVolume),Yp.textContent=`${Math.round(Pe.musicVolume*100)}%`,Ca(),Lr()});vu.addEventListener("input",()=>{Pe.sfxVolume=qn(vu.value,0,1,Pe.sfxVolume),Kp.textContent=`${Math.round(Pe.sfxVolume*100)}%`,Ca(),Lr()});Mu.addEventListener("input",()=>{Pe.fov=qn(Mu.value,60,100,Pe.fov),$p.textContent=String(Math.round(Pe.fov)),Ca(),Lr()});yu.addEventListener("change",()=>{Pe.showPerfByDefault=!!yu.checked,!H.showPerf&&Pe.showPerfByDefault&&(H.showPerf=!0,fh(!0)),Dr(),Lr()});const hc=()=>{kf.set(Ci,Pn,0),de.quaternion.setFromEuler(kf)},Um=()=>{if(!or)return;Cf.copy(de.position),de.getWorldDirection(fo),fo.normalize();const i=Cf.clone().add(fo.clone().multiplyScalar(18));Pf.set(-Math.sin(Pn),0,-Math.cos(Pn)).normalize(),If.set(Math.cos(Pn),0,-Math.sin(Pn)).normalize(),ho.copy(de.position).addScaledVector(fo,-.8).add(new P(0,Mb,0)).addScaledVector(Pf,-4.6).addScaledVector(If,yb),ho.y=Math.max(vn+.6,ho.y),As.position.lerp(ho,Sb),As.lookAt(i)},Iu=()=>or?As:de,dT=(i,e,t,n={})=>{let s=t,r=null;const a=new P,o=new P,c=new P,l=Number.isFinite(n.headRadius)?n.headRadius:sc,u=Number.isFinite(n.bodyRadius)?n.bodyRadius:rc,h=(d,f)=>{o.copy(d).sub(i);const g=o.dot(e);g<0||g>s||(c.copy(e).multiplyScalar(g).add(i),c.distanceToSquared(d)<=f*f&&(s=g,r=c.clone()))};for(const d of H.remotePlayers.values())!d?.group||d.isDead||(a.set(d.group.position.x,d.group.position.y+1.85,d.group.position.z),h(a,l),a.set(d.group.position.x,d.group.position.y+1.1,d.group.position.z),h(a,u));return r?{point:r,distance:s}:null},Fm=()=>{const i=new un,e=new Je(new ts(Cu,zf),new It({color:1776411,transparent:!0,opacity:.78,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));e.renderOrder=999,e.position.set(0,pl,0),i.add(e);const t=new Je(new ts(Cu-.02,zf-.02),new It({color:5701485,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));t.renderOrder=1e3,t.position.set(0,pl,.001),i.add(t);const n=document.createElement("canvas");n.width=256,n.height=64;const s=n.getContext("2d"),r=new b0(n);r.minFilter=Tt,r.magFilter=Tt,r.generateMipmaps=!1;const a=new Je(new ts(1.05,.18),new It({map:r,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));return a.renderOrder=1001,a.position.set(0,pl+.16,.001),i.add(a),{holder:i,bg:e,fill:t,text:a,textCanvas:n,textCtx:s,textTexture:r,lastText:""}},Es=i=>{if(!i?.healthBar?.fill)return;const e=Number.isFinite(Number(i.health))?Number(i.health):Et,t=Math.max(0,Math.min(1,e/Et));i.healthBar.fill.scale.x=Math.max(.001,t),i.healthBar.fill.position.x=(t-1)*(Cu-.02)*.5,t>.66?i.healthBar.fill.material.color.set(5701485):t>.33?i.healthBar.fill.material.color.set(16769898):i.healthBar.fill.material.color.set(16738151);const n=`${String(i.name||"Player")} ${Math.round(e)}`;if(i.healthBar.lastText!==n&&i.healthBar.textCtx){const s=i.healthBar.textCtx;s.clearRect(0,0,i.healthBar.textCanvas.width,i.healthBar.textCanvas.height),s.font="bold 24px Courier New, monospace",s.textAlign="center",s.textBaseline="middle",s.strokeStyle="rgba(0, 0, 0, 0.75)",s.lineWidth=6,s.strokeText(n,i.healthBar.textCanvas.width/2,32),s.fillStyle="#d8ffd8",s.fillText(n,i.healthBar.textCanvas.width/2,32),i.healthBar.textTexture.needsUpdate=!0,i.healthBar.lastText=n}i.healthBar.holder.visible=!i.isDead},Ea=(i=!1)=>{if(!H.joinedRoom)return;const e=performance.now();if(!i&&e-H.lastStateSentAt<55)return;H.lastStateSentAt=e;const t=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD||vt.lengthSq()>.5;nn({type:"player_move",position:{x:de.position.x,y:de.position.y,z:de.position.z},rotation:{yaw:Pn,pitch:Ci},jumping:Ht,moving:t})},Lu=(i,e)=>{for(let t=0;t<ko.length;t+=1){const n=ko[t];if(i+Qi>n.minX&&i-Qi<n.maxX&&e+Qi>n.minZ&&e-Qi<n.maxZ)return!0}return!1},Du=(i,e)=>$E(i,e,Qi+.05)?!Lu(i,e):!1,fT=(i,e)=>{const t=Hf(i,e,Qi+.05);if(Du(t.x,t.z))return t;const n=14;for(let s=.6;s<=n;s+=.6)for(let a=0;a<24;a+=1){const o=a/24*Math.PI*2,c=Hf(t.x+Math.cos(o)*s,t.z+Math.sin(o)*s,Qi+.05);if(Du(c.x,c.z))return c}return t},Om=(i,e)=>{const t=de.position.x,n=de.position.z,s=Eb-Qi,r=Math.max(-s,Math.min(s,i)),a=Math.max(-s,Math.min(s,e));let o=t,c=n;return Lu(r,n)||(o=r),Lu(o,a)||(c=a),{x:o,z:c}},Bm=()=>{if(!Du(de.position.x,de.position.z)){const e=fT(de.position.x,de.position.z);de.position.x=e.x,de.position.z=e.z}const i=Om(de.position.x,de.position.z);de.position.x=i.x,de.position.z=i.z,de.position.y=Math.max(vn,de.position.y)};mn.domElement.addEventListener("click",()=>{!bs&&H.joinedRoom&&mn.domElement.requestPointerLock()});document.addEventListener("pointerlockchange",()=>{bs=document.pointerLockElement===mn.domElement,Jo.classList.toggle("locked",bs),bs||(si=!1,H.joinedRoom&&!Ir&&!yt&&!br&&!ns&&Mm())});document.addEventListener("mousemove",i=>{if(!bs||!On())return;const e=.0021*Pe.mouseSensitivity;Pn-=i.movementX*e,Ci-=i.movementY*e,Ci=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,Ci)),hc(),Ea()});window.addEventListener("mousedown",i=>{i.button===0&&bs&&On()&&(Po(),si=!0)});window.addEventListener("mouseup",i=>{i.button===0&&(si=!1)});window.addEventListener("keydown",i=>{if(i.code==="Escape"&&!ns){i.preventDefault(),qb();return}if(i.code==="Enter"){if(i.preventDefault(),!H.joinedRoom)return;if(!ns){db();return}const e=Bo.value.trim();e&&nn({type:"chat_message",text:e}),Su();return}if(ns){i.code==="Escape"&&(i.preventDefault(),Su());return}if(i.code==="Tab"&&(i.preventDefault(),H.joinedRoom&&(H.showScoreboard=!0,dh())),i.code==="KeyI"&&(H.showMatchInfo=!H.showMatchInfo,Qp()),i.code==="KeyP"&&(H.showPerf=!H.showPerf,H.showPerf&&fh(!0),Dr()),i.code==="KeyF"){if(i.preventDefault(),H.joinedRoom&&Ke.actions?.funny){const e=Ke.actions.funny.getClip(),t=Math.max(500,Math.round((e?.duration||1)*1e3));Ke.funnyUntil=performance.now()+t,Yi("funny"),nn({type:"player_funny"})}return}i.code==="KeyC"&&(or=!or,or&&Um()),i.code==="Space"&&(i.preventDefault(),Po(),On()&&!Ht&&de.position.y<=vn+.001&&(Ht=!0,Si=uE,Ea(!0))),i.code==="KeyR"&&(Po(),Nh()),i.code in pt&&((i.code==="KeyW"||i.code==="KeyA"||i.code==="KeyS"||i.code==="KeyD")&&Po(),pt[i.code]=!0)});window.addEventListener("keyup",i=>{ns||(i.code==="Space"&&i.preventDefault(),i.code==="Tab"&&(H.showScoreboard=!1,dh()),i.code in pt&&(pt[i.code]=!1))});const pT=()=>{const i=Ph(et),e=Ih(et),t=Lh(et),n=Dh(et),s=i||e||t||n;if(s&&Lt<Bf)return;if(!s&&Pi<=0){Nh();return}s?(Lt=Math.max(0,Lt-Bf),ti=Math.round(Lt)):Pi-=1,Kb(),Ke.shootUntil=performance.now()+420,Pt(),de.getWorldDirection(Vf);const r=Vf.clone().normalize(),a=de.position.clone().add(r.clone().multiplyScalar(.55)),o=Math.sqrt(vt.x*vt.x+vt.z*vt.z),c=Math.min(1,o/Math.max(.001,Eh)),l=!s,u=l?(.0018+c*.0032+(Ht?.0055:0)+fr*.0048)*(1/Pe.mouseSensitivity):0,h=r.clone();if(u>0){const _=new P().crossVectors(h,de.up).normalize(),m=new P().crossVectors(_,h).normalize(),p=(Math.random()*2-1)*u,M=(Math.random()*2-1)*u;h.add(_.multiplyScalar(p)).add(m.multiplyScalar(M)).normalize()}lr.set(a,h),lr.far=220;const d=lr.intersectObjects(Ji,!1);let f=d.length>0?d[0].point:a.clone().add(h.clone().multiplyScalar(120));if(s||e||t){const _=dT(a,h,a.distanceTo(f),{headRadius:sc,bodyRadius:rc});_?.point&&f.copy(_.point)}e&&a.distanceTo(f)>Ru&&(f=a.clone().add(h.clone().multiplyScalar(Ru)));const g=a.distanceTo(f);if(i?(Pm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):e?(Im(a,f,{source:"local",ownerId:H.self?.id}),es(a)):t?(Lm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):n?(Dm(a,f,{source:"local",ownerId:H.self?.id}),es(a)):(Dn(a,f),Jt(f)),nn({type:"player_shoot",origin:{x:a.x,y:a.y,z:a.z},direction:{x:h.x,y:h.y,z:h.z},distance:g}),va.intensity=2.3,ya=Math.min(1.3,ya+.52+c*.14+(Ht?.18:0)),fr=Math.min(_E,fr+(l?.22+c*.18+(Ht?.24:0):.08)),Ci+=(Math.random()*.5+.5)*mE,Pn+=(Math.random()-.5)*gE,Ci=Math.min(Ci,Math.PI/2-.01),hc(),d.length>0){const _=d[0].object;_.material.emissiveIntensity=1.3}},mT=(i,e)=>{i.active=!1,i.respawnAt=e+SE,i.mesh.visible=!1,Fr(et)?(Lt=Math.min(hn,Lt+EE),ti=Math.round(Lt)):ei=Math.min(Ia,ei+bE),Pt()},gT=(i,e)=>{i.active=!1,i.respawnAt=e+AE,i.mesh.visible=!1,ai=Math.min(Pa,ai+wE),Pt()},_T=(i,e)=>{i.active=!1,i.respawnAt=e+CE,i.mesh.visible=!1;const t=Math.max(0,Et-(Vt+Kt)),n=Math.min(t,PE);n<=0||(Kt+=n,nn({type:"player_pickup_health"}))},xT=i=>{if(!On()||yt||Vt<=0||Kt<=0)return;const e=Math.max(0,Et-Vt);if(e<=1e-4){Kt=0;return}const t=Math.min(e,Kt,IE*i);if(t<=1e-4)return;const n=Math.round(Vt);Vt+=t,Kt=Math.max(0,Kt-t),Math.round(Vt)!==n&&Pt()},Nu=()=>{const i=Math.max(0,Et-Vt);Kt=Math.max(0,Math.min(Kt,i))},Er=(i,e)=>{if(!i?.mesh||!i.active||!i.mesh.visible)return;if(Ss.length>=rE){const o=Ss.shift();o&&(Ee.remove(o.mesh),o.mesh.geometry.dispose(),o.mesh.material.dispose())}const t=new It({color:e,transparent:!0,opacity:.55+Math.random()*.25,blending:Li,depthWrite:!1}),n=new Je(nE,t),s=Math.random()*Math.PI*2,r=.11+Math.random()*.28;n.position.set(i.mesh.position.x+Math.cos(s)*r,i.mesh.position.y+.08+Math.random()*.32,i.mesh.position.z+Math.sin(s)*r),Ee.add(n);const a=.38+Math.random()*.3;Ss.push({mesh:n,life:a,initialLife:a,velocity:new P((Math.random()-.5)*.22,.28+Math.random()*.34,(Math.random()-.5)*.22)})},vT=i=>{for(let e=Ss.length-1;e>=0;e-=1){const t=Ss[e];t.life-=i,t.mesh.position.addScaledVector(t.velocity,i),t.velocity.y+=i*.2,t.mesh.scale.multiplyScalar(1+i*1.2);const n=Math.max(0,t.life/t.initialLife);t.mesh.material.opacity=n*.75,t.life<=0&&(Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Ss.splice(e,1))}},MT=i=>{if(!On()||Ir){vt.multiplyScalar(Math.max(0,1-i*10));return}Vn.set(0,0,0),de.getWorldDirection(Ys),Ys.y=0,Ys.normalize(),gl.crossVectors(Ys,de.up).normalize(),pt.KeyW&&Vn.add(Ys),pt.KeyS&&Vn.sub(Ys),pt.KeyA&&Vn.sub(gl),pt.KeyD&&Vn.add(gl);const e=Vn.lengthSq()>0;e&&(Vn.normalize().multiplyScalar(Eh),(pt.KeyA||pt.KeyD)&&!(pt.KeyW||pt.KeyS)&&Vn.multiplyScalar(lE));const n=1-Math.exp(-((e?aE:oE)*(Ht?cE:1))*i);if(vt.x+=((e?Vn.x:0)-vt.x)*n,vt.z+=((e?Vn.z:0)-vt.z)*n,Math.abs(vt.x)<1e-4&&(vt.x=0),Math.abs(vt.z)<1e-4&&(vt.z=0),vt.lengthSq()>0){const s=de.position.x+vt.x*i,r=de.position.z+vt.z*i,a=Om(s,r),o=Math.abs(a.x-de.position.x)>1e-4||Math.abs(a.z-de.position.z)>1e-4;Math.abs(a.x-s)>2e-4&&(vt.x=0),Math.abs(a.z-r)>2e-4&&(vt.z=0),de.position.x=a.x,de.position.z=a.z,de.position.y=Math.max(vn,de.position.y),o&&Ea()}},yT=i=>{!Ht&&de.position.y<=vn+.001&&Si<=0||(Si-=hE*i,de.position.y+=Si*i,de.position.y<=vn?(de.position.y=vn,Si=0,Ht&&(Ht=!1,Ea(!0))):Ht=!0,Ea())},ST=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<tr.length;n+=1){const s=tr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*2.2,s.mesh.position.y=s.baseY+Math.sin(t*2.4+s.phase)*.09,Math.random()<i*2.2&&(Er(s,9421823),Math.random()<.55&&Er(s,9421823)),!On()||(Fr(et)?Lt>=hn:ei>=Ia))continue;const r=de.position.x-s.mesh.position.x,a=de.position.z-s.mesh.position.z;r*r+a*a<=1.1*1.1&&mT(s,e)}},bT=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<nr.length;n+=1){const s=nr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.x+=i*1.3,s.mesh.rotation.y+=i*1.7,s.mesh.position.y=s.baseY+Math.sin(t*2+s.phase)*.1,Math.random()<i*2.4&&(Er(s,9435135),Math.random()<.6&&Er(s,9435135)),!On()||ai>=Pa)continue;const r=de.position.x-s.mesh.position.x,a=de.position.z-s.mesh.position.z;r*r+a*a<=1.1*1.1&&gT(s,e)}},ET=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<ir.length;n+=1){const s=ir[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*1.9,s.mesh.position.y=s.baseY+Math.sin(t*2.2+s.phase)*.11,Math.random()<i*2.8&&(Er(s,10878896),Math.random()<.7&&Er(s,10878896)),!On()||yt||Math.max(0,Et-(Vt+Kt))<=1e-4)continue;const a=de.position.x-s.mesh.position.x,o=de.position.z-s.mesh.position.z;a*a+o*o<=1.1*1.1&&_T(s,e)}},TT=i=>{if(!mh.visible)return;const e=.15+Math.sin(performance.now()*.0024)*.2;for(let t=0;t<Qo;t+=1){const n=t*3,s=t*3+1,r=t*3+2;Tn[s]-=Eu[t]*i,Tn[n]+=e*i*Eu[t]*.35,Tn[r]+=Math.sin(performance.now()*.0015+t)*.015,Tn[s]<.2&&(Tn[s]=Math.random()*120+25,Tn[n]=de.position.x+(Math.random()-.5)*220,Tn[r]=de.position.z+(Math.random()-.5)*220)}ph.attributes.position.needsUpdate=!0},AT=i=>{if(_h.visible){for(let e=0;e<ec;e+=1){const t=e*3,n=t+1,s=t+2;An[n]-=sm[e]*i,An[t]+=Math.sin(performance.now()*9e-4+e)*.02,An[s]+=Math.cos(performance.now()*7e-4+e)*.02,An[n]<.2&&(An[n]=Math.random()*120+25,An[t]=de.position.x+(Math.random()-.5)*180,An[s]=de.position.z+(Math.random()-.5)*180)}gh.attributes.position.needsUpdate=!0}},wT=i=>{ra=Math.max(0,ra-i*(tm==="night"?.35:.55));const t=performance.now()*.001,n=Vo.attributes.position.array;for(let r=0;r<tc;r+=1){const a=r*3;n[a+1]+=Math.sin(t*cm[r]+r)*.003,n[a]+=Math.cos(t*.7+r)*.0025,n[a+2]+=Math.sin(t*.5+r)*.0025}Vo.attributes.position.needsUpdate=!0;const s=ra*.95;for(let r=0;r<Tu.length;r+=1){const a=Tu[r],o=(Math.sin(t*1.6+a.phase)+1)*.035;a.material.emissiveIntensity=a.base+o+s,a.material.color&&s>.08&&a.material.color.offsetHSL(Math.sin(t+a.phase)*3e-4,4e-4,3e-4)}},RT=i=>{const e=Math.min(1,i*8),t=performance.now(),n=WE()-FE;for(const s of H.remotePlayers.values()){const r=s.netSnapshots||[];if(r.length>0){const p=n-1e3;for(;r.length>2&&r[0].ts<p;)r.shift();let M=r[r.length-1];for(let S=1;S<r.length;S+=1){const y=r[S-1],T=r[S];if(n<y.ts||n>T.ts)continue;const w=Math.max(1,T.ts-y.ts),R=Math.max(0,Math.min(1,(n-y.ts)/w));M={x:y.x+(T.x-y.x)*R,y:y.y+(T.y-y.y)*R,z:y.z+(T.z-y.z)*R,yaw:y.yaw+((T.yaw-y.yaw+Math.PI*3)%(Math.PI*2)-Math.PI)*R,pitch:y.pitch+(T.pitch-y.pitch)*R,jumping:y.jumping||T.jumping,moving:y.moving||T.moving,ts:n};break}if(r.length>=2&&n>r[r.length-1].ts){const S=r[r.length-1],y=r[r.length-2],T=n-S.ts;if(T<=OE){const w=Math.max(1,S.ts-y.ts),R=T/w;M={x:S.x+(S.x-y.x)*R,y:S.y+(S.y-y.y)*R,z:S.z+(S.z-y.z)*R,yaw:S.yaw,pitch:S.pitch,jumping:S.jumping,moving:S.moving,ts:n}}else M=S}s.targetPosition.set(M.x,M.y,M.z),s.targetYaw=M.yaw,s.targetPitch=M.pitch,s.isJumping=!!M.jumping,M.moving&&(s.movingUntil=Math.max(Number(s.movingUntil||0),t+Tm))}const a=s.group.position.distanceTo(s.targetPosition);let o=e;a>BE?o=Math.max(o,Math.min(1,i*12)):a>zE&&(o=Math.max(o,Math.min(1,i*10)));const c=s.group.position.clone();a>kE?s.group.position.copy(s.targetPosition):s.group.position.lerp(s.targetPosition,o),s.group.rotation.y=Gf(s.group.rotation.y,s.targetYaw+Ch,o);const l=c.distanceTo(s.group.position),u=i>0?l/i:0,h=Math.min(1,i*10);s.smoothedMoveSpeed=hp.lerp(Number(s.smoothedMoveSpeed||0),u,h);const d=s.currentAnimation==="move"?s.smoothedMoveSpeed>HE:s.smoothedMoveSpeed>VE,g=t<Number(s.movingUntil||0)||d,_=s.isJumping||s.targetPosition.y>.08||s.group.position.y>.08,m=t-Number(s.lastAnimationAt||0)>=GE;if(s.head&&(s.head.rotation.x=Gf(s.head.rotation.x,s.targetPitch,o)),s.healthBar?.holder){s.healthBar.holder.quaternion.copy(Iu().quaternion);const p=s.group.position.distanceTo(Iu().position),M=p<=NE,S=Math.max(.74,Math.min(1.06,1.12-p/170));s.healthBar.holder.scale.setScalar(S),s.healthBar.holder.visible=!s.isDead&&M}s.mixer&&s.mixer.update(i),s.animationUntil>0&&t>=s.animationUntil&&(s.isDead&&(s.isDead=!1),_?(bi(s,"jump"),s.lastAnimationAt=t):g?(bi(s,"move"),s.lastAnimationAt=t):(Sa(s),s.lastAnimationAt=t),s.animationUntil=0),!s.isDead&&s.animationUntil<=0&&(_?s.currentAnimation!=="jump"&&(bi(s,"jump"),s.lastAnimationAt=t):g?s.currentAnimation!=="move"&&m&&(bi(s,"move"),s.lastAnimationAt=t):s.currentAnimation!=="idle"&&m&&(Sa(s),s.lastAnimationAt=t))}},CT=i=>{va.intensity=Math.max(0,va.intensity-20*i),ya=Math.max(0,ya-i*4.8),fr=Math.max(0,fr-i*xE),vT(i);for(let e=ys.length-1;e>=0;e-=1){const t=ys[e];t.userData.life-=i,t.material.opacity=Math.max(0,t.userData.life*7.5),t.userData.life<=0&&(Ee.remove(t),t.material.dispose(),ys.splice(e,1))}for(let e=ur.length-1;e>=0;e-=1){const t=ur[e];t.userData.life-=i,t.scale.multiplyScalar(1+7*i),t.material.opacity=Math.max(0,t.userData.life*5),t.userData.life<=0&&(Ee.remove(t),t.material.dispose(),ur.splice(e,1))}for(let e=0;e<Ji.length;e+=1){const t=Ji[e];t.material.emissiveIntensity>.5&&(t.material.emissiveIntensity=Math.max(.5,t.material.emissiveIntensity-3*i))}},PT=i=>{for(let e=oa.length-1;e>=0;e-=1){const t=oa[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.max(0,t.radius*(1-n*t.radiusFalloff)),a=Math.cos(s)*r,o=Math.sin(s)*r,l=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(a)).add(t.up.clone().multiplyScalar(o));t.pos.copy(l),t.mesh.position.copy(l),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.02)*.24),t.trailTimer+=i;const u=t.source==="remote"?.028:.012;if(t.trailTimer>=u){t.trailTimer=0;const d=Jt(l,Math.random()>.5?16773830:10154239);d&&(d.scale.setScalar(1.35+Math.random()*.95),d.userData.life=.3+Math.random()*.18)}let h=null;if(t.source==="remote"){const d=lc(t.prevPos,t.pos);d&&(h=d.point,d.headshot)}if(h||(h=cc(t.prevPos,t.pos,.22)),h||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),oa.splice(e,1);const d=h?h.clone():t.end.clone();h&&t.source==="remote"&&uc({},t.ownerId);const f=Jt(d,16775121);f&&(f.scale.setScalar(2.3),f.userData.life=.42);const g=Jt(d,12579839);g&&(g.scale.setScalar(1.7),g.userData.life=.36),Dn(d.clone().add(t.up.clone().multiplyScalar(1.05)),d.clone().add(t.up.clone().multiplyScalar(-1.05)),16773830,{radiusScale:2.2,life:.34,opacity:1}),Dn(d.clone().add(t.right.clone().multiplyScalar(.7)),d.clone().add(t.right.clone().multiplyScalar(-.7)),10154239,{radiusScale:1.9,life:.34,opacity:1})}}},IT=i=>{for(let e=ca.length-1;e>=0;e-=1){const t=ca[e];t.prevPos.copy(t.pos),t.velocity.y-=pE*i,t.pos.add(t.velocity.clone().multiplyScalar(i)),t.mesh.position.copy(t.pos);const n=t.pos.distanceTo(t.prevPos);t.traveledDistance+=n;const s=Math.max(0,Math.min(1,t.traveledDistance/Ru)),r=t.phase+s*t.spin;t.mesh.rotation.set(r*.9,r*1.1,r*.75),t.trailTimer+=i;const a=t.source==="remote"?.032:.018;if(t.trailTimer>=a){t.trailTimer=0;const c=Jt(t.pos,Math.random()>.5?16773830:10154239);c&&(c.scale.setScalar(1+Math.random()*.9),c.userData.life=.22+Math.random()*.16)}let o=null;if(t.pos.y<=.2&&(o=t.pos.clone(),o.y=.2),!o&&n>1e-4&&(o=cc(t.prevPos,t.pos,.4)),!o){if(t.source==="local")for(const c of H.remotePlayers.values()){if(!c?.group||c.isDead)continue;const l=new P(c.group.position.x,c.group.position.y+1.85,c.group.position.z),u=new P(c.group.position.x,c.group.position.y+1.1,c.group.position.z);if(o=Go(t.prevPos,t.pos,l,sc)||Go(t.prevPos,t.pos,u,rc),o)break}else if(t.source==="remote"){const c=lc(t.prevPos,t.pos);c&&(o=c.point,c.headshot)}}if(!o&&t.traveledDistance>=Of&&(o=null),(o||t.traveledDistance>=Of)&&(Ee.remove(t.mesh),t.mesh.traverse(c=>{c.isMesh&&(c.geometry.dispose(),c.material.dispose())}),ca.splice(e,1),o)){const c=o.clone();t.source==="remote"&&uc({},t.ownerId);const l=Jt(c,16773830),u=Jt(c,10154239);l&&(l.scale.setScalar(2.5),l.userData.life=.42),u&&(u.scale.setScalar(1.9),u.userData.life=.35),Dn(c.clone().add(t.up.clone().multiplyScalar(1.15)),c.clone().add(t.up.clone().multiplyScalar(-1.15)),16773830,{radiusScale:2.3,life:.34,opacity:1}),Dn(c.clone().add(t.right.clone().multiplyScalar(.8)),c.clone().add(t.right.clone().multiplyScalar(-.8)),10154239,{radiusScale:2,life:.34,opacity:1})}}},LT=i=>{for(let e=la.length-1;e>=0;e-=1){const t=la[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA*(1-n*.22),a=Math.sin(s*.5+Math.PI*.35)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(a));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.12+Math.sin(performance.now()*.02)*.28),t.trailTimer+=i;const l=t.source==="remote"?.016:.007;if(t.trailTimer>=l){t.trailTimer=0;const h=Math.random()>.5?6750067:10354554,d=Math.random()>.5?6160236:9437049,f=Jt(c,h),g=Jt(c.clone().add(t.right.clone().multiplyScalar((Math.random()-.5)*.12)),d);f&&(f.scale.setScalar(.72+Math.random()*.35),f.userData.life=.22+Math.random()*.08),g&&(g.scale.setScalar(.62+Math.random()*.28),g.userData.life=.18+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=lc(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=cc(t.prevPos,t.pos,.22)),u||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),la.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&uc({},t.ownerId);const d=Jt(h,5832550);d&&(d.scale.setScalar(2.45),d.userData.life=.45);const f=Jt(h,11075468);f&&(f.scale.setScalar(1.9),f.userData.life=.38),Dn(h.clone().add(t.up.clone().multiplyScalar(.95)),h.clone().add(t.up.clone().multiplyScalar(-.95)),7733092,{radiusScale:2,life:.28,opacity:1}),Dn(h.clone().add(t.right.clone().multiplyScalar(.75)),h.clone().add(t.right.clone().multiplyScalar(-.75)),12124053,{radiusScale:1.75,life:.28,opacity:.95})}}},DT=i=>{for(let e=ua.length-1;e>=0;e-=1){const t=ua[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA,a=Math.cos(s*.7+Math.PI*.3)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(a));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.03)*.18),t.trailTimer+=i;const l=t.source==="remote"?.012:.005;if(t.trailTimer>=l){t.trailTimer=0;const h=2.9+Math.random()*1.4,d=c.clone().add(t.dir.clone().multiplyScalar(-h)),f=Math.random()>.5?10148095:8309247;Dn(c,d,f,{radiusScale:1.8,life:.36,opacity:.92});const g=Jt(d,Math.random()>.5?12380671:8703999);g&&(g.scale.setScalar(.7+Math.random()*.3),g.userData.life=.22+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=lc(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=cc(t.prevPos,t.pos,.24)),u||n>=1){Ee.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),ua.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&uc({},t.ownerId);const d=Jt(h,15661567),f=Jt(h,9359871);d&&(d.scale.setScalar(2.2),d.userData.life=.4),f&&(f.scale.setScalar(2.8),f.userData.life=.46),Dn(h.clone().add(t.up.clone().multiplyScalar(1.35)),h.clone().add(t.up.clone().multiplyScalar(-1.35)),14677759,{radiusScale:2.35,life:.36,opacity:1}),Dn(h.clone().add(t.right.clone().multiplyScalar(1.05)),h.clone().add(t.right.clone().multiplyScalar(-1.05)),9097215,{radiusScale:2.15,life:.36,opacity:.98})}}},NT=i=>{const e=Fr(et);if(On()){if(e){const t=ti;Lt=Math.min(hn,Lt+ME*i),ti=Math.round(Lt),jn&&(jn=!1,hr=0),ti!==t&&Pt()}if(!e&&jn&&(hr-=i,hr<=0)){const t=ss-Pi,n=Math.min(t,ei);Pi+=n,ei-=n,jn=!1,Pt()}if(fl-=i,Ir){si=!1;return}bs&&si&&fl<=0&&!jn&&(pT(),fl=JE(),!e&&Pi<=0&&ei>0&&Nh())}},UT=()=>{if(!yt||!H.joinedRoom||!xa()){yt&&!xa()&&(yt=!1,Ui=0,Ln=ri,oi());return}const i=Math.max(0,Ui-performance.now()),e=Math.ceil(i/1e3);e!==Ln&&(Ln=e,oi()),i<=0&&rT()},FT=()=>{if(!br||!H.joinedRoom||H.joinedRoom.room.status!=="cooldown"){br&&vs();return}const i=Math.max(0,Ah-performance.now()),e=Math.ceil(i/1e3);e!==dr&&(dr=e,mu.textContent=String(dr)),i<=0&&(mu.textContent="0")},_l=()=>!H.joinedRoom&&Zi&&!Zi.classList.contains("hidden"),zm=()=>{requestAnimationFrame(zm);const i=Math.min(UE.getDelta(),.05);_b(),MT(i),yT(i),xT(i),oT(i),Um(),ST(i),bT(i),ET(i),TT(i),AT(i),wT(i),RT(i),PT(i),IT(i),LT(i),DT(i),NT(i),UT(),FT(),CT(i),iT(),sT(),wm(i),_l()&&qe.mixer&&qe.mixer.update(i),_l()&&qe.model&&(qe.model.rotation.y+=i*.45),_l()&&qe.renderer&&qe.scene&&qe.camera&&(pm(),qe.renderer.render(qe.scene,qe.camera)),mn.render(Ee,Iu()),Xn.drawCalls=mn.info.render.calls||0,Xn.triangles=mn.info.render.triangles||0,Xn.geometries=mn.info.memory.geometries||0,Xn.textures=mn.info.memory.textures||0,Xn.vfx=ys.length+ur.length+Ss.length+oa.length+ca.length+la.length+ua.length};window.addEventListener("resize",()=>{de.aspect=window.innerWidth/window.innerHeight,de.updateProjectionMatrix(),As.aspect=window.innerWidth/window.innerHeight,As.updateProjectionMatrix(),mn.setSize(window.innerWidth,window.innerHeight),qe.renderer&&qe.camera&&pm()});fb();Xb();Ca();zo(!1);sa("night");fm();oi();Pt();bu();hc();zm();Nm();Fb();
