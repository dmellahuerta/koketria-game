...
const LUNAR_STRIKE_AOE_RADIUS: f64 = 3.0;
const LUNAR_SPECIAL_MIN_FACTOR: f64 = 0.16;
const LUNAR_SPECIAL_MAX_FACTOR: f64 = 1.0;
const NEOORPHEN_STRIKE_AOE_RADIUS: f64 = 3.0;
...
const LUNAR_SPECIAL_MIN_RADIUS: f64 = 3.0;
const LUNAR_SPECIAL_MAX_RADIUS: f64 = 28.0;
const NEO_SPECIAL_MIN_RADIUS: f64 = 3.0;
