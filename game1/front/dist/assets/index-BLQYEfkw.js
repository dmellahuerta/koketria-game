...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ri,depthTest:!1,depthWrite:!1})}function kM(i,e,t){const n=new Float32Array(vs),s=new C(0,1,0);return new ci({name:"SphericalGaussianBlur",defines:{n:vs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:xc(),fragmentShader:`
	...
	`}class am extends ti{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new $p(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Qe(a,c),u=new _c(-1,1,1,-1,0,1);let h=null,d=null,f=!1,g,x=null,m=[],p=!1;this.setSize=function(M,E){r.setSize(M,E),o.setSize(M,E);for(let S=0;S<m.length;S++){const w=m[S];w.setSize&&w.setSize(M,E)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;const E=r.width,S=r.height;for(let w=0;w<m.length;w++){const A=m[w];A.setSize&&A.setSize(E,S)}},this.begin=function(M,E){if(f||M.toneMapping===ei&&m.length===0)return!1;if(x=E,E!==null){const S=E.width,w=E.height;(r.width!==S||r.height!==w)&&this.setSize(S,w)}return p===!1&&M.setRenderTarget(r),g=M.toneMapping,M.toneMapping=ei,!0},this.hasRenderPass=function(){return p},this.end=function(M,E){M.toneMapping=g,f=!0;let S=r,w=o;for(let A=0;A<m.length;A++){const R=m[A];if(R.enabled!==!1&&(R.render(M,w,S,E),R.needsSwap!==!1)){const _=S;S=w,w=_}}if(h!==M.outputColorSpace||d!==M.toneMapping){h=M.outputColorSpace,d=M.toneMapping,c.defines={},Ze.getTransfer(h)===rt&&(c.defines.SRGB_TRANSFER="");const A=YM[d];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=S.texture,M.setRenderTarget(x),M.render(l,u),x=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),c.dispose()}}const cm=new Ft,Du=new Io(1,1),lm=new Gp,um=new U0,hm=new $p,pf=[],mf=[],gf=new Float32Array(16),_f=new Float32Array(9),xf=new Float32Array(4);function Ur(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=pf[s];if(r===void 0&&(r=new Float32Array(s),pf[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Bt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function zt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function vc(i,e){let t=mf[e];t===void 0&&(t=new Int32Array(e),mf[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function $M(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function ZM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2fv(this.addr,e),zt(t,e)}}function JM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Bt(t,e))return;i.uniform3fv(this.addr,e),zt(t,e)}}function QM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4fv(this.addr,e),zt(t,e)}}function ey(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;xf.set(n),i.uniformMatrix2fv(this.addr,!1,xf),zt(t,n)}}function ty(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;_f.set(n),i.uniformMatrix3fv(this.addr,!1,_f),zt(t,n)}}function ny(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;gf.set(n),i.uniformMatrix4fv(this.addr,!1,gf),zt(t,n)}}function iy(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function sy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2iv(this.addr,e),zt(t,e)}}function ry(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3iv(this.addr,e),zt(t,e)}}function oy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4iv(this.addr,e),zt(t,e)}}function ay(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function cy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2uiv(this.addr,e),zt(t,e)}}function ly(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3uiv(this.addr,e),zt(t,e)}}function uy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4uiv(this.addr,e),zt(t,e)}}function hy(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Du.compareFunction=t.isReversedDepthBuffer()?gh:mh,r=Du):r=cm,t.setTexture2D(e||r,s)}function dy(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||um,s)}function fy(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||hm,s)}function py(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||lm,s)}function my(i){switch(i){case 5126:return $M;case 35664:return ZM;case 35665:return JM;case 35666:return QM;case 35674:return ey;case 35675:return ty;case 35676:return ny;case 5124:case 35670:return iy;case 35667:case 35671:return sy;case 35668:case 35672:return ry;case 35669:case 35673:return oy;case 5125:return ay;case 36294:return cy;case 36295:return ly;case 36296:return uy;case 35678:case 36198:case 36298:case 36306:case 35682:return hy;case 35679:case 36299:case 36307:return dy;case 35680:case 36300:case 36308:case 36293:return fy;case 36289:case 36303:case 36311:case 36292:return py}}function gy(i,e){i.uniform1fv(this.addr,e)}function _y(i,e){const t=Ur(e,this.size,2);i.uniform2fv(this.addr,t)}function xy(i,e){const t=Ur(e,this.size,3);i.uniform3fv(this.addr,t)}function vy(i,e){const t=Ur(e,this.size,4);i.uniform4fv(this.addr,t)}function My(i,e){const t=Ur(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function yy(i,e){const t=Ur(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Sy(i,e){const t=Ur(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function by(i,e){i.uniform1iv(this.addr,e)}function Ey(i,e){i.uniform2iv(this.addr,e)}function Ty(i,e){i.uniform3iv(this.addr,e)}function Ay(i,e){i.uniform4iv(this.addr,e)}function wy(i,e){i.uniform1uiv(this.addr,e)}function Ry(i,e){i.uniform2uiv(this.addr,e)}function Cy(i,e){i.uniform3uiv(this.addr,e)}function Py(i,e){i.uniform4uiv(this.addr,e)}function Iy(i,e,t){const n=this.cache,s=e.length,r=vc(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=Du:o=cm;for(let a=0;a!==s;++a)t.setTexture2D(e[a]||o,r[a])}function Ly(i,e,t){const n=this.cache,s=e.length,r=vc(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||um,r[o])}function Dy(i,e,t){const n=this.cache,s=e.length,r=vc(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||hm,r[o])}function Ny(i,e,t){const n=this.cache,s=e.length,r=vc(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||lm,r[o])}function Uy(i){switch(i){case 5126:return gy;case 35664:return _y;case 35665:return xy;case 35666:return vy;case 35674:return My;case 35675:return yy;case 35676:return Sy;case 5124:case 35670:return by;case 35667:case 35671:return Ey;case 35668:case 35672:return Ty;case 35669:case 35673:return Ay;case 5125:return wy;case 36294:return Ry;case 36295:return Cy;case 36296:return Py;case 35678:case 36198:case 36298:case 36306:case 35682:return Iy;case 35679:case 36299:case 36307:return Ly;case 35680:case 36300:case 36308:case 36293:return Dy;case 36289:case 36303:case 36311:case 36292:return Ny}}class Fy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=my(t.type)}}class Oy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Uy(t.type)}}class By{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const pl=/(\w+)(\])?(\[|\.)?/g;function vf(i,e){i.seq.push(e),i.map[e.id]=e}function zy(i,e,t){const n=i.name,s=n.length;for(pl.lastIndex=0;;){const r=pl.exec(n),o=pl.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){vf(t,l===void 0?new Fy(a,i,e):new Oy(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new By(a),vf(t,h)),t=h}}}class Xa{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=e.getActiveUniform(t,o),c=e.getUniformLocation(t,a.name);zy(a,c,this)}const s=[],r=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function Mf(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const ky=37297;let Vy=0;function Hy(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const yf=new Be;function Gy(i){Ze._getMatrix(yf,Ze.workingColorSpace,i);const e=`mat3( ${yf.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(i)){case tc:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return Ae("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Sf(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+Hy(i.getShaderSource(e),a)}else return r}function Wy(i,e){const t=Gy(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Xy={[Ep]:"Linear",[Tp]:"Reinhard",[Ap]:"Cineon",[wp]:"ACESFilmic",[Cp]:"AgX",[Pp]:"Neutral",[Rp]:"Custom"};function qy(i,e){const t=Xy[e];return t===void 0?(Ae("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ca=new C;function jy(){Ze.getLuminanceCoefficients(Ca);const i=Ca.x.toFixed(4),e=Ca.y.toFixed(4),t=Ca.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Yy(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(oo).join(`
`)}function Ky(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function $y(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function oo(i){return i!==""}function bf(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ef(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Zy=/^[ \t]*#include +<([\w\d./]+)>/gm;function Nu(i){return i.replace(Zy,Qy)}const Jy=new Map;function Qy(i,e){let t=Ve[e];if(t===void 0){const n=Jy.get(e);if(n!==void 0)t=Ve[n],Ae('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Nu(t)}const eS=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Tf(i){return i.replace(eS,tS)}function tS(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Af(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const nS={[za]:"SHADOWMAP_TYPE_PCF",[so]:"SHADOWMAP_TYPE_VSM"};function iS(i){return nS[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const sS={[Cs]:"ENVMAP_TYPE_CUBE",[xr]:"ENVMAP_TYPE_CUBE",[dc]:"ENVMAP_TYPE_CUBE_UV"};function rS(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":sS[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const oS={[xr]:"ENVMAP_MODE_REFRACTION"};function aS(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":oS[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const cS={[bp]:"ENVMAP_BLENDING_MULTIPLY",[Kg]:"ENVMAP_BLENDING_MIX",[$g]:"ENVMAP_BLENDING_ADD"};function lS(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":cS[i.combine]||"ENVMAP_BLENDING_NONE"}function uS(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function hS(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=iS(t),l=rS(t),u=aS(t),h=lS(t),d=uS(t),f=Yy(t),g=Ky(r),x=s.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`;const es=document.querySelector("#bootLoader"),Of=document.querySelector("#bootLoaderText"),Bf=document.querySelector("#bootLoaderFill"),zf=document.querySelector("#bootLoaderPercent"),Jn=document.querySelector("#lobby"),vl=document.querySelector("#connectionStatus"),Nh=document.querySelector("#playerName"),en=document.querySelector("#characterSelect"),tr=document.querySelector("#characterPreview"),Sb=document.querySelector("#refreshRoomsBtn"),bb=document.querySelector("#createVersusBtn"),Ml=document.querySelector("#roomList"),Pa=document.querySelector("#lobbyError"),mo=document.querySelector("#versusLobby"),Eb=document.querySelector("#versusRoomInfo"),oc=document.querySelector("#versusTypeSelect"),Tb=document.querySelector("#versusWaitingInfo"),Ab=document.querySelector("#versusLeftPlayers"),wb=document.querySelector("#versusRightPlayers"),gm=document.querySelector("#versusStartBtn"),Rb=document.querySelector("#versusLeaveBtn"),kf=document.querySelector("#matchInfo"),Vf=document.querySelector("#respawnScreen"),Cb=document.querySelector("#respawnCounter"),_m=document.querySelector("#winnerScreen"),Pb=document.querySelector("#winnerText"),Ou=document.querySelector("#winnerCounter"),yl=document.querySelector("#damageOverlay"),Ia=document.querySelector("#damageIndicator"),Hf=document.querySelector("#scoreboard"),Ib=document.querySelector("#scoreboardBody"),Lb=document.querySelector("#healthStat"),Db=document.querySelector("#shieldStat"),Nb=document.querySelector("#ammoStat"),Sl=document.querySelector("#specialStat"),Ub=document.querySelector("#healthSideLabel"),Fb=document.querySelector("#shieldSideLabel"),Ob=document.querySelector("#ammoSideLabel"),Qr=document.querySelector("#abilityHud"),Gf=document.querySelector("#abilityCooldownText"),Wf=document.querySelector("#abilityCooldownFill"),Bb=document.querySelector("#healthBarFill"),zb=document.querySelector("#shieldBarFill"),kb=document.querySelector("#ammoBarFill"),Vb=document.querySelector("#stats"),Xf=document.querySelector("#roomHud"),qf=document.querySelector("#stateHud"),jf=document.querySelector("#weatherHud"),Yf=document.querySelector("#playersHud"),Kf=document.querySelector("#perfPanel"),Hb=document.querySelector("#fpsValue"),Gb=document.querySelector("#latencyValue"),Wb=document.querySelector("#drawCallsValue"),Xb=document.querySelector("#trianglesValue"),qb=document.querySelector("#geometriesValue"),jb=document.querySelector("#texturesValue"),Yb=document.querySelector("#vfxValue"),bl=document.querySelector("#hostControls"),xm=document.querySelector("#startGameBtn"),vm=document.querySelector("#endGameBtn"),Kb=document.querySelector("#leaveRoomHudBtn"),Uh=document.querySelector("#chatFeed"),Mm=document.querySelector("#chatPanel"),La=document.querySelector("#chatLog"),ym=document.querySelector("#chatInputWrap"),ac=document.querySelector("#chatInput"),eo=document.querySelector("#crosshair"),Sm=document.querySelector("#optionsScreen"),Bu=document.querySelector("#optMouseSensitivity"),bm=document.querySelector("#optMouseSensitivityValue"),zu=document.querySelector("#optMasterVolume"),Em=document.querySelector("#optMasterVolumeValue"),ku=document.querySelector("#optMusicVolume"),Tm=document.querySelector("#optMusicVolumeValue"),Vu=document.querySelector("#optSfxVolume"),Am=document.querySelector("#optSfxVolumeValue"),Hu=document.querySelector("#optFov"),wm=document.querySelector("#optFovValue"),Gu=document.querySelector("#optShowPerf"),$b=document.querySelector("#optResumeBtn"),Zb=document.querySelector("#optLeaveLobbyBtn"),O={ws:null,self:null,rooms:[],joinedRoom:null,remotePlayers:new Map,lastStateSentAt:0,showMatchInfo:!1,showScoreboard:!1,showPerf:!1,fps:0,latencyMs:null},jn={drawCalls:0,triangles:0,geometries:0,textures:0,vfx:0},In=[],$f=40,Jb=8e3;let ss=!1,Fr=!1;const Rm="koketria_settings_v1",Pe={mouseSensitivity:1,masterVolume:1,musicVolume:1,sfxVolume:1,fov:75,showPerfByDefault:!1},El=["battle1","battle2","battle3"],Cm=()=>{pt.KeyW=!1,pt.KeyA=!1,pt.KeyS=!1,pt.KeyD=!1,pt.Space=!1},Fh=()=>{if(!La)return;const i=Date.now();for(let t=In.length-1;t>=0;t-=1)i-In[t].ts>Jb&&In.splice(t,1);Uh.classList.toggle("open",In.length>0);const e=In.slice(-8);La.innerHTML=e.map(t=>{const n=t.isSelf?" (Tú)":"";return`<p><strong>${t.playerName}${n}:</strong> ${t.text}</p>`}).join(""),La.scrollTop=La.scrollHeight},Qb=(i,e)=>{if(!e)return;const t=!!(O.self&&String(i||"")===String(O.self.name||""));In.push({playerName:String(i||"Player"),text:String(e||""),isSelf:t,ts:Date.now()}),In.length>$f&&In.splice(0,In.length-$f),Fh()};setInterval(()=>{In.length>0&&!ss&&Fh()},500);const eE=()=>{O.joinedRoom&&(ss=!0,Cm(),li=!1,Mm.classList.add("open"),ym.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),ac.value="",ac.focus())},Wu=()=>{ss=!1,Mm.classList.remove("open"),ym.classList.add("hidden"),ac.blur()},ys=(i="")=>{if(!i){Pa.classList.add("hidden"),Pa.textContent="";return}Pa.classList.remove("hidden"),Pa.textContent=i},Yn=(i,e,t,n)=>{const s=Number(i);return Number.isFinite(s)?Math.max(e,Math.min(t,s)):n},tE=()=>{try{const i=localStorage.getItem(Rm);if(!i)return;const e=JSON.parse(i);Pe.mouseSensitivity=Yn(e.mouseSensitivity,.4,2.5,Pe.mouseSensitivity),Pe.masterVolume=Yn(e.masterVolume,0,1,Pe.masterVolume),Pe.musicVolume=Yn(e.musicVolume,0,1,Pe.musicVolume),Pe.sfxVolume=Yn(e.sfxVolume,0,1,Pe.sfxVolume),Pe.fov=Yn(e.fov,60,100,Pe.fov),Pe.showPerfByDefault=!!e.showPerfByDefault}catch{}},Or=()=>{localStorage.setItem(Rm,JSON.stringify(Pe))},nE=i=>{const e=[...i];for(let t=e.length-1;t>0;t-=1){const n=Math.floor(Math.random()*(t+1)),s=e[t];e[t]=e[n],e[n]=s}return e},go=i=>{Mc.classList.toggle("in-room",i),Li(),!i&&document.pointerLockElement&&document.exitPointerLock(),i||(Tc(),In.length=0,Fh(),Wu(),Uh.classList.remove("open"))},Pm=()=>{O.showMatchInfo&&O.joinedRoom?kf.classList.add("visible"):kf.classList.remove("visible")},Oh=()=>{if(!O.joinedRoom||!O.showScoreboard){Hf.classList.add("hidden");return}const i=[...O.joinedRoom.players].sort((e,t)=>(t.kills||0)!==(e.kills||0)?(t.kills||0)-(e.kills||0):(e.deaths||0)-(t.deaths||0));Ib.innerHTML=i.map(e=>{const t=O.self&&e.id===O.self.id?" (Tú)":"";return`<tr><td>${e.name}${t}</td><td>${e.kills||0}</td><td>${e.deaths||0}</td></tr>`}).join(""),Hf.classList.remove("hidden")},Br=()=>{if(!O.joinedRoom||!O.showPerf){Kf.classList.add("hidden");return}Hb.textContent=String(O.fps),Gb.textContent=Number.isFinite(O.latencyMs)?`${Math.round(O.latencyMs)} ms`:"--",Wb.textContent=String(Math.round(jn.drawCalls)),Xb.textContent=String(Math.round(jn.triangles)),qb.textContent=String(Math.round(jn.geometries)),jb.textContent=String(Math.round(jn.textures)),Yb.textContent=String(Math.round(jn.vfx)),Kf.classList.remove("hidden")},Im=()=>!!(O.joinedRoom&&O.self&&O.joinedRoom.room.hostId===O.self.id),Sn=()=>!!(O.joinedRoom&&O.joinedRoom.room.status==="in_game"&&!St&&!Ar),Lo=()=>!!(O.joinedRoom&&O.joinedRoom.room.status==="in_game"),iE=i=>i==="rainy"?"Lluvioso":i==="sunny"?"Soleado":i==="night"?"Noche":i==="snow"?"Nieve":i||"-",_o=i=>{const e=i||"night";Dm=e,kh.visible=e==="rainy",Hh.visible=e==="snow",zm.visible=e==="night"||e==="snow",Vm.visible=!1,Gh.visible=!1,Wh.visible=!1,e==="sunny"?(_e.background=new Ce(12050431),_e.fog.color.set(12050431),_e.fog.near=90,_e.fog.far=400,co.intensity=.74,Wn.intensity=1.2,Wn.color.set(16773826),lo.opacity=.35):e==="rainy"?(_e.background=new Ce(599e4),_e.fog.color.set(599e4),_e.fog.near=10,_e.fog.far=95,co.intensity=.26,Wn.intensity=.42,Wn.color.set(9156567),lo.opacity=.25):e==="snow"?(_e.background=new Ce(14215668),_e.fog.color.set(14215668),_e.fog.near=26,_e.fog.far=200,co.intensity=.65,Wn.intensity=.9,Wn.color.set(15202047),lo.opacity=.42):(_e.background=new Ce(461588),_e.fog.color.set(461588),_e.fog.near=16,_e.fog.far=140,co.intensity=.26,Wn.intensity=.38,Wn.color.set(8354248),lo.opacity=.6)},yt=i=>{if(!O.ws||O.ws.readyState!==WebSocket.OPEN){ys("WebSocket no conectado");return}O.ws.send(JSON.stringify(i))};let Zf=0,Ei=null,Jf=0;const sE=2e3;let Tl=0,Qf=performance.now(),Ln=1;const Bh=(i=!1)=>{const e=performance.now();if(!O.showPerf||!O.joinedRoom||!O.ws||O.ws.readyState!==WebSocket.OPEN||Ei&&e-Ei.sentAt<5e3||!i&&e-Jf<sE)return;const t=`${Date.now()}-${Zf}`;Zf+=1,Ei={id:t,sentAt:e},Jf=e,yt({type:"ping",probeId:t,clientTs:Date.now(),rttMs:Number.isFinite(O.latencyMs)?Math.round(O.latencyMs):void 0})},rE=()=>{const i=performance.now();Tl+=1;const e=i-Qf;if(e>=500){O.fps=Math.max(0,Math.round(Tl*1e3/e));const t=O.fps;t>=58?Ln=1:t>=48?Ln=.82:t>=38?Ln=.62:t>=30?Ln=.48:Ln=.34,Tl=0,Qf=i,O.showPerf&&O.joinedRoom&&Br()}Bh()},Lm=i=>String(i?.mode||"").toLowerCase()==="versusmatch",yc=()=>!!(O.joinedRoom&&Lm(O.joinedRoom.room)&&O.joinedRoom.room.status==="waiting"),ao=()=>{const i=yc();mo&&mo.classList.toggle("hidden",!i),i&&Jn&&Jn.classList.add("hidden")},ep=(i,e,t)=>{if(!i)return;const n=Array.isArray(e)?e:[],s=Math.max(1,Number(t)||1),r=[];for(let o=0;o<s;o+=1){const a=n[o];if(a){const c=String(a.name||`Player ${o+1}`),l=No(a.character||"-");r.push(`<div class="versus-player"><strong>${c}</strong><span>${l}</span></div>`)}else r.push('<div class="versus-player empty"><strong>Esperando...</strong><span>Slot libre</span></div>')}i.innerHTML=r.join("")},xo=()=>{if(!mo)return;if(!yc()){mo.classList.add("hidden");return}const i=O.joinedRoom.room,e=Number(O.joinedRoom.players?.length||0),t=Number(i.requiredPlayers||0),n=Number(i.maxPlayers||4),s=String(i.versusType||""),r=Im(),o=s==="1v1"||s==="2v2",a=Array.isArray(O.joinedRoom.players)?[...O.joinedRoom.players]:[];a.sort((d,f)=>d.id===O.self?.id?-1:f.id===O.self?.id?1:String(d.name||"").localeCompare(String(f.name||"")));const c=o?s==="2v2"?2:1:Math.max(1,Math.ceil(n/2)),l=a.slice(0,c),u=a.slice(c,c*2),h=o&&t>0&&e===t;mo.classList.remove("hidden"),Eb.textContent=`Sala: ${i.name} (${i.id})`,oc.value=o?s:"",oc.disabled=!r,Tb.textContent=o?`Esperando: ${e}/${t} jugadores (${s})`:`Esperando selección de modalidad (${e}/${n})`,ep(Ab,l,c),ep(wb,u,c),gm.disabled=!r||!h},Xu=()=>{if(Ml.innerHTML="",O.rooms.length===0){const i=document.createElement("p");i.className="room-empty",i.textContent="No hay salas activas.",Ml.appendChild(i);return}O.rooms.forEach(i=>{const e=Lm(i)?"versusmatch":"freeforall",t=i.versusType?` (${i.versusType})`:"",n=Number(i.maxPlayers)>0?Number(i.maxPlayers):5,s=document.createElement("article");s.className="room-card",s.innerHTML=`
      <div>
    ...
    `,s.querySelector("button").addEventListener("click",()=>{ys(),yt({type:"join_room",roomId:i.id,playerName:Nh.value.trim(),character:en.value||Xe})}),Ml.appendChild(s)}),xo()},oE=()=>`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws`,aE=()=>`${window.location.protocol}//${window.location.host}`,_e=new Xp;_e.background=new Ce(66817);_e.fog=new Mh(66817,18,160);let Dm="night";const ue=new jt(75,window.innerWidth/window.innerHeight,.1,500);ue.position.set(0,1.7,10);const Ps=new jt(75,window.innerWidth/window.innerHeight,.1,500);let ur=!1;const cE=1.25,lE=.7,uE=.18,tp=new C,Da=new C,np=new C,ip=new C,Na=new C,mn=new dm({antialias:!0});mn.setSize(window.innerWidth,window.innerHeight);mn.setPixelRatio(Math.min(window.devicePixelRatio,2));Mc.appendChild(mn.domElement);const co=new P_(6750088,.3);_e.add(co);const Wn=new Ph(4849523,.8);Wn.position.set(15,30,10);_e.add(Wn);const Do=new sm(10026904,0,8,2);ue.add(Do);Do.position.set(.2,-.18,-.6);_e.add(ue);const Nm=new Qe(new is(320,320),new On({color:135426,roughness:1}));Nm.rotation.x=-Math.PI/2;_e.add(Nm);const Um=new Y_(320,80,4194150,1002015);Um.position.y=.01;_e.add(Um);const hE=new On({color:5984868,emissive:2762034,emissiveIntensity:.18,metalness:.06,roughness:.9});new On({color:8089476,emissive:2893110,emissiveIntensity:.14,metalness:.04,roughness:.92});new On({color:9401999,emissive:3417405,emissiveIntensity:.11,metalness:.04,roughness:.9});const ts=[],cc=[],ns=.55,dE=156;let sp=null;const Sc=5600,wn=new Float32Array(Sc*3),qu=new Float32Array(Sc);for(let i=0;i<Sc;i+=1)wn[i*3]=(Math.random()-.5)*260,wn[i*3+1]=Math.random()*120+6,wn[i*3+2]=(Math.random()-.5)*260,qu[i]=22+Math.random()*26;const zh=new Ct;zh.setAttribute("position",new Ot(wn,3));const fE=new Pr({color:6750054,size:.26,transparent:!0,opacity:.98,sizeAttenuation:!0}),kh=new Vo(zh,fE);_e.add(kh);const bc=1700,Rn=new Float32Array(bc*3),Fm=new Float32Array(bc);for(let i=0;i<bc;i+=1)Rn[i*3]=(Math.random()-.5)*260,Rn[i*3+1]=Math.random()*120+6,Rn[i*3+2]=(Math.random()-.5)*260,Fm[i]=1.6+Math.random()*2.7;const Vh=new Ct;Vh.setAttribute("position",new Ot(Rn,3));const pE=new Pr({color:16777215,size:.22,transparent:!0,opacity:.85,sizeAttenuation:!0}),Hh=new Vo(Vh,pE);_e.add(Hh);const Om=1200,qa=new Float32Array(Om*3);for(let i=0;i<Om;i+=1)qa[i*3]=(Math.random()-.5)*420,qa[i*3+1]=70+Math.random()*80,qa[i*3+2]=(Math.random()-.5)*420;const Bm=new Ct;Bm.setAttribute("position",new Ot(qa,3));const mE=new Pr({color:12572927,size:.36,transparent:!0,opacity:.78,sizeAttenuation:!0}),zm=new Vo(Bm,mE);_e.add(zm);const Ec=900,ja=new Float32Array(Ec*3),km=new Float32Array(Ec);for(let i=0;i<Ec;i+=1)ja[i*3]=(Math.random()-.5)*300,ja[i*3+1]=8+Math.random()*34,ja[i*3+2]=(Math.random()-.5)*300,km[i]=.4+Math.random()*.9;const lc=new Ct;lc.setAttribute("position",new Ot(ja,3));const lo=new Pr({color:16773311,size:.18,transparent:!0,opacity:.62,sizeAttenuation:!0,depthWrite:!1}),Vm=new Vo(lc,lo);_e.add(Vm);const Gh=new Qe(new pi(8.5,24,24),new Dt({color:15331839,transparent:!0,opacity:.9}));Gh.position.set(78,95,-124);_e.add(Gh);const Wh=new Qe(new pi(4.2,18,18),new Dt({color:16373920,transparent:!0,opacity:.74}));Wh.position.set(-104,76,-112);_e.add(Wh);const Al=[],ju=[];let vo=0;const gE=new C,Hm=new HS,Yu=new Map,an=[];let Xe="";const _E=["attack","dead","running","idle","jump","funny"],je={renderer:null,scene:null,camera:null,mixer:null,model:null,lastWidth:0,lastHeight:0},$e={group:null,mixer:null,actions:null,currentAnimation:"",shootUntil:0,loadingKey:"",funnyUntil:0},Go=i=>{const e=String(i||"").trim();return e?e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,"")==="pezunalunar"?"pezunalunar":e:""},xE=(i,e)=>`/characters/${encodeURIComponent(Go(i))}/${encodeURIComponent(e)}`,No=i=>Go(i)==="pezunalunar"?"pezuñalunar":i,vE=i=>/\.(glb|gltf)$/i.test(String(i||"").trim()),ME=i=>{const e=String(i||"").trim();if(!e)return[];const t=Go(e);return t===e?[e]:[t,e]},yE=i=>new Promise(e=>{const t=n=>{if(n>=i.length){e(null);return}Hm.load(i[n],s=>e(s),void 0,()=>t(n+1))};t(0)}),rp={mana:{url:"/items/mana.glb",targetHeight:.62},defensa:{url:"/items/defensa.glb",targetHeight:.7},vida:{url:"/items/vida.glb",targetHeight:.68}},to=new Map,Ua=new Map,SE=(i,e)=>{const t=new yn().setFromObject(i),n=t.getSize(new C);if(Number.isFinite(n.y)&&n.y>1e-4){const o=e/n.y;i.scale.setScalar(o),t.setFromObject(i)}const s=t.getCenter(new C),r=Number.isFinite(t.min.y)?t.min.y:0;return i.position.set(-s.x,-r,-s.z),i.traverse(o=>{o.isMesh&&(o.frustumCulled=!0)}),i},Ya=async i=>{const e=String(i||"").trim();if(!e||!rp[e])return null;if(to.has(e))return to.get(e);if(Ua.has(e))return Ua.get(e);const{url:t,targetHeight:n}=rp[e],s=new Promise(r=>{Hm.load(t,o=>{const a=o?.scene?o.scene.clone(!0):null;if(!a){to.set(e,null),r(null);return}const c=SE(a,n);to.set(e,c),r(c)},void 0,()=>{to.set(e,null),r(null)})}).finally(()=>{Ua.delete(e)});return Ua.set(e,s),s},wl=(i,e)=>{const t=new un,n=new un;t.add(n);const s=e();return s.name="__pickup_fallback__",n.add(s),Ya(i).then(r=>{if(!r||!t.parent)return;for(;n.children.length>0;)n.remove(n.children[0]);const o=r.clone(!0);o.name=`pickup_${i}`,n.add(o),t.userData.modelLoaded=!0}),t},Zs=(i,e)=>{if(!i?.animations||i.animations.length===0)return null;const t=i.animations[0].clone();return t.name=e,t},zr=async i=>{if(!i)return null;const e=Yu.get(i);if(e?.loaded)return e;if(e?.loadingPromise)return e.loadingPromise;const t=e||{loaded:!1,scene:null,animations:[],animationSet:{},loadingPromise:null};return Yu.set(i,t),t.loadingPromise=new Promise(n=>{const s=ME(i);if(s.length===0){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}Promise.all(_E.map(async r=>{const o=vE(r)?[r]:[r,`${r}.glb`,`${r}.gltf`],a=s.flatMap(l=>o.map(u=>xE(l,u))),c=await yE(a);return{actionName:r,gltf:c}})).then(r=>{const o=r.find(x=>x.actionName==="dead"&&x.gltf?.scene)?.gltf,a=r.find(x=>x.actionName==="idle"&&x.gltf?.scene)?.gltf,c=r.find(x=>x.actionName==="running"&&x.gltf?.scene)?.gltf,l=r.find(x=>x.actionName==="jump"&&x.gltf?.scene)?.gltf,u=r.find(x=>x.actionName==="funny"&&x.gltf?.scene)?.gltf,h=r.find(x=>x.actionName==="attack"&&x.gltf?.scene)?.gltf,d=a||c||l||u||o||h;if(!d?.scene){t.loaded=!1,t.scene=null,t.animations=[],t.animationSet={},t.loadingPromise=null,n(t);return}const f={attack:Zs(h,"attack"),dead:Zs(o,"dead"),running:Zs(c,"running"),idle:Zs(a,"idle"),jump:Zs(l,"jump"),funny:Zs(u,"funny")},g=Object.values(f).filter(Boolean);t.loaded=!0,t.scene=d.scene,t.animations=g,t.animationSet=f,t.loadingPromise=null,n(t)})}),t.loadingPromise},Gm=i=>{const e=en.value||Xe;if(en.innerHTML="",an.length=0,nE(i).forEach(n=>an.push(n)),an.length===0){const n=document.createElement("option");n.value="",n.textContent="Sin personajes",en.appendChild(n),en.disabled=!0,Xe="";return}en.disabled=!1,an.forEach(n=>{const s=document.createElement("option");s.value=n,s.textContent=No(n),en.appendChild(s)}),Xe=an.includes(e)?e:an[0],en.value=Xe},Rl=(i,e,t="")=>{const n=Math.max(1,e),s=Math.max(0,Math.min(1,i/n)),r=Math.round(s*100);Bf&&(Bf.style.width=`${r}%`),zf&&(zf.textContent=`${r}%`),Of&&t&&(Of.textContent=t)},Wm=async()=>{const i=aE();try{const t=await(await fetch(`${i}/characters`)).json();if(t?.ok&&Array.isArray(t.data)&&t.data.length>0)return t.data}catch{}return["silentman","pumori","neoorphen","pezunalunar"]},op=new Set,nr=(i,e=6e3)=>new Promise(t=>{if(!i){t(!1);return}if(op.has(i)){t(!0);return}const n=new Audio;let s=!1;const r=c=>{s||(s=!0,n.removeEventListener("canplaythrough",o),n.removeEventListener("loadedmetadata",o),n.removeEventListener("error",a),c&&op.add(i),t(c))},o=()=>r(!0),a=()=>r(!1);n.preload="auto",n.addEventListener("canplaythrough",o,{once:!0}),n.addEventListener("loadedmetadata",o,{once:!0}),n.addEventListener("error",a,{once:!0}),n.src=i,n.load(),setTimeout(()=>r(!1),e)}),bE=async i=>{const e=await qh(i);return await nr(e,6e3)?!0:nr(e,1e4)},EE=async()=>{es&&es.classList.remove("hidden"),Jn&&Jn.classList.add("hidden");const i=await Wm();Gm(i),Ac(Xe);const e=[...an],t=2+e.length*2+1+El.length+1+3+1;let n=0;const s=r=>{n+=1,Rl(n,t,r)};Rl(0,t,"Cargando tema pre-lobby..."),await nr(jm,1e4),s("Tema pre-lobby cargado"),Li(),Rl(n,t,"Preparando catalogo..."),Xm(),s("Catalogo listo");for(let r=0;r<e.length;r+=1){const o=e[r];await zr(o),s(`Modelo: ${No(o)}`)}for(let r=0;r<e.length;r+=1){const o=e[r];await bE(o),s(`Audio ataque: ${No(o)}`)}await nr(Ii,6e3),s("Audio base cargado");for(let r=0;r<El.length;r+=1){const o=El[r];await nr(Xh(o),1e4),s(`Tema batalla: ${o}`)}await nr(Ym,1e4),s("Audio lobby cargado"),await Ya("mana"),s("Item mana cargado"),await Ya("defensa"),s("Item defensa cargado"),await Ya("vida"),s("Item vida cargado"),await id(),kr();for(const r of O.remotePlayers.values())Bo(r);s("Lobby listo"),es&&es.classList.add("hidden"),Jn&&Jn.classList.remove("hidden"),Li()},TE=async()=>{const i=await Wm();Gm(i),Ac(Xe),await zr(Xe),await id(),kr();for(const e of O.remotePlayers.values())Bo(e)},kr=()=>{if(!je.scene)return;const i=en.value||Xe;if(!i)return;je.model&&(je.scene.remove(je.model),je.model=null,je.mixer=null);const e=Yu.get(i);if(!e?.loaded||!e.scene){zr(i).then(a=>{a?.loaded&&(en.value||Xe)===i&&kr()});return}const t=Dh(e.scene),n=new yn().setFromObject(t),s=n.getCenter(new C),r=n.getSize(new C);t.position.set(-s.x,-n.min.y,-s.z),je.scene.add(t),je.model=t,je.camera.position.set(0,Math.max(1.2,r.y*.55),Math.max(2.3,r.y*.95)),je.camera.lookAt(0,Math.max(.9,r.y*.45),0);const o=e.animationSet?.running||_s(e.animations||[],"running",["running"]);if(o){const a=new rm(t),c=a.clipAction(o);c.reset(),c.setLoop(fc,1/0),c.play(),je.mixer=a}},Xm=()=>{if(!tr||je.renderer)return;const i=new Xp,e=new jt(40,1,.1,100),t=new dm({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(window.devicePixelRatio,2));const n=tr.clientWidth||280,s=tr.clientHeight||220;t.setSize(n,s,!1),tr.appendChild(t.domElement);const r=new T_(12514815,1975838,.95);i.add(r);const o=new Ph(16777215,1);o.position.set(3.5,5,4),i.add(o),je.scene=i,je.camera=e,je.renderer=t,je.lastWidth=n,je.lastHeight=s,kr()},qm=()=>{if(!je.renderer||!je.camera)return;const i=tr.clientWidth||280,e=tr.clientHeight||220;i===je.lastWidth&&e===je.lastHeight||(je.lastWidth=i,je.lastHeight=e,je.camera.aspect=i/e,je.camera.updateProjectionMatrix(),je.renderer.setSize(i,e,!1))},pn=new Audio("/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3");pn.preload="auto";pn.loop=!1;pn.volume=.24;const no=[],AE=8,jm="/themes/pre-lobby.mp3",Ym="/themes/lobby.mp3",Ku={battle1:"/themes/battle1.mp3",battle2:"/themes/battle2.mp3",battle3:"/themes/battle3.mp3"},Xh=i=>Ku[i]||Ku.battle1,ii=new Audio(jm);ii.preload="auto";ii.loop=!1;ii.volume=.28;const rs=new Audio(Ym);rs.preload="auto";rs.loop=!0;rs.volume=.34;const Pi=new Audio(Xh("battle1"));Pi.preload="auto";Pi.loop=!0;Pi.volume=.38;let Uo=!1,Es=!1,Mo=!1,hr=!1,$i=!1,Cl="battle1";const Ii="/8d82b5_Doom_Chaingun_Firing_Sound_Effect.mp3",wE=[".ogg",".mp3",".wav",".m4a",""],Fa=new Map;let Pl="";const ap=140,Il=6,Zi=[],RE=24,CE=3e4,PE=15e3;let uc=0,uo=null;const IE=(i,e,t)=>{(i.getAttribute(t)||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute(t,e),i.load())},Km=()=>!O.joinedRoom&&es&&!es.classList.contains("hidden"),$m=()=>!O.joinedRoom&&Jn&&!Jn.classList.contains("hidden")&&(!es||es.classList.contains("hidden")),Zm=()=>!!(O.joinedRoom&&O.joinedRoom.room?.status==="in_game"),Ll=()=>{!Es&&ii.paused||(ii.pause(),ii.currentTime=0,Es=!1,$i=!1)},Oa=()=>{!Mo&&rs.paused||(rs.pause(),rs.currentTime=0,Mo=!1)},Dl=()=>{!hr&&Pi.paused||(Pi.pause(),Pi.currentTime=0,hr=!1)},LE=()=>{if(!Uo||Es||!Km())return;Es=!0;const i=ii.play();i&&typeof i.catch=="function"&&i.catch(()=>{Es=!1})},DE=()=>{if(!Uo||Mo||!$m())return;Mo=!0;const i=rs.play();i&&typeof i.catch=="function"&&i.catch(()=>{Mo=!1})},NE=()=>{if(!Uo||hr||!Zm())return;hr=!0;const i=Pi.play();i&&typeof i.catch=="function"&&i.catch(()=>{hr=!1})},Li=()=>{if(Zm()){$i=!1,Ll(),Oa(),NE();return}if(Km()){$i=!1,Dl(),Oa(),LE();return}if($m()){if(Dl(),Es&&!ii.ended){$i=!0,Oa();return}$i=!1,Ll(),DE();return}$i=!1,Dl(),Ll(),Oa()},Ka=i=>{const e=String(i||"").trim(),t=Ku[e]?e:"battle1";t!==Cl&&(Cl=t,IE(Pi,Xh(Cl),"data-bgm-src"),hr=!1,Li())},Wo=()=>{const i=Math.max(0,Math.min(1,Pe.masterVolume));pn.volume=.24*i*Pe.sfxVolume,ii.volume=.28*i*Pe.musicVolume,rs.volume=.34*i*Pe.musicVolume,Pi.volume=.38*i*Pe.musicVolume,ue.fov=Pe.fov,ue.updateProjectionMatrix(),Ps.fov=Pe.fov,Ps.updateProjectionMatrix(),O.showPerf=Pe.showPerfByDefault||O.showPerf,Br()},UE=()=>{Bu.value=String(Pe.mouseSensitivity),bm.textContent=Pe.mouseSensitivity.toFixed(2),zu.value=String(Pe.masterVolume),Em.textContent=`${Math.round(Pe.masterVolume*100)}%`,ku.value=String(Pe.musicVolume),Tm.textContent=`${Math.round(Pe.musicVolume*100)}%`,Vu.value=String(Pe.sfxVolume),Am.textContent=`${Math.round(Pe.sfxVolume*100)}%`,Hu.value=String(Math.round(Pe.fov)),wm.textContent=String(Math.round(Pe.fov)),Gu.checked=!!Pe.showPerfByDefault},Tc=()=>{Fr=!1,Sm.classList.add("hidden")},Jm=()=>{O.joinedRoom&&(Fr=!0,li=!1,Cm(),Sm.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock())},FE=()=>{Fr?Tc():Jm()},OE=i=>{const e=Go(i);return e?wE.map(t=>`/characters/${encodeURIComponent(e)}/attack_sound${t}`):[]},BE=i=>new Promise(e=>{const t=new Audio;let n=!1;const s=a=>{n||(n=!0,t.removeEventListener("canplaythrough",r),t.removeEventListener("loadedmetadata",r),t.removeEventListener("error",o),e(a))},r=()=>s(!0),o=()=>s(!1);t.preload="metadata",t.addEventListener("canplaythrough",r,{once:!0}),t.addEventListener("loadedmetadata",r,{once:!0}),t.addEventListener("error",o,{once:!0}),t.src=i,t.load(),setTimeout(()=>s(!1),900)}),qh=async i=>{const e=Go(i);if(!e)return Ii;if(Fa.has(e))return Fa.get(e);const t=OE(e);for(let n=0;n<t.length;n+=1){const s=t[n];if(await BE(s))return Fa.set(e,s),s}return Fa.set(e,Ii),Ii},Qm=(i,e)=>{(i.getAttribute("data-attack-src")||"")!==e&&(i.pause(),i.currentTime=0,i.src=e,i.setAttribute("data-attack-src",e),i.removeAttribute("data-fallback-applied"),i.load())},Ac=async i=>{const e=String(i||"").trim();if(e===Pl&&pn.getAttribute("data-attack-src"))return;Pl=e;const t=await qh(e);e===Pl&&Qm(pn,t)},jh=()=>{Uo||(Uo=!0,Li())};window.addEventListener("pointerdown",jh,{once:!0});window.addEventListener("keydown",jh,{once:!0});window.addEventListener("touchstart",jh,{once:!0,passive:!0});ii.addEventListener("ended",()=>{Es=!1,$i&&($i=!1,Li())});const zE=()=>{const i=pn.getAttribute("data-attack-src")||pn.src||Ii,e=new Audio(i);if(e.preload="auto",e.loop=!1,e.volume=pn.volume,no.length>=AE){const s=no.shift();s&&(s.pause(),s.currentTime=0)}no.push(e);const t=()=>{const s=no.indexOf(e);s>=0&&no.splice(s,1)};e.addEventListener("ended",t,{once:!0}),e.addEventListener("pause",t,{once:!0});const n=e.play();n&&typeof n.catch=="function"&&n.catch(()=>{t();const s=pn.getAttribute("data-fallback-applied")==="1";i!==Ii&&!s&&(pn.setAttribute("data-fallback-applied","1"),Qm(pn,Ii))})},kE=i=>{const e=i.distanceTo(ue.position);if(e>=ap)return 0;const n=1-(Math.max(Il,e)-Il)/(ap-Il);return .02+Math.pow(Math.max(0,n),1.6)*.2},cp=()=>{for(let i=0;i<Zi.length;i+=1){const e=Zi[i];e.pause(),e.currentTime=0}Zi.length=0},lp=async(i,e="")=>{const t=kE(i);if(t<=.02)return;let n=Ii;e&&(n=await qh(e));const s=new Audio(n||Ii);if(s.preload="auto",s.loop=!1,s.volume=t*Pe.masterVolume*Pe.sfxVolume,Zi.length>=RE){const a=Zi.shift();a&&(a.pause(),a.currentTime=0)}Zi.push(s);const r=()=>{const a=Zi.indexOf(s);a>=0&&Zi.splice(a,1)};s.addEventListener("ended",r,{once:!0}),s.addEventListener("pause",r,{once:!0});const o=s.play();o&&typeof o.catch=="function"&&o.catch(()=>{r()})},dr=new q_;new qe(0,0);const VE=new mc(.028,.028,1,10,1,!0),HE=new Dt({color:10682286,transparent:!0,opacity:1,blending:Fi,depthWrite:!1}),GE=new pi(.11,8,8),WE=new Dt({color:8257426,transparent:!0,opacity:.9}),Ts=[],fr=[],yo=[],So=[],bo=[],Eo=[],si=[],XE=24,qE=new pi(.045,6,6),As=[],jE=420,YE=680,KE=980,Nl=35,up=165,io=new C,hp=new C,$a=new C,Ss=new C,dp=new C,fp=new C,$E=new C(0,1,0),eg=i=>{const e=hc();if(!e||!i)return Ln;const t=i.x-e.position.x,n=i.y-e.position.y,s=i.z-e.position.z,r=Math.sqrt(t*t+n*n+s*s);if(r<=Nl)return Ln;if(r>=up)return Ln*.35;const o=(r-Nl)/(up-Nl);return Ln*(1-o*.65)},ZE=()=>Math.max(120,Math.round(jE*(.45+Ln*.55))),JE=()=>Math.max(180,Math.round(YE*(.4+Ln*.6))),pt={KeyW:!1,KeyA:!1,KeyS:!1,KeyD:!1,Space:!1};let ws=!1,Dn=0,Di=0;const Yh=9,QE=24,eT=18,tT=.45,nT=.92,vn=1.7,iT=6.8,sT=18;let li=!1,Ul=0;const rT=8,oT=1,$u=55,aT=19,pp=260,cT=.018,lT=.008,uT=1.2,hT=2.25,dT=1.2,ui=10,Tt=100,Xo=100,wc=0,os=30,qo=120,hn=100,mp=Math.ceil(hn/3),fT=12,pT=50,mT=6e4,gT=12,_T=20,xT=30,vT=6e4,MT=25,yT=20,ST=6e4,bT=Tt/3,ET=18,jo=.5,Yo=.92,TT=.18,AT=-.45,Fl=2.45,Zu=.9,gp=.09,wT=320;let Kh=0,Gt=Tt,hi=wc,Ni=os,ri=qo-os,Nt=hn,oi=Math.round(hn),Zt=0,Kn=!1,pr=0,Wt=!1,wi=0,St=!1,zi=0,Un=ui,Ar=!1,$h=0,mr=0,Ol=0,ir=0,Fo=0,gr=0,tg=0,ng=0,Zh=0,Jh=0,ig=0;const _p=new Fn(0,0,0,"YXZ"),Js=new C,Bl=new C,Hn=new C,vt=new C,xp=new C,RT=new j_,Qh=Math.PI,CT=170,PT=160,IT=4.8,LT=2.4,DT=9.5,NT=.55,UT=.32,FT=140,sg=220,OT=()=>Date.now(),BT=new pc(.2,.18,4,8),zT=new On({color:5082623,emissive:1719696,emissiveIntensity:.85,roughness:.35,metalness:.4}),sr=[],kT=new wh(.32,0),VT=new On({color:4584703,emissive:1006976,emissiveIntensity:.9,roughness:.25,metalness:.3}),rr=[],or=[],Ba=i=>{let e=Number(i)>>>0;return()=>{e+=1831565813;let t=Math.imul(e^e>>>15,1|e);return t^=t+Math.imul(t^t>>>7,61|t),((t^t>>>14)>>>0)/4294967296}},HT=i=>{const e=String(i||"");let t=2166136261;for(let n=0;n<e.length;n+=1)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0||1},GT=(i,e,t=0)=>!0,vp=(i,e,t=0)=>({x:i,z:e}),WT=()=>{for(let i=Al.length-1;i>=0;i-=1){const e=Al[i];e&&(_e.remove(e),e.traverse(t=>{t.isMesh&&(t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(s=>s.dispose()))}))}Al.length=0,ju.length=0},qn=i=>{vo=Math.min(1,vo+.5),i&&gE.copy(i)},rg=i=>{const e=Number(i);if(!Number.isFinite(e)||sp===e)return;sp=e;for(let o=ts.length-1;o>=0;o-=1){const a=ts[o];_e.remove(a),a.geometry.dispose(),a.material.dispose()}ts.length=0,cc.length=0,WT();for(let o=sr.length-1;o>=0;o-=1)_e.remove(sr[o].mesh);sr.length=0;for(let o=rr.length-1;o>=0;o-=1)_e.remove(rr[o].mesh);rr.length=0;for(let o=or.length-1;o>=0;o-=1)_e.remove(or[o].mesh);or.length=0;const t=Ba(e^2654435769);for(let o=0;o<220;o+=1){const a=1+t()*3,c=1+t()*3,l=3+t()*24,u=new Qe(new Ls(a,l,c),hE.clone());u.position.set((t()-.5)*220,l/2,(t()-.5)*220),u.userData.hp=1+Math.floor(t()*3),_e.add(u),ts.push(u),cc.push({minX:u.position.x-a/2,maxX:u.position.x+a/2,minZ:u.position.z-c/2,maxZ:u.position.z+c/2})}const n=Ba(e^2246822507);for(let o=0;o<pT;o+=1){const a=wl("mana",()=>new Qe(BT,zT.clone())),c=(n()-.5)*180,l=(n()-.5)*180,u=.35;a.position.set(c,u,l),_e.add(a),sr.push({mesh:a,baseY:u,phase:n()*Math.PI*2,active:!0,respawnAt:0})}const s=Ba(e^3266489909);for(let o=0;o<xT;o+=1){const a=wl("defensa",()=>new Qe(kT,VT.clone())),c=(s()-.5)*180,l=(s()-.5)*180,u=.6;a.position.set(c,u,l),_e.add(a),rr.push({mesh:a,baseY:u,phase:s()*Math.PI*2,active:!0,respawnAt:0})}const r=Ba(e^668265263);for(let o=0;o<yT;o+=1){const a=wl("vida",()=>new Qe(new Rh(.34,0),new On({color:9502623,emissive:2985794,emissiveIntensity:.8,roughness:.32,metalness:.25}))),c=(r()-.5)*180,l=(r()-.5)*180,u=.55;a.position.set(c,u,l),_e.add(a),or.push({mesh:a,baseY:u,phase:r()*Math.PI*2,active:!0,respawnAt:0})}},Rc=i=>String(i||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]/g,""),Vr=i=>{const e=Rc(i);return e==="silentman"||e==="silenmant"},Ko=i=>Rc(i)==="pumori",$o=i=>Rc(i)==="neoorphen",Zo=i=>{const e=Rc(i);return e==="pezunalunar"||e==="pezuanalunar"},og=i=>Vr(i)||$o(i)||Zo(i)||Ko(i),Hr=i=>Vr(i)||Ko(i)||$o(i)||Zo(i),XT=()=>Hr(Xe)?oT:1/rT,ag=()=>Math.max(0,uc-performance.now()),cg=i=>{const e=Number(i);if(!Number.isFinite(e)||e<=0){uc=0;return}uc=performance.now()+e},ed=(i=!1)=>{if(!Sl)return;const e=!!O.joinedRoom;if(!og(Xe)){(i||uo!==-1)&&(Sl.textContent="Especial R: -",uo=-1),Qr&&Qr.classList.add("hidden");return}const t=ag(),n=t>0?Math.ceil(t/1e3):0;if(!(!i&&uo===n)&&(uo=n,Sl.textContent=n>0?`Especial R: ${n}s`:"Especial R: LISTO",Qr&&(e?Qr.classList.remove("hidden"):Qr.classList.add("hidden")),Gf&&(Gf.textContent=n>0?`${n}s`:"LISTO"),Wf)){const s=Vr(Xe)?PE:CE,r=Math.max(0,Math.min(1,t/s));Wf.style.width=`${Math.round((1-r)*100)}%`}};rg(1);const Lt=()=>{const i=Hr(Xe),e=i?Math.round(Nt):Ni,t=i?hn:ri,n=i?"Mana":"Balas",s=Math.round(Gt),r=Math.round(hi);if(Lb.textContent=`Vida: ${s}`,Db.textContent=`Escudo: ${r}`,Nb.textContent=`${n}: ${e} / ${t}${!i&&Kn?" (recargando...)":""}`,ed(!0),Vb.textContent=`Kills: ${Kh}`,Ub.textContent=`${s}`,Fb.textContent=`${r}`,Ob.textContent=`${e} / ${t}`,Bb.style.width=`${Math.max(0,Math.min(100,Gt/Tt*100))}%`,zb.style.width=`${Math.max(0,Math.min(100,hi/Xo*100))}%`,kb.style.height=`${Math.max(0,Math.min(100,e/t*100))}%`,!O.joinedRoom){Xf.textContent="Sala: -",qf.textContent="Estado: waiting",jf.textContent="Clima: -",Yf.textContent="Jugadores: -",bl.classList.add("hidden");return}const o=O.joinedRoom.room,a=O.joinedRoom.players.map(c=>c.name).join(", ");if(Xf.textContent=`Sala: ${o.name} (${o.id})`,qf.textContent=`Estado: ${o.status}`,jf.textContent=`Clima: ${iE(o.weather)}`,Yf.textContent=`Jugadores: ${a||"-"}`,Im()){bl.classList.remove("hidden");const c=Number(O.joinedRoom.players?.length||0),l=String(o.mode||"freeforall").toLowerCase(),u=Number(o.requiredPlayers||0),h=l!=="versusmatch"||u>0&&c===u;xm.disabled=o.status==="in_game"||!h,vm.disabled=o.status!=="in_game"}else bl.classList.add("hidden");Pm(),Oh(),Br(),lg()},di=()=>{if(!St||!O.joinedRoom||!Lo()){Vf.classList.add("hidden");return}Cb.textContent=String(Un),Vf.classList.remove("hidden")},bs=()=>{Ar=!1,$h=0,mr=0,_m.classList.add("hidden")},qT=(i,e)=>{const t=String(i?.name||"Desconocido"),n=String(i?.character||"Sin personaje"),s=Math.max(1,Number(e)||10);Ar=!0,$h=performance.now()+s*1e3,mr=s,Pb.textContent=`Ganador: ${t} (${n})`,Ou.textContent=String(mr),_m.classList.remove("hidden"),document.pointerLockElement&&document.exitPointerLock(),li=!1,St&&(St=!1,zi=0,Un=ui,di())},lg=(i=0)=>{if(!yl)return;const e=!!(O.joinedRoom&&O.joinedRoom.room.status==="in_game"),n=1-Math.max(0,Math.min(1,Gt/Tt));let s=e&&!St?n*.62:0;e||(ir=0);const r=i>0?Math.min(1,i*4.8):1;Ol+=(s-Ol)*r,ir=Math.max(0,ir-(i>0?i*1.7:0));const o=e&&!St?(Math.sin(performance.now()*.01)+1)*.5*n*.22:0,a=Math.max(0,Math.min(.92,Ol+o+ir));yl.style.opacity=a.toFixed(3),yl.style.setProperty("--bleed-inner",`${20+n*24}%`)},jT=(i=!1)=>{const e=performance.now();tg=e+140,i&&(ng=e+220)},YT=()=>{Zh=performance.now()+320},KT=i=>{if(!i||!O.remotePlayers.has(i))return;const e=O.remotePlayers.get(i);if(!e?.group)return;const t=e.group.position.x-ue.position.x,n=e.group.position.z-ue.position.z;ig=(Math.atan2(t,-n)-Dn)*180/Math.PI,Jh=performance.now()+520},$T=()=>{if(!eo)return;const i=performance.now(),e=Math.sqrt(vt.x*vt.x+vt.z*vt.z),t=Math.min(1,e/Math.max(.001,Yh)),n=Wt?.85:0,s=5+t*7.5+n*6+Fo*10+gr*6.5;eo.style.setProperty("--crosshair-gap",`${s.toFixed(2)}px`),eo.classList.toggle("hit",i<=tg),eo.classList.toggle("headshot",i<=ng),eo.classList.toggle("kill",i<=Zh)},ZT=()=>{if(!Ia)return;if(!(performance.now()<=Jh)){Ia.classList.remove("visible");return}Ia.classList.add("visible"),Ia.style.setProperty("--damage-angle",`${ig.toFixed(1)}deg`)},Za=()=>{rA(),Gt=Tt,hi=wc,Ni=os,ri=qo-os,Nt=hn,oi=Math.round(hn),Zt=0,uc=0,uo=null,Kn=!1,pr=0,Wt=!1,wi=0,Kh=0,St=!1,Un=ui,zi=0,bs(),li=!1,Zh=0,Jh=0,di(),Lt()},td=()=>{Hr(Xe)||Kn||Ni>=os||ri<=0||!Sn()||(Kn=!0,pr=dT,Lt())},JT=()=>!Sn()||!og(Xe)?!1:ag()>0?(ed(!0),!0):Zo(Xe)?(yt({type:"player_special_lunar_rain"}),!0):Vr(Xe)?(yt({type:"player_special_silent_cone"}),!0):$o(Xe)?(yt({type:"player_special_neoorphen_meteor"}),!0):(Ko(Xe)&&yt({type:"player_special_pumori_orbit"}),!0),QT=()=>{Gt=Tt,hi=wc,Ni=os,ri=qo-os,Nt=hn,oi=Math.round(hn),Zt=0,Kn=!1,pr=0,Wt=!1,wi=0,St=!1,Un=ui,zi=0,di(),yt({type:"player_respawn"}),Lt()},ug=()=>{Lo()&&(St=!0,li=!1,Wt=!1,wi=0,zi=performance.now()+ui*1e3,Un=ui,document.pointerLockElement&&document.exitPointerLock(),di())},Mp=(i,e,t)=>{const n=(e-i+Math.PI)%(Math.PI*2)-Math.PI;return i+n*t},_s=(i,e,t)=>{const n=i.find(s=>s.name===e);return n||i.find(s=>{const r=String(s.name||"").toLowerCase();return t.some(o=>r.includes(o))})},nd=i=>{const e=String(i||"").trim();if(!e)return an[0]||Xe||"silentman";if(an.includes(e))return e;const t=e.toLowerCase(),n=an.find(s=>No(s).toLowerCase()===t);return n||e},Qn=(i,e)=>{if(!i.actions)return;const t=i.actions[e]||i.actions.move||null;t&&i.currentAnimation!==e&&(Object.values(i.actions).forEach(n=>{!n||n===t||n.fadeOut(.12)}),e==="death"?(t.reset(),t.setLoop(fh,1),t.clampWhenFinished=!0,t.fadeIn(.08).play()):(t.reset(),t.setLoop(fc,1/0),t.clampWhenFinished=!1,t.fadeIn(.1).play()),i.currentAnimation=e)},Oo=i=>{i.actions&&Qn(i,"idle")},Ji=i=>{if(!$e.actions)return;const e=$e.actions[i]||$e.actions.move||null;e&&$e.currentAnimation!==i&&(Object.values($e.actions).forEach(t=>{!t||t===e||t.fadeOut(.1)}),i==="death"||i==="funny"?(e.reset(),e.setLoop(fh,1),e.clampWhenFinished=!0,e.fadeIn(.08).play()):(e.reset(),e.setLoop(fc,1/0),e.clampWhenFinished=!1,e.fadeIn(.08).play()),$e.currentAnimation=i)},Ja=()=>{$e.funnyUntil<=0||($e.funnyUntil=0,$e.currentAnimation==="funny"&&Ji("idle"))},hg=i=>{const e=new un,t=Dh(i.scene),n=new yn().setFromObject(t),s=Number.isFinite(n.min.y)?n.min.y:0;t.position.y-=s,e.add(t);const r=new rm(t),o=i.animations||[],a=i.animationSet?.idle||_s(o,"idle",["idle"]),c=i.animationSet?.running||_s(o,"running",["running"]),l=i.animationSet?.jump||_s(o,"jump",["jump"]),u=i.animationSet?.funny||_s(o,"funny",["funny"]),h=i.animationSet?.attack||_s(o,"attack",["attack"]),d=i.animationSet?.dead||_s(o,"dead",["dead"]),f={idle:a?r.clipAction(a):null,move:c?r.clipAction(c):null,jump:l?r.clipAction(l):null,funny:u?r.clipAction(u):null,shoot:h?r.clipAction(h):null,death:d?r.clipAction(d):null};return _e.add(e),{group:e,avatarRoot:t,mixer:r,actions:f,body:null,head:null}},eA=()=>{$e.group&&_e.remove($e.group),$e.group=null,$e.mixer=null,$e.actions=null,$e.currentAnimation="",$e.funnyUntil=0},id=async()=>{const i=en.value||Xe;if(!i)return;const e=`${i}`;$e.loadingKey=e;const t=await zr(i);if(!t?.loaded||$e.loadingKey!==e)return;eA();const n=hg(t);$e.group=n.group,$e.mixer=n.mixer,$e.actions=n.actions,$e.currentAnimation="",$e.shootUntil=0,$e.funnyUntil=0,Ji("idle")},tA=i=>{if(!$e.group)return;const e=!!(O.joinedRoom&&ur&&!St);if($e.group.visible=e,!e)return;$e.group.position.set(ue.position.x,ue.position.y-vn,ue.position.z),$e.group.rotation.y=Dn+Qh;const t=performance.now(),n=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD;$e.funnyUntil>t?Ji("funny"):Wt?Ji("jump"):$e.shootUntil>t?Ji("shoot"):Ji(n?"move":"idle"),$e.mixer&&$e.mixer.update(i)},nA=i=>{const e=new un,t=new On({color:i?4835839:6815591,emissive:i?731702:1003290,emissiveIntensity:.6,roughness:.6}),n=t.clone(),s=new Qe(new pc(.35,.9,4,8),t),r=new Qe(new pi(.22,12,12),n);return s.position.y=1.15,r.position.y=1.95,e.add(s),e.add(r),_e.add(e),{group:e,avatarRoot:e,body:s,head:r,mixer:null,actions:null}},Bo=async i=>{const e=nd(i.character);if(!e)return;const t=await zr(e);if(!t?.loaded||!O.remotePlayers.has(i.id))return;const n=O.remotePlayers.get(i.id);if(!n)return;n.character=e;const s=n.group.position.clone(),r=n.group.rotation.y;Cc(n);const o=hg(t);o.group.position.copy(s),o.group.rotation.y=r,n.group=o.group,n.avatarRoot=o.avatarRoot,n.body=o.body,n.head=o.head,n.mixer=o.mixer,n.actions=o.actions,n.currentAnimation=null,n.animationUntil=0,n.isDead=!1,n.isJumping=!1,n.deadAt=0;const a=_g();n.group.add(a.holder),n.healthBar=a,Rs(n),Oo(n)},Cc=i=>{i.healthBar&&(i.healthBar.holder?.parent&&i.healthBar.holder.parent.remove(i.healthBar.holder),i.healthBar.bg&&(i.healthBar.bg.geometry.dispose(),i.healthBar.bg.material.dispose()),i.healthBar.fill&&(i.healthBar.fill.geometry.dispose(),i.healthBar.fill.material.dispose()),i.healthBar.text&&(i.healthBar.text.geometry.dispose(),i.healthBar.text.material.dispose()),i.healthBar.textTexture&&i.healthBar.textTexture.dispose(),i.healthBar=null),_e.remove(i.group),i.body&&(i.body.geometry.dispose(),i.body.material.dispose()),i.head&&(i.head.geometry.dispose(),i.head.material.dispose())},iA=(i,e,t)=>{const n=nA(e),s=nd(t);O.remotePlayers.set(i,{id:i,name:"Player",character:s,group:n.group,avatarRoot:n.avatarRoot,body:n.body,head:n.head,mixer:n.mixer,actions:n.actions,currentAnimation:null,animationUntil:0,isDead:!1,health:Tt,isJumping:!1,deadAt:0,targetPosition:new C(0,0,0),targetYaw:0,targetPitch:0,netSnapshots:[],netInitialized:!1,smoothedMoveSpeed:0,movingUntil:0,lastAnimationAt:0,healthBar:null});const r=O.remotePlayers.get(i),o=_g();r.group.add(o.holder),r.healthBar=o,Rs(r),r.character||(r.character=an[0]||Xe||"silentman"),Bo(r)},Ju=i=>{if(O.self&&i.id===O.self.id)return;O.remotePlayers.has(i.id)||iA(i.id,O.joinedRoom?.room?.hostId===i.id,i.character);const e=O.remotePlayers.get(i.id);i.name&&(e.name=String(i.name));const n=typeof i.character=="string"&&i.character.length>0?nd(i.character):e.character;n!==e.character&&(e.character=n||e.character,Bo(e)),e.mixer||(e.character||(e.character=an[0]||Xe||"silentman"),e.character&&Bo(e));const s=i.state?.position||{x:0,y:vn,z:0},r=i.state?.rotation||{yaw:0,pitch:0},o=!!i.state?.moving,a=Number.isFinite(Number(i.ts))?Number(i.ts):Date.now();e.isJumping=!!i.state?.jumping,o&&(e.movingUntil=Math.max(Number(e.movingUntil||0),performance.now()+sg)),Number.isFinite(Number(i.health))&&(e.health=Math.max(0,Math.min(Tt,Math.round(Number(i.health)))),Rs(e)),typeof i.alive=="boolean"&&(!i.alive&&!e.isDead?(e.isDead=!0,e.deadAt=performance.now(),e.animationUntil=0,Qn(e,"death"),Rs(e)):i.alive&&e.isDead&&(e.isDead=!1,e.deadAt=0,e.animationUntil=0,Oo(e),Number.isFinite(Number(i.health))||(e.health=Tt),Rs(e)));const l={ts:a,x:s.x,y:s.y-vn,z:s.z,yaw:r.yaw,pitch:r.pitch,jumping:!!i.state?.jumping,moving:o};e.netSnapshots.push(l),e.netSnapshots.length>32&&e.netSnapshots.splice(0,e.netSnapshots.length-32),e.netInitialized||(e.group.position.set(l.x,l.y,l.z),e.targetPosition.set(l.x,l.y,l.z),e.group.rotation.y=l.yaw+Qh,e.targetYaw=l.yaw,e.targetPitch=l.pitch,e.smoothedMoveSpeed=0,e.netInitialized=!0)},sA=i=>{const e=new Set;i.players.forEach(t=>{O.self&&t.id===O.self.id||(e.add(t.id),Ju(t))});for(const[t,n]of O.remotePlayers.entries())e.has(t)||(Cc(n),O.remotePlayers.delete(t))},yp=()=>{for(const i of O.remotePlayers.values())Cc(i);O.remotePlayers.clear()},Mn=(i,e,t=10682286,n={})=>{Ss.subVectors(e,i);const s=Ss.length();if(s<=1e-4)return;const r=$a.copy(i).add(e).multiplyScalar(.5),o=eg(r);if(o<.999&&Math.random()>o)return;const a=Number.isFinite(n.radiusScale)?n.radiusScale:1,c=Number.isFinite(n.life)?n.life:.14,l=Number.isFinite(n.opacity)?n.opacity:1,u=HE.clone();u.color=new Ce(t),u.opacity=l;const h=new Qe(VE,u);if(h.position.copy(r),h.quaternion.setFromUnitVectors($E,Ss.multiplyScalar(1/s)),h.scale.set(a,s,a),h.userData.life=c,_e.add(h),Ts.push(h),Ts.length>ZE()){const d=Ts.shift();d&&(_e.remove(d),d.material.dispose())}},Qu=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let o=new C().crossVectors(r,new C(0,1,0));o.lengthSq()<1e-4?o=new C(1,0,0):o.normalize();const a=new C().crossVectors(o,r).normalize(),c=new Qe(new pi(.22,14,14),new Dt({color:10154239,transparent:!0,opacity:.96,blending:Fi,depthWrite:!1}));c.position.copy(i),_e.add(c),yo.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:o,up:a,distance:s,traveled:0,speed:85,phase:Math.random()*Math.PI*2,spin:Math.PI*15+Math.random()*Math.PI*6,radius:.72,radiusFalloff:.22,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},dg=(i=1,e=1)=>{const t=new un,n=new Qe(new Ls(.46*i,.26*i,.22*i),new Dt({color:16773830,transparent:!0,opacity:Math.max(.1,Math.min(1,.98*e)),blending:Fi,depthWrite:!1})),s=new Qe(new mc(.05*i,.05*i,.7*i,10),new Dt({color:10154239,transparent:!0,opacity:Math.max(.1,Math.min(1,.95*e)),blending:Fi,depthWrite:!1}));return s.rotation.z=Math.PI/2,t.add(n),t.add(s),t},fg=(i,e,t={})=>{const n=e.clone().sub(i);if(n.length()<=1e-4)return;const r=n.clone().normalize();let o=new C().crossVectors(r,new C(0,1,0));o.lengthSq()<1e-4?o=new C(1,0,0):o.normalize();const a=new C().crossVectors(o,r).normalize(),c=dg(1,1);c.position.copy(i),_e.add(c),So.push({mesh:c,prevPos:i.clone(),pos:i.clone(),velocity:r.clone().multiplyScalar(34).add(a.clone().multiplyScalar(7.2)),origin:i.clone(),right:o,up:a,traveledDistance:0,spin:(Math.random()>.5?1:-1)*(Math.PI*6.5+Math.random()),phase:Math.random()*Math.PI*2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},wr=i=>{const e=String(i||"");for(let t=si.length-1;t>=0;t-=1){const n=si[t];if(n.ownerId===e){for(let s=0;s<n.hammers.length;s+=1){const r=n.hammers[s],o=r?.mesh;o&&(r.disposed||(_e.remove(o),o.traverse(a=>{a.isMesh&&(a.geometry&&a.geometry.dispose(),a.material&&a.material.dispose())}),r.disposed=!0))}si.splice(t,1)}}},rA=()=>{for(let i=si.length-1;i>=0;i-=1)wr(si[i]?.ownerId)},pg=i=>{const e=String(i||"");if(!e)return null;if(O.self&&e===O.self.id)return ue.position.clone();const t=O.remotePlayers.get(e);return t?.group?t.group.position.clone():null},oA=(i,e)=>{const t=String(i||"");if(!t||(wr(t),!pg(t)))return;const s=performance.now(),r=[],o=Math.max(500,Number(e)||1e4);si.push({ownerId:t,hammers:r,createdAt:s,endAt:s+o,spawnIntervalMs:220,nextSpawnAt:s,spawnCount:0,maxOrbitRadius:22,maxActiveHammers:28,phase:Math.random()*Math.PI*2})},aA=(i,e=null)=>{if(!i?.mesh||i.disposed)return;const t=i.mesh;if(_e.remove(t),t.traverse(n=>{n.isMesh&&(n.geometry&&n.geometry.dispose(),n.material&&n.material.dispose())}),i.disposed=!0,t.visible=!1,e){const n=wt(e,16773830),s=wt(e,10154239);n&&(n.scale.setScalar(1.9),n.userData.life=.28),s&&(s.scale.setScalar(1.45),s.userData.life=.24)}},eh=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let o=new C().crossVectors(r,new C(0,1,0));o.lengthSq()<1e-4?o=new C(1,0,0):o.normalize();const a=new C().crossVectors(o,r).normalize(),c=new Qe(new pi(.3,16,16),new Dt({color:6029158,transparent:!0,opacity:.9,blending:Fi,depthWrite:!1}));c.position.copy(i),_e.add(c),bo.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:o,up:a,distance:s,traveled:0,speed:60,phase:Math.random()*Math.PI*2,spin:Math.PI*9+Math.random()*Math.PI*3,waveAmpA:1.05,waveAmpB:.42,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},th=(i,e,t={})=>{const n=e.clone().sub(i),s=n.length();if(s<=1e-4)return;const r=n.clone().normalize();let o=new C().crossVectors(r,new C(0,1,0));o.lengthSq()<1e-4?o=new C(1,0,0):o.normalize();const a=new C().crossVectors(o,r).normalize(),c=new Qe(new pi(.22,16,16),new Dt({color:15267839,transparent:!0,opacity:.96,blending:Fi,depthWrite:!1}));c.position.copy(i),_e.add(c),Eo.push({mesh:c,start:i.clone(),end:e.clone(),prevPos:i.clone(),pos:i.clone(),dir:r,right:o,up:a,distance:s,traveled:0,speed:80,phase:Math.random()*Math.PI*2,spin:Math.PI*10+Math.random()*Math.PI*4,waveAmpA:.4,waveAmpB:.2,trailTimer:0,source:t.source==="remote"?"remote":"local",ownerId:String(t.ownerId||"")})},wt=(i,e=8257426)=>{const t=eg(i);if(t<.999&&Math.random()>t||fr.length>=JE())return null;const n=new Qe(GE,WE.clone());return n.material.color=new Ce(e),n.position.copy(i),n.userData.life=.26,_e.add(n),fr.push(n),n},Rr=(i,e,t,n)=>{io.subVectors(e,i);const s=io.length();if(s<=1e-4)return null;io.multiplyScalar(1/s),hp.subVectors(t,i);const r=hp.dot(io);return r<0||r>s?null:($a.copy(io).multiplyScalar(r).add(i),$a.distanceToSquared(t)<=n*n?$a.clone():null)},Jo=(i,e,t=.2)=>{Ss.subVectors(e,i);const n=Ss.length();if(n<=1e-4)return null;Ss.multiplyScalar(1/n),dr.set(i,Ss),dr.far=n+t;const s=dr.intersectObjects(ts,!1);return s.length>0?s[0].point.clone():null},Qo=(i,e)=>{dp.set(ue.position.x,ue.position.y+TT,ue.position.z),fp.set(ue.position.x,ue.position.y+AT,ue.position.z);const t=Rr(i,e,dp,jo);if(t)return{point:t,headshot:!0};const n=Rr(i,e,fp,Yo);return n?{point:n,headshot:!1}:null},Pc=(i,e)=>{},cA=i=>{if(!O.self)return;const e=i.players.find(s=>s.id===O.self.id);if(!e)return;const t=e.state?.position,n=e.state?.rotation;t&&(ue.position.set(t.x,t.y,t.z),vg(),Wt=!!e.state?.jumping,!Wt&&ue.position.y<=vn+.001&&(wi=0)),n&&(Dn=n.yaw,Di=n.pitch,Ic()),Kh=Number.isFinite(e.kills)?e.kills:0,Number.isFinite(e.health)&&(Gt=Math.max(0,Math.min(Tt,Number(e.health)))),Number.isFinite(e.shield)&&(hi=Math.max(0,Math.min(Xo,Math.round(e.shield)))),Number.isFinite(e.mana)&&(Nt=Math.max(0,Math.min(hn,Math.round(e.mana))),oi=Math.round(Nt)),Number.isFinite(Number(e.pendingHealthRegen))&&(Zt=Math.max(0,Number(e.pendingHealthRegen))),Number.isFinite(Number(e.lunarRainCooldownMs))&&cg(Number(e.lunarRainCooldownMs)),sh(),e.alive===!1&&!St&&Lo()&&ug(),e.alive===!0&&St&&(St=!1,zi=0,Un=ui,di())},Sp=(i,e={})=>{const t=!O.joinedRoom;t&&Za(),O.joinedRoom=i;const n=Number.isFinite(i.room?.mapSeed)?i.room.mapSeed:HT(i.room?.id);rg(n),sA(i),_o(i.room?.weather),Ka(i.room?.battleTheme),(e.applyOwnState||t)&&cA(i),go(i.room.status==="in_game"),ao(),i.room.status!=="cooldown"&&bs(),xo(),Lt()},mg=()=>{const i=oE(),e=new WebSocket(i);O.ws=e,vl.textContent=`Conectando a ${i}`,e.addEventListener("open",()=>{vl.textContent="Conectado",ys(),yt({type:"list_rooms"})}),e.addEventListener("message",t=>{let n;try{n=JSON.parse(t.data)}catch{ys("Respuesta invalida del servidor");return}if(n.ok===!1&&n.error){ys(n.error.message||"Error del servidor");return}if(n.type==="connected"){O.self=n.data.player,Nh.value=O.self.name,O.self.character&&an.includes(O.self.character)&&(Xe=O.self.character,en.value=O.self.character),Ac(O.self.character||Xe),O.rooms=n.data.rooms||[],kr(),Xu(),ao();return}if(n.type==="rooms_list"){O.rooms=n.data||[],Xu();return}if(n.type==="room_joined"){Sp(n.data,{applyOwnState:!0});return}if(n.type==="room_state"){Sp(n.data);return}if(n.type==="left_room"){O.joinedRoom=null,O.showScoreboard=!1,Ei=null,O.latencyMs=null,yp(),go(!1),cp(),_o("night"),Ka("battle1"),Za(),bs(),Lt(),ao(),xo(),Li();return}if(n.type==="pong"){const s=String(n.data?.probeId||"");Ei&&s===Ei.id&&(O.latencyMs=performance.now()-Ei.sentAt,Ei=null,Br());return}if(n.type==="player_joined"){n.data?.player&&Ju(n.data.player);return}if(n.type==="player_left"){const s=n.data?.playerId;wr(s),s&&O.remotePlayers.has(s)&&(Cc(O.remotePlayers.get(s)),O.remotePlayers.delete(s));return}if(n.type==="player_move"){const{playerId:s,position:r,rotation:o,character:a,jumping:c,moving:l,ts:u}=n.data||{};if(!s||O.self&&s===O.self.id)return;Ju({id:s,ts:u,character:a,state:{position:r,rotation:o,jumping:c,moving:l}});return}if(n.type==="player_shoot"){const s=n.data;if(!s)return;const r=s.playerId?O.remotePlayers.get(s.playerId):null,o=s.character||r?.character||"",a=Vr(o),c=Ko(o),l=$o(o),u=Zo(o);if(s.playerId&&O.remotePlayers.has(s.playerId)){const m=O.remotePlayers.get(s.playerId);m.isDead||(Qn(m,"shoot"),m.animationUntil=performance.now()+420)}const h=new C(s.origin.x,s.origin.y,s.origin.z),d=new C(s.direction.x,s.direction.y,s.direction.z).normalize(),f=s.distance||100,x=h.clone().add(d.clone().multiplyScalar(f)).clone();a?(Qu(h,x,{source:"remote",ownerId:s.playerId}),qn(h)):c?(fg(h,x,{source:"remote",ownerId:s.playerId}),qn(h)):l?(eh(h,x,{source:"remote",ownerId:s.playerId}),qn(h)):u?(th(h,x,{source:"remote",ownerId:s.playerId}),qn(h)):(Mn(h,x,5885183),wt(x,5885183)),lp(h,o);return}if(n.type==="special_lunar_rain_wave"){const s=n.data||{},r=String(s.playerId||""),o=Array.isArray(s.strikes)?s.strikes:[];for(let a=0;a<o.length;a+=1){const c=o[a]||{},l=c.start||{},u=c.impact||{};if(!Number.isFinite(Number(l.x))||!Number.isFinite(Number(l.y))||!Number.isFinite(Number(l.z))||!Number.isFinite(Number(u.x))||!Number.isFinite(Number(u.y))||!Number.isFinite(Number(u.z)))continue;const h=new C(Number(l.x),Number(l.y),Number(l.z)),d=new C(Number(u.x),Number(u.y),Number(u.z));th(h,d,{source:"local",ownerId:r}),wt(d,Math.random()>.5?12380671:8703999)}return}if(n.type==="special_silent_cone"){const s=n.data||{},r=String(s.playerId||""),o=s.origin||{},a=Array.isArray(s.rays)?s.rays:[];if(!r||!Number.isFinite(Number(o.x))||!Number.isFinite(Number(o.y))||!Number.isFinite(Number(o.z)))return;const c=new C(Number(o.x),Number(o.y),Number(o.z)),l=O.remotePlayers.get(r),u=s.character||l?.character||"silentman";r!==O.self?.id&&l&&!l.isDead&&(Qn(l,"shoot"),l.animationUntil=performance.now()+420);const h=Math.max(1,Math.ceil(a.length/XE));for(let d=0;d<a.length;d+=h){const f=a[d]||{},g=f.direction||{},x=Number(f.distance||0);if(!Number.isFinite(Number(g.x))||!Number.isFinite(Number(g.y))||!Number.isFinite(Number(g.z))||!Number.isFinite(x)||x<=0)continue;const m=new C(Number(g.x),Number(g.y),Number(g.z)).normalize(),p=c.clone().add(m.multiplyScalar(x));Qu(c.clone(),p,{source:"local",ownerId:r})}qn(c),r!==O.self?.id&&lp(c,u);return}if(n.type==="special_neoorphen_meteor_wave"){const s=n.data||{},r=String(s.playerId||""),o=Array.isArray(s.strikes)?s.strikes:[];let a=null;for(let c=0;c<o.length;c+=1){const l=o[c]||{},u=l.start||{},h=l.impact||{};if(!Number.isFinite(Number(u.x))||!Number.isFinite(Number(u.y))||!Number.isFinite(Number(u.z))||!Number.isFinite(Number(h.x))||!Number.isFinite(Number(h.y))||!Number.isFinite(Number(h.z)))continue;const d=new C(Number(u.x),Number(u.y),Number(u.z)),f=new C(Number(h.x),Number(h.y),Number(h.z));a||(a=f.clone()),eh(d,f,{source:"local",ownerId:r}),Mn(d,f,6750067,{radiusScale:1.6,life:.52,opacity:.98});const g=wt(f,5832550),x=wt(f,10354554);g&&(g.scale.setScalar(2.6),g.userData.life=.48),x&&(x.scale.setScalar(2.1),x.userData.life=.42)}a&&qn(a);return}if(n.type==="special_pumori_orbit_start"){const s=String(n.data?.playerId||""),r=Number(n.data?.durationMs||1e4);if(!s)return;oA(s,r);return}if(n.type==="player_damage"){if(!O.self||!Sn())return;const s=Number(n.data?.health),r=Number(n.data?.shield),o=!!n.data?.headshot;Number.isFinite(s)&&(Gt=Math.max(0,Math.min(Tt,s))),Number.isFinite(r)&&(hi=Math.max(0,Math.min(Xo,Math.round(r)))),sh(),ir=Math.min(.45,ir+(o?.35:.2)),KT(n.data?.fromPlayerId),Lt();return}if(n.type==="hit_confirm"){jT(!!n.data?.headshot);return}if(n.type==="player_resources"){const s=Number(n.data?.mana),r=Number(n.data?.health),o=Number(n.data?.pendingHealthRegen),a=Number(n.data?.lunarRainCooldownMs);let c=!1;Number.isFinite(s)&&(Nt=Math.max(0,Math.min(hn,Math.round(s))),oi=Math.round(Nt),c=!0),Number.isFinite(r)&&(Gt=Math.max(0,Math.min(Tt,r)),c=!0),Number.isFinite(o)&&(Zt=Math.max(0,o)),Number.isFinite(a)&&cg(a),sh(),c&&Lt();return}if(n.type==="player_death"){const s=n.data?.playerId;if(!s)return;if(wr(s),O.self&&n.data?.killerId===O.self.id&&s!==O.self.id&&YT(),O.self&&s===O.self.id){Gt=0,Zt=0,Lt(),ug();return}if(!O.remotePlayers.has(s))return;const r=O.remotePlayers.get(s);r.isDead=!0,r.health=0,r.isJumping=!1,r.deadAt=performance.now(),Qn(r,"death"),r.animationUntil=0,Rs(r);return}if(n.type==="player_respawned"){const s=n.data?.playerId;if(!s)return;if(O.self&&s===O.self.id){const a=n.data?.position;a&&Number.isFinite(Number(a.x))&&Number.isFinite(Number(a.y))&&Number.isFinite(Number(a.z))&&(ue.position.set(Number(a.x),Number(a.y),Number(a.z)),vg()),Gt=Number.isFinite(n.data?.health)?Number(n.data.health):Tt,hi=Number.isFinite(n.data?.shield)?Math.round(n.data.shield):wc,Number.isFinite(n.data?.mana)&&(Nt=Math.round(n.data.mana),oi=Math.round(Nt)),Zt=0,St=!1,zi=0,Un=ui,di(),Lt();return}const r=O.remotePlayers.get(s);if(!r)return;r.isDead=!1,r.deadAt=0,r.health=Number.isFinite(Number(n.data?.health))?Math.max(0,Math.min(Tt,Math.round(Number(n.data.health)))):Tt,r.animationUntil=0,Oo(r);const o=n.data?.position;if(o&&Number.isFinite(Number(o.x))&&Number.isFinite(Number(o.y))&&Number.isFinite(Number(o.z))){const a=Number(o.x),c=Number(o.y)-vn,l=Number(o.z);r.group.position.set(a,c,l),r.targetPosition.set(a,c,l)}Rs(r);return}if(n.type==="chat_message"){const s=n.data||{},r=String(s.playerName||"Player"),o=String(s.text||"").trim();if(!o)return;Qb(r,o),Uh.classList.add("open");return}if(n.type==="player_funny"){const s=n.data?.playerId;if(!s||!O.remotePlayers.has(s))return;const r=O.remotePlayers.get(s);if(r.isDead)return;r.currentAnimation==="funny"&&(r.currentAnimation=""),Qn(r,"funny");const o=r.actions?.funny,a=Math.max(500,Math.round((o?.getClip()?.duration||1)*1e3));r.animationUntil=performance.now()+a;return}if(n.type==="game_state"){O.joinedRoom&&O.joinedRoom.room.id===n.data.roomId&&(O.joinedRoom.room.status=n.data.status,O.joinedRoom.room.hostId=n.data.hostId,n.data.mode&&(O.joinedRoom.room.mode=n.data.mode),Object.prototype.hasOwnProperty.call(n.data,"versusType")&&(O.joinedRoom.room.versusType=n.data.versusType),Number.isFinite(Number(n.data.requiredPlayers))&&(O.joinedRoom.room.requiredPlayers=Number(n.data.requiredPlayers)),Number.isFinite(Number(n.data.maxPlayers))&&(O.joinedRoom.room.maxPlayers=Number(n.data.maxPlayers)),n.data.weather&&(O.joinedRoom.room.weather=n.data.weather,_o(n.data.weather)),n.data.battleTheme&&(O.joinedRoom.room.battleTheme=n.data.battleTheme,Ka(n.data.battleTheme)),n.data.status!=="in_game"&&St&&(St=!1,zi=0,Un=ui,di()),n.data.status!=="cooldown"&&bs(),go(n.data.status==="in_game"),ao(),xo(),Lt(),Li());return}if(n.type==="match_winner"){if(!O.joinedRoom)return;qT(n.data?.winner,n.data?.countdownSeconds);return}if(n.type==="match_reset"){bs(),Za(),Lt();return}}),e.addEventListener("close",()=>{vl.textContent="Desconectado. Reintentando...",O.joinedRoom=null,O.showScoreboard=!1,Ei=null,O.latencyMs=null,yp(),go(!1),cp(),_o("night"),Ka("battle1"),Za(),bs(),Lt(),ao(),xo(),Li(),setTimeout(mg,1200)}),e.addEventListener("error",()=>{ys("No se pudo conectar al WebSocket")})};en.addEventListener("change",()=>{Xe=en.value||Xe,O.self&&(O.self.character=Xe),Ac(Xe),zr(Xe),id(),kr(),Lt()});Sb.addEventListener("click",()=>{yt({type:"list_rooms"}),TE()});bb.addEventListener("click",()=>{ys(),yt({type:"create_room",mode:"versusmatch",playerName:Nh.value.trim(),character:en.value||Xe})});oc.addEventListener("change",()=>{if(!yc())return;const i=oc.value;i&&yt({type:"room_set_versus_type",versusType:i})});gm.addEventListener("click",()=>{yc()&&yt({type:"start_game"})});Rb.addEventListener("click",()=>{yt({type:"leave_room"})});Kb.addEventListener("click",()=>{yt({type:"leave_room"})});xm.addEventListener("click",()=>{yt({type:"start_game"})});vm.addEventListener("click",()=>{yt({type:"end_game"})});$b.addEventListener("click",()=>{Tc()});Zb.addEventListener("click",()=>{Tc(),yt({type:"leave_room"})});Bu.addEventListener("input",()=>{Pe.mouseSensitivity=Yn(Bu.value,.4,2.5,Pe.mouseSensitivity),bm.textContent=Pe.mouseSensitivity.toFixed(2),Or()});zu.addEventListener("input",()=>{Pe.masterVolume=Yn(zu.value,0,1,Pe.masterVolume),Em.textContent=`${Math.round(Pe.masterVolume*100)}%`,Wo(),Or()});ku.addEventListener("input",()=>{Pe.musicVolume=Yn(ku.value,0,1,Pe.musicVolume),Tm.textContent=`${Math.round(Pe.musicVolume*100)}%`,Wo(),Or()});Vu.addEventListener("input",()=>{Pe.sfxVolume=Yn(Vu.value,0,1,Pe.sfxVolume),Am.textContent=`${Math.round(Pe.sfxVolume*100)}%`,Wo(),Or()});Hu.addEventListener("input",()=>{Pe.fov=Yn(Hu.value,60,100,Pe.fov),wm.textContent=String(Math.round(Pe.fov)),Wo(),Or()});Gu.addEventListener("change",()=>{Pe.showPerfByDefault=!!Gu.checked,!O.showPerf&&Pe.showPerfByDefault&&(O.showPerf=!0,Bh(!0)),Br(),Or()});const Ic=()=>{_p.set(Di,Dn,0),ue.quaternion.setFromEuler(_p)},gg=()=>{if(!ur)return;tp.copy(ue.position),ue.getWorldDirection(Na),Na.normalize();const i=tp.clone().add(Na.clone().multiplyScalar(18));np.set(-Math.sin(Dn),0,-Math.cos(Dn)).normalize(),ip.set(Math.cos(Dn),0,-Math.sin(Dn)).normalize(),Da.copy(ue.position).addScaledVector(Na,-.8).add(new C(0,cE,0)).addScaledVector(np,-4.6).addScaledVector(ip,lE),Da.y=Math.max(vn+.6,Da.y),Ps.position.lerp(Da,uE),Ps.lookAt(i)},hc=()=>ur?Ps:ue,lA=(i,e,t,n={})=>{let s=t,r=null;const o=new C,a=new C,c=new C,l=Number.isFinite(n.headRadius)?n.headRadius:jo,u=Number.isFinite(n.bodyRadius)?n.bodyRadius:Yo,h=(d,f)=>{a.copy(d).sub(i);const g=a.dot(e);g<0||g>s||(c.copy(e).multiplyScalar(g).add(i),c.distanceToSquared(d)<=f*f&&(s=g,r=c.clone()))};for(const d of O.remotePlayers.values())!d?.group||d.isDead||(o.set(d.group.position.x,d.group.position.y+1.85,d.group.position.z),h(o,l),o.set(d.group.position.x,d.group.position.y+1.1,d.group.position.z),h(o,u));return r?{point:r,distance:s}:null},_g=()=>{const i=new un,e=new Qe(new is(Zu,gp),new Dt({color:1776411,transparent:!0,opacity:.78,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));e.renderOrder=999,e.position.set(0,Fl,0),i.add(e);const t=new Qe(new is(Zu-.02,gp-.02),new Dt({color:5701485,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));t.renderOrder=1e3,t.position.set(0,Fl,.001),i.add(t);const n=document.createElement("canvas");n.width=256,n.height=64;const s=n.getContext("2d"),r=new s_(n);r.minFilter=At,r.magFilter=At,r.generateMipmaps=!1;const o=new Qe(new is(1.05,.18),new Dt({map:r,transparent:!0,opacity:.96,depthWrite:!1,depthTest:!1,side:cn,toneMapped:!1}));return o.renderOrder=1001,o.position.set(0,Fl+.16,.001),i.add(o),{holder:i,bg:e,fill:t,text:o,textCanvas:n,textCtx:s,textTexture:r,lastText:""}},Rs=i=>{if(!i?.healthBar?.fill)return;const e=Number.isFinite(Number(i.health))?Number(i.health):Tt,t=Math.max(0,Math.min(1,e/Tt));i.healthBar.fill.scale.x=Math.max(.001,t),i.healthBar.fill.position.x=(t-1)*(Zu-.02)*.5,t>.66?i.healthBar.fill.material.color.set(5701485):t>.33?i.healthBar.fill.material.color.set(16769898):i.healthBar.fill.material.color.set(16738151);const n=`${String(i.name||"Player")} ${Math.round(e)}`;if(i.healthBar.lastText!==n&&i.healthBar.textCtx){const s=i.healthBar.textCtx;s.clearRect(0,0,i.healthBar.textCanvas.width,i.healthBar.textCanvas.height),s.font="bold 24px Courier New, monospace",s.textAlign="center",s.textBaseline="middle",s.strokeStyle="rgba(0, 0, 0, 0.75)",s.lineWidth=6,s.strokeText(n,i.healthBar.textCanvas.width/2,32),s.fillStyle="#d8ffd8",s.fillText(n,i.healthBar.textCanvas.width/2,32),i.healthBar.textTexture.needsUpdate=!0,i.healthBar.lastText=n}i.healthBar.holder.visible=!i.isDead},zo=(i=!1)=>{if(!O.joinedRoom)return;const e=performance.now();if(!i&&e-O.lastStateSentAt<55)return;O.lastStateSentAt=e;const t=pt.KeyW||pt.KeyA||pt.KeyS||pt.KeyD||vt.lengthSq()>.5;yt({type:"player_move",position:{x:ue.position.x,y:ue.position.y,z:ue.position.z},rotation:{yaw:Dn,pitch:Di},jumping:Wt,moving:t})},nh=(i,e)=>{for(let t=0;t<cc.length;t+=1){const n=cc[t];if(i+ns>n.minX&&i-ns<n.maxX&&e+ns>n.minZ&&e-ns<n.maxZ)return!0}return!1},ih=(i,e)=>GT(i,e,ns+.05)?!nh(i,e):!1,uA=(i,e)=>{const t=vp(i,e,ns+.05);if(ih(t.x,t.z))return t;const n=14;for(let s=.6;s<=n;s+=.6)for(let o=0;o<24;o+=1){const a=o/24*Math.PI*2,c=vp(t.x+Math.cos(a)*s,t.z+Math.sin(a)*s,ns+.05);if(ih(c.x,c.z))return c}return t},xg=(i,e)=>{const t=ue.position.x,n=ue.position.z,s=dE-ns,r=Math.max(-s,Math.min(s,i)),o=Math.max(-s,Math.min(s,e));let a=t,c=n;return nh(r,n)||(a=r),nh(a,o)||(c=o),{x:a,z:c}},vg=()=>{if(!ih(ue.position.x,ue.position.z)){const e=uA(ue.position.x,ue.position.z);ue.position.x=e.x,ue.position.z=e.z}const i=xg(ue.position.x,ue.position.z);ue.position.x=i.x,ue.position.z=i.z,ue.position.y=Math.max(vn,ue.position.y)};mn.domElement.addEventListener("click",()=>{!ws&&O.joinedRoom&&mn.domElement.requestPointerLock()});document.addEventListener("pointerlockchange",()=>{ws=document.pointerLockElement===mn.domElement,Mc.classList.toggle("locked",ws),ws||(li=!1,O.joinedRoom&&!Fr&&!St&&!Ar&&!ss&&Jm())});document.addEventListener("mousemove",i=>{if(!ws||!Sn())return;const e=.0021*Pe.mouseSensitivity;Dn-=i.movementX*e,Di-=i.movementY*e,Di=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,Di)),Ic(),zo()});window.addEventListener("mousedown",i=>{i.button===0&&ws&&Sn()&&(Ja(),li=!0)});window.addEventListener("mouseup",i=>{i.button===0&&(li=!1)});window.addEventListener("keydown",i=>{if(i.code==="Escape"&&!ss){i.preventDefault(),FE();return}if(i.code==="Enter"){if(i.preventDefault(),!O.joinedRoom)return;if(!ss){eE();return}const e=ac.value.trim();e&&yt({type:"chat_message",text:e}),Wu();return}if(ss){i.code==="Escape"&&(i.preventDefault(),Wu());return}if(i.code==="Tab"&&(i.preventDefault(),O.joinedRoom&&(O.showScoreboard=!0,Oh())),i.code==="KeyI"&&(O.showMatchInfo=!O.showMatchInfo,Pm()),i.code==="KeyP"&&(O.showPerf=!O.showPerf,O.showPerf&&Bh(!0),Br()),i.code==="KeyF"){if(i.preventDefault(),O.joinedRoom&&$e.actions?.funny){const e=$e.actions.funny.getClip(),t=Math.max(500,Math.round((e?.duration||1)*1e3));$e.funnyUntil=performance.now()+t,Ji("funny"),yt({type:"player_funny"})}return}i.code==="KeyC"&&(ur=!ur,ur&&gg()),i.code==="Space"&&(i.preventDefault(),Ja(),Sn()&&!Wt&&ue.position.y<=vn+.001&&(Wt=!0,wi=iT,zo(!0))),i.code==="KeyR"&&(Ja(),JT()||td()),i.code in pt&&((i.code==="KeyW"||i.code==="KeyA"||i.code==="KeyS"||i.code==="KeyD")&&Ja(),pt[i.code]=!0)});window.addEventListener("keyup",i=>{ss||(i.code==="Space"&&i.preventDefault(),i.code==="Tab"&&(O.showScoreboard=!1,Oh()),i.code in pt&&(pt[i.code]=!1))});const hA=()=>{const i=Vr(Xe),e=Ko(Xe),t=$o(Xe),n=Zo(Xe),s=i||e||t||n;if(s&&Nt<mp)return;if(!s&&Ni<=0){td();return}s?(Nt=Math.max(0,Nt-mp),oi=Math.round(Nt)):Ni-=1,zE(),$e.shootUntil=performance.now()+420,Lt(),ue.getWorldDirection(xp);const r=xp.clone().normalize(),o=ue.position.clone().add(r.clone().multiplyScalar(.55)),a=Math.sqrt(vt.x*vt.x+vt.z*vt.z),c=Math.min(1,a/Math.max(.001,Yh)),l=!s,u=l?(.0018+c*.0032+(Wt?.0055:0)+gr*.0048)*(1/Pe.mouseSensitivity):0,h=r.clone();if(u>0){const x=new C().crossVectors(h,ue.up).normalize(),m=new C().crossVectors(x,h).normalize(),p=(Math.random()*2-1)*u,M=(Math.random()*2-1)*u;h.add(x.multiplyScalar(p)).add(m.multiplyScalar(M)).normalize()}dr.set(o,h),dr.far=220;const d=dr.intersectObjects(ts,!1);let f=d.length>0?d[0].point:o.clone().add(h.clone().multiplyScalar(120));if(s||e||t){const x=lA(o,h,o.distanceTo(f),{headRadius:jo,bodyRadius:Yo});x?.point&&f.copy(x.point)}e&&o.distanceTo(f)>$u&&(f=o.clone().add(h.clone().multiplyScalar($u)));const g=o.distanceTo(f);if(i?(Qu(o,f,{source:"local",ownerId:O.self?.id}),qn(o)):e?(fg(o,f,{source:"local",ownerId:O.self?.id}),qn(o)):t?(eh(o,f,{source:"local",ownerId:O.self?.id}),qn(o)):n?(th(o,f,{source:"local",ownerId:O.self?.id}),qn(o)):(Mn(o,f),wt(f)),yt({type:"player_shoot",origin:{x:o.x,y:o.y,z:o.z},direction:{x:h.x,y:h.y,z:h.z},distance:g}),Do.intensity=2.3,Fo=Math.min(1.3,Fo+.52+c*.14+(Wt?.18:0)),gr=Math.min(uT,gr+(l?.22+c*.18+(Wt?.24:0):.08)),Di+=(Math.random()*.5+.5)*cT,Dn+=(Math.random()-.5)*lT,Di=Math.min(Di,Math.PI/2-.01),Ic(),d.length>0){const x=d[0].object;x.material.emissiveIntensity=1.3}},dA=(i,e)=>{i.active=!1,i.respawnAt=e+mT,i.mesh.visible=!1,Hr(Xe)?(Nt=Math.min(hn,Nt+_T),oi=Math.round(Nt)):ri=Math.min(qo,ri+gT),Lt()},fA=(i,e)=>{i.active=!1,i.respawnAt=e+vT,i.mesh.visible=!1,hi=Math.min(Xo,hi+MT),Lt()},pA=(i,e)=>{i.active=!1,i.respawnAt=e+ST,i.mesh.visible=!1;const t=Math.max(0,Tt-(Gt+Zt)),n=Math.min(t,bT);n<=0||(Zt+=n,yt({type:"player_pickup_health"}))},mA=i=>{if(!Sn()||St||Gt<=0||Zt<=0)return;const e=Math.max(0,Tt-Gt);if(e<=1e-4){Zt=0;return}const t=Math.min(e,Zt,ET*i);if(t<=1e-4)return;const n=Math.round(Gt);Gt+=t,Zt=Math.max(0,Zt-t),Math.round(Gt)!==n&&Lt()},sh=()=>{const i=Math.max(0,Tt-Gt);Zt=Math.max(0,Math.min(Zt,i))},sd=2.2,rd=.1,Cr=(i,e)=>{if(!i?.mesh||!i.active||!i.mesh.visible)return;if(As.length>=KE){const a=As.shift();a&&(_e.remove(a.mesh),a.mesh.geometry.dispose(),a.mesh.material.dispose())}const t=new Dt({color:e,transparent:!0,opacity:.55+Math.random()*.25,blending:Fi,depthWrite:!1}),n=new Qe(qE,t),s=Math.random()*Math.PI*2,r=.11+Math.random()*.28;n.position.set(i.mesh.position.x+Math.cos(s)*r,i.mesh.position.y+.08+Math.random()*.32,i.mesh.position.z+Math.sin(s)*r),_e.add(n);const o=.95+Math.random()*.85;As.push({mesh:n,life:o,initialLife:o,velocity:new C((Math.random()-.5)*.16,1.6+Math.random()*1.25,(Math.random()-.5)*.16)})},gA=i=>{for(let e=As.length-1;e>=0;e-=1){const t=As[e];t.life-=i,t.mesh.position.addScaledVector(t.velocity,i),t.velocity.y+=i*.55,t.mesh.scale.multiplyScalar(1+i*1.45);const n=Math.max(0,t.life/t.initialLife);t.mesh.material.opacity=n*.75,t.life<=0&&(_e.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),As.splice(e,1))}},_A=i=>{if(!Sn()||Fr){vt.multiplyScalar(Math.max(0,1-i*10));return}Hn.set(0,0,0),ue.getWorldDirection(Js),Js.y=0,Js.normalize(),Bl.crossVectors(Js,ue.up).normalize(),pt.KeyW&&Hn.add(Js),pt.KeyS&&Hn.sub(Js),pt.KeyA&&Hn.sub(Bl),pt.KeyD&&Hn.add(Bl);const e=Hn.lengthSq()>0;e&&(Hn.normalize().multiplyScalar(Yh),(pt.KeyA||pt.KeyD)&&!(pt.KeyW||pt.KeyS)&&Hn.multiplyScalar(nT));const n=1-Math.exp(-((e?QE:eT)*(Wt?tT:1))*i);if(vt.x+=((e?Hn.x:0)-vt.x)*n,vt.z+=((e?Hn.z:0)-vt.z)*n,Math.abs(vt.x)<1e-4&&(vt.x=0),Math.abs(vt.z)<1e-4&&(vt.z=0),vt.lengthSq()>0){const s=ue.position.x+vt.x*i,r=ue.position.z+vt.z*i,o=xg(s,r),a=Math.abs(o.x-ue.position.x)>1e-4||Math.abs(o.z-ue.position.z)>1e-4;Math.abs(o.x-s)>2e-4&&(vt.x=0),Math.abs(o.z-r)>2e-4&&(vt.z=0),ue.position.x=o.x,ue.position.z=o.z,ue.position.y=Math.max(vn,ue.position.y),a&&zo()}},xA=i=>{!Wt&&ue.position.y<=vn+.001&&wi<=0||(wi-=sT*i,ue.position.y+=wi*i,ue.position.y<=vn?(ue.position.y=vn,wi=0,Wt&&(Wt=!1,zo(!0))):Wt=!0,zo())},vA=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<sr.length;n+=1){const s=sr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*2.2,s.mesh.position.y=s.baseY+Math.sin(t*sd+s.phase)*rd,Math.random()<i*2.9&&(Cr(s,9421823),Math.random()<.72&&Cr(s,9421823)),!Sn()||(Hr(Xe)?Nt>=hn:ri>=qo))continue;const r=ue.position.x-s.mesh.position.x,o=ue.position.z-s.mesh.position.z;r*r+o*o<=1.1*1.1&&dA(s,e)}},MA=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<rr.length;n+=1){const s=rr[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.position.y=s.baseY+Math.sin(t*sd+s.phase)*rd,Math.random()<i*3.1&&(Cr(s,9435135),Math.random()<.75&&Cr(s,9435135)),!Sn()||hi>=Xo)continue;const r=ue.position.x-s.mesh.position.x,o=ue.position.z-s.mesh.position.z;r*r+o*o<=1.1*1.1&&fA(s,e)}},yA=i=>{const e=performance.now(),t=e/1e3;for(let n=0;n<or.length;n+=1){const s=or[n];if(!s.active)if(e>=s.respawnAt)s.active=!0,s.mesh.visible=!0;else continue;if(s.mesh.rotation.y+=i*1.9,s.mesh.position.y=s.baseY+Math.sin(t*sd+s.phase)*rd,Math.random()<i*3.5&&(Cr(s,10878896),Math.random()<.82&&Cr(s,10878896)),!Sn()||St||Math.max(0,Tt-(Gt+Zt))<=1e-4)continue;const o=ue.position.x-s.mesh.position.x,a=ue.position.z-s.mesh.position.z;o*o+a*a<=1.1*1.1&&pA(s,e)}},SA=i=>{if(!kh.visible)return;const e=.15+Math.sin(performance.now()*.0024)*.2;for(let t=0;t<Sc;t+=1){const n=t*3,s=t*3+1,r=t*3+2;wn[s]-=qu[t]*i,wn[n]+=e*i*qu[t]*.35,wn[r]+=Math.sin(performance.now()*.0015+t)*.015,wn[s]<.2&&(wn[s]=Math.random()*120+25,wn[n]=ue.position.x+(Math.random()-.5)*220,wn[r]=ue.position.z+(Math.random()-.5)*220)}zh.attributes.position.needsUpdate=!0},bA=i=>{if(Hh.visible){for(let e=0;e<bc;e+=1){const t=e*3,n=t+1,s=t+2;Rn[n]-=Fm[e]*i,Rn[t]+=Math.sin(performance.now()*9e-4+e)*.02,Rn[s]+=Math.cos(performance.now()*7e-4+e)*.02,Rn[n]<.2&&(Rn[n]=Math.random()*120+25,Rn[t]=ue.position.x+(Math.random()-.5)*180,Rn[s]=ue.position.z+(Math.random()-.5)*180)}Vh.attributes.position.needsUpdate=!0}},EA=i=>{vo=Math.max(0,vo-i*(Dm==="night"?.35:.55));const t=performance.now()*.001,n=lc.attributes.position.array;for(let r=0;r<Ec;r+=1){const o=r*3;n[o+1]+=Math.sin(t*km[r]+r)*.003,n[o]+=Math.cos(t*.7+r)*.0025,n[o+2]+=Math.sin(t*.5+r)*.0025}lc.attributes.position.needsUpdate=!0;const s=vo*.95;for(let r=0;r<ju.length;r+=1){const o=ju[r],a=(Math.sin(t*1.6+o.phase)+1)*.035;o.material.emissiveIntensity=o.base+a+s,o.material.color&&s>.08&&o.material.color.offsetHSL(Math.sin(t+o.phase)*3e-4,4e-4,3e-4)}},TA=i=>{const e=Math.min(1,i*8),t=performance.now(),n=OT()-CT;for(const s of O.remotePlayers.values()){const r=s.netSnapshots||[];if(r.length>0){const A=n-1e3;for(;r.length>2&&r[0].ts<A;)r.shift();let R=r[r.length-1];for(let _=1;_<r.length;_+=1){const y=r[_-1],N=r[_];if(n<y.ts||n>N.ts)continue;const P=Math.max(1,N.ts-y.ts),D=Math.max(0,Math.min(1,(n-y.ts)/P));R={x:y.x+(N.x-y.x)*D,y:y.y+(N.y-y.y)*D,z:y.z+(N.z-y.z)*D,yaw:y.yaw+((N.yaw-y.yaw+Math.PI*3)%(Math.PI*2)-Math.PI)*D,pitch:y.pitch+(N.pitch-y.pitch)*D,jumping:y.jumping||N.jumping,moving:y.moving||N.moving,ts:n};break}if(r.length>=2&&n>r[r.length-1].ts){const _=r[r.length-1],y=r[r.length-2],N=n-_.ts;if(N<=PT){const P=Math.max(1,_.ts-y.ts),D=N/P;R={x:_.x+(_.x-y.x)*D,y:_.y+(_.y-y.y)*D,z:_.z+(_.z-y.z)*D,yaw:_.yaw,pitch:_.pitch,jumping:_.jumping,moving:_.moving,ts:n}}else R=_}s.targetPosition.set(R.x,R.y,R.z),s.targetYaw=R.yaw,s.targetPitch=R.pitch,s.isJumping=!!R.jumping,R.moving&&(s.movingUntil=Math.max(Number(s.movingUntil||0),t+sg))}const o=s.group.position.distanceTo(s.targetPosition);let a=e;o>IT?a=Math.max(a,Math.min(1,i*12)):o>LT&&(a=Math.max(a,Math.min(1,i*10)));const c=s.group.position.x,l=s.group.position.y,u=s.group.position.z;o>DT?s.group.position.copy(s.targetPosition):s.group.position.lerp(s.targetPosition,a),s.group.rotation.y=Mp(s.group.rotation.y,s.targetYaw+Qh,a);const h=s.group.position.x-c,d=s.group.position.y-l,f=s.group.position.z-u,g=Math.sqrt(h*h+d*d+f*f),x=i>0?g/i:0,m=Math.min(1,i*10);s.smoothedMoveSpeed=Hp.lerp(Number(s.smoothedMoveSpeed||0),x,m);const p=s.currentAnimation==="move"?s.smoothedMoveSpeed>UT:s.smoothedMoveSpeed>NT,E=t<Number(s.movingUntil||0)||p,S=s.isJumping||s.targetPosition.y>.08||s.group.position.y>.08,w=t-Number(s.lastAnimationAt||0)>=FT;if(s.head&&(s.head.rotation.x=Mp(s.head.rotation.x,s.targetPitch,a)),s.healthBar?.holder){s.healthBar.holder.quaternion.copy(hc().quaternion);const A=s.group.position.distanceTo(hc().position),R=A<=wT,_=Math.max(.74,Math.min(1.06,1.12-A/170));s.healthBar.holder.scale.setScalar(_),s.healthBar.holder.visible=!s.isDead&&R}s.mixer&&s.mixer.update(i),s.animationUntil>0&&t>=s.animationUntil&&(s.isDead&&(s.isDead=!1),S?(Qn(s,"jump"),s.lastAnimationAt=t):E?(Qn(s,"move"),s.lastAnimationAt=t):(Oo(s),s.lastAnimationAt=t),s.animationUntil=0),!s.isDead&&s.animationUntil<=0&&(S?s.currentAnimation!=="jump"&&(Qn(s,"jump"),s.lastAnimationAt=t):E?s.currentAnimation!=="move"&&w&&(Qn(s,"move"),s.lastAnimationAt=t):s.currentAnimation!=="idle"&&w&&(Oo(s),s.lastAnimationAt=t))}},AA=i=>{Do.intensity=Math.max(0,Do.intensity-20*i),Fo=Math.max(0,Fo-i*4.8),gr=Math.max(0,gr-i*hT),gA(i);for(let e=Ts.length-1;e>=0;e-=1){const t=Ts[e];t.userData.life-=i,t.material.opacity=Math.max(0,t.userData.life*7.5),t.userData.life<=0&&(_e.remove(t),t.material.dispose(),Ts.splice(e,1))}for(let e=fr.length-1;e>=0;e-=1){const t=fr[e];t.userData.life-=i,t.scale.multiplyScalar(1+7*i),t.material.opacity=Math.max(0,t.userData.life*5),t.userData.life<=0&&(_e.remove(t),t.material.dispose(),fr.splice(e,1))}for(let e=0;e<ts.length;e+=1){const t=ts[e];t.material.emissiveIntensity>.5&&(t.material.emissiveIntensity=Math.max(.5,t.material.emissiveIntensity-3*i))}},wA=i=>{for(let e=yo.length-1;e>=0;e-=1){const t=yo[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.max(0,t.radius*(1-n*t.radiusFalloff)),o=Math.cos(s)*r,a=Math.sin(s)*r,l=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(o)).add(t.up.clone().multiplyScalar(a));t.pos.copy(l),t.mesh.position.copy(l),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.02)*.24),t.trailTimer+=i;const u=t.source==="remote"?.028:.012;if(t.trailTimer>=u){t.trailTimer=0;const d=wt(l,Math.random()>.5?16773830:10154239);d&&(d.scale.setScalar(1.35+Math.random()*.95),d.userData.life=.3+Math.random()*.18)}let h=null;if(t.source==="remote"){const d=Qo(t.prevPos,t.pos);d&&(h=d.point,d.headshot)}if(h||(h=Jo(t.prevPos,t.pos,.22)),h||n>=1){_e.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),yo.splice(e,1);const d=h?h.clone():t.end.clone();h&&t.source==="remote"&&Pc({},t.ownerId);const f=wt(d,16775121);f&&(f.scale.setScalar(2.3),f.userData.life=.42);const g=wt(d,12579839);g&&(g.scale.setScalar(1.7),g.userData.life=.36),Mn(d.clone().add(t.up.clone().multiplyScalar(1.05)),d.clone().add(t.up.clone().multiplyScalar(-1.05)),16773830,{radiusScale:2.2,life:.34,opacity:1}),Mn(d.clone().add(t.right.clone().multiplyScalar(.7)),d.clone().add(t.right.clone().multiplyScalar(-.7)),10154239,{radiusScale:1.9,life:.34,opacity:1})}}},RA=i=>{for(let e=So.length-1;e>=0;e-=1){const t=So[e];t.prevPos.copy(t.pos),t.velocity.y-=aT*i,t.pos.add(t.velocity.clone().multiplyScalar(i)),t.mesh.position.copy(t.pos);const n=t.pos.distanceTo(t.prevPos);t.traveledDistance+=n;const s=Math.max(0,Math.min(1,t.traveledDistance/$u)),r=t.phase+s*t.spin;t.mesh.rotation.set(r*.9,r*1.1,r*.75),t.trailTimer+=i;const o=t.source==="remote"?.032:.018;if(t.trailTimer>=o){t.trailTimer=0;const c=wt(t.pos,Math.random()>.5?16773830:10154239);c&&(c.scale.setScalar(1+Math.random()*.9),c.userData.life=.22+Math.random()*.16)}let a=null;if(t.pos.y<=.2&&(a=t.pos.clone(),a.y=.2),!a&&n>1e-4&&(a=Jo(t.prevPos,t.pos,.4)),!a){if(t.source==="local")for(const c of O.remotePlayers.values()){if(!c?.group||c.isDead)continue;const l=new C(c.group.position.x,c.group.position.y+1.85,c.group.position.z),u=new C(c.group.position.x,c.group.position.y+1.1,c.group.position.z);if(a=Rr(t.prevPos,t.pos,l,jo)||Rr(t.prevPos,t.pos,u,Yo),a)break}else if(t.source==="remote"){const c=Qo(t.prevPos,t.pos);c&&(a=c.point,c.headshot)}}if(!a&&t.traveledDistance>=pp&&(a=null),(a||t.traveledDistance>=pp)&&(_e.remove(t.mesh),t.mesh.traverse(c=>{c.isMesh&&(c.geometry.dispose(),c.material.dispose())}),So.splice(e,1),a)){const c=a.clone();t.source==="remote"&&Pc({},t.ownerId);const l=wt(c,16773830),u=wt(c,10154239);l&&(l.scale.setScalar(2.5),l.userData.life=.42),u&&(u.scale.setScalar(1.9),u.userData.life=.35),Mn(c.clone().add(t.up.clone().multiplyScalar(1.15)),c.clone().add(t.up.clone().multiplyScalar(-1.15)),16773830,{radiusScale:2.3,life:.34,opacity:1}),Mn(c.clone().add(t.right.clone().multiplyScalar(.8)),c.clone().add(t.right.clone().multiplyScalar(-.8)),10154239,{radiusScale:2,life:.34,opacity:1})}}},CA=i=>{for(let e=bo.length-1;e>=0;e-=1){const t=bo[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA*(1-n*.22),o=Math.sin(s*.5+Math.PI*.35)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(o));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.12+Math.sin(performance.now()*.02)*.28),t.trailTimer+=i;const l=t.source==="remote"?.016:.007;if(t.trailTimer>=l){t.trailTimer=0;const h=Math.random()>.5?6750067:10354554,d=Math.random()>.5?6160236:9437049,f=wt(c,h),g=wt(c.clone().add(t.right.clone().multiplyScalar((Math.random()-.5)*.12)),d);f&&(f.scale.setScalar(.72+Math.random()*.35),f.userData.life=.22+Math.random()*.08),g&&(g.scale.setScalar(.62+Math.random()*.28),g.userData.life=.18+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=Qo(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=Jo(t.prevPos,t.pos,.22)),u||n>=1){_e.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),bo.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&Pc({},t.ownerId);const d=wt(h,5832550);d&&(d.scale.setScalar(2.45),d.userData.life=.45);const f=wt(h,11075468);f&&(f.scale.setScalar(1.9),f.userData.life=.38),Mn(h.clone().add(t.up.clone().multiplyScalar(.95)),h.clone().add(t.up.clone().multiplyScalar(-.95)),7733092,{radiusScale:2,life:.28,opacity:1}),Mn(h.clone().add(t.right.clone().multiplyScalar(.75)),h.clone().add(t.right.clone().multiplyScalar(-.75)),12124053,{radiusScale:1.75,life:.28,opacity:.95})}}},PA=i=>{for(let e=Eo.length-1;e>=0;e-=1){const t=Eo[e];t.prevPos.copy(t.pos),t.traveled+=t.speed*i;const n=Math.max(0,Math.min(1,t.traveled/t.distance)),s=t.phase+n*t.spin,r=Math.sin(s)*t.waveAmpA,o=Math.cos(s*.7+Math.PI*.3)*t.waveAmpB,c=t.start.clone().lerp(t.end,n).add(t.right.clone().multiplyScalar(r)).add(t.up.clone().multiplyScalar(o));t.pos.copy(c),t.mesh.position.copy(c),t.mesh.scale.setScalar(1.25+Math.sin(performance.now()*.03)*.18),t.trailTimer+=i;const l=t.source==="remote"?.012:.005;if(t.trailTimer>=l){t.trailTimer=0;const h=2.9+Math.random()*1.4,d=c.clone().add(t.dir.clone().multiplyScalar(-h)),f=Math.random()>.5?10148095:8309247;Mn(c,d,f,{radiusScale:1.8,life:.36,opacity:.92});const g=wt(d,Math.random()>.5?12380671:8703999);g&&(g.scale.setScalar(.7+Math.random()*.3),g.userData.life=.22+Math.random()*.08)}let u=null;if(t.source==="remote"){const h=Qo(t.prevPos,t.pos);h&&(u=h.point,h.headshot)}if(u||(u=Jo(t.prevPos,t.pos,.24)),u||n>=1){_e.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Eo.splice(e,1);const h=u?u.clone():t.end.clone();u&&t.source==="remote"&&Pc({},t.ownerId);const d=wt(h,15661567),f=wt(h,9359871);d&&(d.scale.setScalar(2.2),d.userData.life=.4),f&&(f.scale.setScalar(2.8),f.userData.life=.46),Mn(h.clone().add(t.up.clone().multiplyScalar(1.35)),h.clone().add(t.up.clone().multiplyScalar(-1.35)),14677759,{radiusScale:2.35,life:.36,opacity:1}),Mn(h.clone().add(t.right.clone().multiplyScalar(1.05)),h.clone().add(t.right.clone().multiplyScalar(-1.05)),9097215,{radiusScale:2.15,life:.36,opacity:.98})}}},IA=i=>{const e=performance.now();for(let t=si.length-1;t>=0;t-=1){const n=si[t];if(!n||e>=n.endAt){wr(n?.ownerId);continue}const s=pg(n.ownerId);if(!s){wr(n.ownerId);continue}if(n.hammers.length>0){let l=0;for(let u=0;u<n.hammers.length;u+=1){const h=n.hammers[u];h?.disposed||(n.hammers[l]=h,l+=1)}n.hammers.length=l}for(;n.nextSpawnAt<=e&&n.nextSpawnAt<n.endAt;){if(n.hammers.length<n.maxActiveHammers){const l=dg(.82,.95);l.position.copy(s),l.visible=!0,_e.add(l);const u=Math.max(0,Math.min(1,(n.nextSpawnAt-n.createdAt)/Math.max(1,n.endAt-n.createdAt)));n.hammers.push({mesh:l,spawnAt:n.nextSpawnAt,baseAngle:Math.random()*Math.PI*2+n.spawnCount%4*(Math.PI*.5),maxRadius:Math.max(2.2,n.maxOrbitRadius*(.22+u*.78)),prevPos:s.clone(),disposed:!1})}n.spawnCount+=1,n.nextSpawnAt+=n.spawnIntervalMs}const r=(e-n.createdAt)/1e3,o=Math.max(0,Math.min(1,(e-n.createdAt)/Math.max(1,n.endAt-n.createdAt))),a=1.15+Math.sin(r*5.5)*.12,c=!!(O.self&&n.ownerId===O.self.id);for(let l=0;l<n.hammers.length;l+=1){const u=n.hammers[l],h=u.mesh;if(!h||u.disposed)continue;h.visible=!0;const d=Math.max(0,Math.min(1,(e-u.spawnAt)/1200)),f=u.maxRadius*(.25+.75*o*d),g=n.phase+r*5.4+u.baseAngle+l*.11,x=f+Math.sin(r*3.4+l)*.12;u.prevPos.copy(h.position),h.position.set(s.x+Math.cos(g)*x,s.y+a+Math.sin(r*3.1+l)*.22,s.z+Math.sin(g)*x),h.rotation.set(r*5.8+l,r*6.5+l*.7,r*4.9+l);let m=null;if(h.position.y<=.22&&(m=h.position.clone(),m.y=.22),m||(m=Jo(u.prevPos,h.position,.34)),!m)if(c)for(const p of O.remotePlayers.values()){if(!p?.group||p.isDead)continue;const M=new C(p.group.position.x,p.group.position.y+1.85,p.group.position.z),E=new C(p.group.position.x,p.group.position.y+1.1,p.group.position.z);if(m=Rr(u.prevPos,h.position,M,jo)||Rr(u.prevPos,h.position,E,Yo),m)break}else{const p=Qo(u.prevPos,h.position);p&&(m=p.point)}if(m){aA(u,m);continue}if(Math.random()<.45){const p=wt(h.position,Math.random()>.5?16773830:10154239);p&&(p.scale.setScalar(.45+Math.random()*.35),p.userData.life=.1+Math.random()*.1)}}}},LA=()=>{let i=0;for(let e=0;e<si.length;e+=1){const t=si[e];if(t?.hammers)for(let n=0;n<t.hammers.length;n+=1)t.hammers[n]?.mesh?.visible&&!t.hammers[n]?.disposed&&(i+=1)}return i},DA=i=>{const e=Hr(Xe);if(Sn()){if(e){const t=oi;Nt=Math.min(hn,Nt+fT*i),oi=Math.round(Nt),Kn&&(Kn=!1,pr=0),oi!==t&&Lt()}if(!e&&Kn&&(pr-=i,pr<=0)){const t=os-Ni,n=Math.min(t,ri);Ni+=n,ri-=n,Kn=!1,Lt()}if(Ul-=i,Fr){li=!1;return}ws&&li&&Ul<=0&&!Kn&&(hA(),Ul=XT(),!e&&Ni<=0&&ri>0&&td())}},NA=()=>{if(!St||!O.joinedRoom||!Lo()){St&&!Lo()&&(St=!1,zi=0,Un=ui,di());return}const i=Math.max(0,zi-performance.now()),e=Math.ceil(i/1e3);e!==Un&&(Un=e,di()),i<=0&&QT()},UA=()=>{if(!Ar||!O.joinedRoom||O.joinedRoom.room.status!=="cooldown"){Ar&&bs();return}const i=Math.max(0,$h-performance.now()),e=Math.ceil(i/1e3);e!==mr&&(mr=e,Ou.textContent=String(mr)),i<=0&&(Ou.textContent="0")},zl=()=>!O.joinedRoom&&Jn&&!Jn.classList.contains("hidden"),Mg=()=>{requestAnimationFrame(Mg);const i=Math.min(RT.getDelta(),.05);rE(),_A(i),xA(i),mA(i),tA(i),gg(),vA(i),MA(i),yA(i),SA(i),bA(i),EA(i),TA(i),wA(i),RA(i),CA(i),PA(i),IA(),DA(i),NA(),UA(),AA(i),$T(),ZT(),ed(!1),lg(i),zl()&&je.mixer&&je.mixer.update(i),zl()&&je.model&&(je.model.rotation.y+=i*.45),zl()&&je.renderer&&je.scene&&je.camera&&(qm(),je.renderer.render(je.scene,je.camera)),mn.render(_e,hc()),jn.drawCalls=mn.info.render.calls||0,jn.triangles=mn.info.render.triangles||0,jn.geometries=mn.info.memory.geometries||0,jn.textures=mn.info.memory.textures||0,jn.vfx=Ts.length+fr.length+As.length+yo.length+So.length+bo.length+Eo.length+LA()};window.addEventListener("resize",()=>{ue.aspect=window.innerWidth/window.innerHeight,ue.updateProjectionMatrix(),Ps.aspect=window.innerWidth/window.innerHeight,Ps.updateProjectionMatrix(),mn.setSize(window.innerWidth,window.innerHeight),je.renderer&&je.camera&&qm()});tE();UE();Wo();go(!1);_o("night");Xm();di();Lt();Xu();Ic();Mg();mg();EE();
